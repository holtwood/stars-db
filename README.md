...
![项目数](https://img.shields.io/badge/Star_项目-1367-8A2BE2) ![最后同步](https://img.shields.io/badge/最后同步-2026--09--23-2ea44f) ![自动更新](https://img.shields.io/badge/自动更新-GitHub_Actions-007ec6)

> 📈 **1367** 个项目 · **19** 个分类 · **28** 个 Star Lists · 每日自动同步
...
- ⭐ [holtwood/cmdc-statusline](https://github.com/holtwood/cmdc-statusline) — 📊 Command Code 状态栏 — 模型 · 渐变上下文进度条 · 缓存命中率 · 会话花费 · 输出速度 · 子… `2026-09-14`
...
| 📦 其他与杂项 | 70 | `█░░░░░░░░░░░░░░░` (5%) | [docs/misc.md](docs/misc.md) |

## 📊 快速入口

- 📦 [全量索引(1367)](docs/all.md) — 所有项目按 ⭐ 排序
