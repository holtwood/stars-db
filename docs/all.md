...
| 项目 | 星数 | 语言 | 描述 |
|------|------|------|------|
| [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | ⭐ 548.3k | Markdown | 通过从零重写你喜爱的技术来精通编程。 |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 507.9k |  | 汇集各类趣味主题的超棒精选列表【注：在我处理完现有PR前，暂时关闭拉取请求提交】 |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 481.7k | Python | 免费API集合列表 |
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | ⭐ 455.8k | TypeScript | freeCodeCamp.org 的开源代码库与课程。免费学习数学、编程与计算机科学。 |
| [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | ⭐ 397.3k | Python | :books: 免费开源编程书籍 |
| [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | ⭐ 370.8k | Python | 学习如何设计大规模系统，备战系统设计面试，包含Anki闪卡。 |
| [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | ⭐ 367.7k | TypeScript | 助力开发者职业成长的交互式路线图、指南及其他教育内容。 |
| [jwasham/coding-interview-university](https://github.com/jwasham/coding-interview-university) | ⭐ 361.2k |  | 一份成为软件工程师的完整计算机科学学习计划 |
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 321.8k | Python | 专门解答「我想用Python做X该用什么工具？」的权威工具清单 |
| [obra/superpowers](https://github.com/obra/superpowers) | ⭐ 288.9k | Shell | 一套行之有效的智能体技能框架与软件开发方法论。 |
| [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | ⭐ 283.9k | Python | 精选基于项目的教程列表 |
| [mattpocock/skills](https://github.com/mattpocock/skills) | ⭐ 265.9k | Shell | 真正工程师必备技能，直接来自我的.agents目录。 |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 263.0k | JavaScript | 这是智能代理性能优化系统，为 Claude Code、Codex、Opencode、Cursor 及更多 AI 编码工具提供技能、本能、记忆、安全能力与研究优先… |
| [react/react](https://github.com/react/react) | ⭐ 250.6k | JavaScript | 用于构建网页和原生用户界面的库。 |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | ⭐ 247.2k | Python | The agent that grows with you |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 230.2k | TypeScript | DeepSeek Harness：万物皆插件。 |
| [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) | ⭐ 224.8k | Python | 用Python实现的所有算法 |
| [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | ⭐ 214.2k |  | 基于Andrej Karpathy对大语言模型编码陷阱的观察，通过单个CLAUDE.md文件优化Claude Code的行为。 |
| [vuejs/vue](https://github.com/vuejs/vue) | ⭐ 212.8k | TypeScript | 这是 Vue 2 的仓库。Vue 3 请访问 https://github.com/vuejs/core |
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | ⭐ 208.7k | TypeScript | 开源编码智能体 |
| [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | ⭐ 200.3k | Markdown | 为所有人提供免费域名注册与实用DNS学习资源 |
| [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) | ⭐ 191.3k | Batchfile | 开源Windows和Office激活工具，支持HWID、Ohook、TSforge和在线KMS激活方式，同时具备高级故障排查功能 |
...
| [jackfrued/Python-100-Days](https://github.com/jackfrued/Python-100-Days) | ⭐ 186.7k | Jupyter Notebook | Python - 100天从新手到大师 |
| [CyC2018/CS-Notes](https://github.com/CyC2018/CS-Notes) | ⭐ 186.2k |  | :books: 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计 |
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | ⭐ 185.7k | Python | 用于将文件和办公文档转换为 Markdown 的 Python 工具 |
| [ollama/ollama](https://github.com/ollama/ollama) | ⭐ 181.3k | Go | 快速上手 Kimi-K2.6、GLM-5.2、MiniMax、DeepSeek、gpt-oss、Qwen、Gemma 等各类大模型。 |
| [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | ⭐ 177.6k | Python | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source proj… |
| [anthropics/skills](https://github.com/anthropics/skills) | ⭐ 177.2k | Python | Agent 技能公开仓库 |
| [jlevy/the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) | ⭐ 162.5k |  | 掌握命令行，只需一页 |
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 152.6k | Python | 易用的 AI 界面（支持 Ollama、OpenAI API 等） |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | ⭐ 146.8k | TypeScript | Claude Code 是一款可在终端内运行的智能编码工具，它能理解你的代码库，通过自然语言命令帮你完成例行任务、讲解复杂代码、处理 git 工作流，让你的编码… |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.7k | Python | 智能体工程开发平台 |
| [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) | ⭐ 145.5k | Rust | 基于 Tauri 构建的现代化图形界面客户端，支持在 Windows、macOS 和 Linux 运行，提供定制化代理体验 |
...
| [github/spec-kit](https://github.com/github/spec-kit) | ⭐ 138.0k | Python | 用于帮助你上手规范驱动开发的工具套件 |
| [labuladong/fucking-algorithm](https://github.com/labuladong/fucking-algorithm) | ⭐ 135.9k | Markdown | 破解LeetCode，不仅要知其然，更要知其所以然。 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | ⭐ 133.7k | Rust | 适用于 Claude Code、Codex、OpenCode、OpenClaw、Grok Build 与 Hermes Agent 的跨平台桌面一站式助手。唯一… |
| [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | ⭐ 129.1k | Python | 一款可为多平台构建专业UI/UX提供设计智能支持的AI技能。 |
| [openai/codex](https://github.com/openai/codex) | ⭐ 125.3k | Rust | 可在终端运行的轻量级编码智能体 |
| [microsoft/generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners) | ⭐ 120.1k | Jupyter Notebook | 21节课，从零开始构建生成式AI项目 |
...
| [openai/whisper](https://github.com/openai/whisper) | ⭐ 109.4k | Python | 基于大规模弱监督的稳健语音识别 |
| [earendil-works/pi](https://github.com/earendil-works/pi) | ⭐ 107.4k | TypeScript | AI 智能体工具包：统一大语言模型API、智能体循环、终端用户界面、编程智能体命令行工具 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | ⭐ 107.1k | TypeScript | 一款可将 Gemini 的能力直接引入终端的开源 AI 智能体 |
| [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | ⭐ 106.8k | Go | 🪨 能少用token干嘛用那么多——这是Claude Code技能，模仿原始人说话帮你砍掉65%的token用量 |
| [ruanyf/weekly](https://github.com/ruanyf/weekly) | ⭐ 103.3k |  | 科技爱好者周刊，每周五发布 |
| [fastapi/fastapi](https://github.com/fastapi/fastapi) | ⭐ 102.5k | Python | FastAPI 框架，高性能，易学习，编码快，可用于生产环境 |
| [neovim/neovim](https://github.com/neovim/neovim) | ⭐ 102.5k | Vim Script | 专注于可扩展性与易用性的 Vim 分支 |
...
| [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 95.3k |  | MCP 服务器集合 |
| [localsend/localsend](https://github.com/localsend/localsend) | ⭐ 92.2k | Dart | AirDrop 的开源跨平台替代工具 |
| [deepseek-ai/DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) | ⭐ 92.0k |  |  |
| [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) | ⭐ 91.6k | JavaScript | 酷炫的自托管监控工具 |
...
| [lobehub/lobehub](https://github.com/lobehub/lobehub) | ⭐ 82.7k | TypeScript | 🤯 LobeHub 是你的智能体总运营官，可通过招聘、排程与全团队报表，将你的 AI 智能体组建成 7×24 不间断运作的团队。 |
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | ⭐ 81.1k | Rust | CLI 代理，可将常用开发命令的 LLM 令牌消耗降低 60-90%，单Rust二进制文件，零依赖 |
...
| [datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents) | ⭐ 79.9k | Python | 📚 《从零开始构建智能体》——从零开始的智能体原理与实践教程 |
...
| [caddyserver/caddy](https://github.com/caddyserver/caddy) | ⭐ 75.9k | Go | 快速可扩展的多平台 HTTP/1-2-3 Web 服务器，自带自动 HTTPS |
...
| [Asabeneh/30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python) | ⭐ 74.2k | Python | 「Python编程30天挑战是一份分步骤的Python语言学习指南，总学习时长可能超过100天，你可以按照自己的节奏学习。这些视频也可能对你有帮助：https:… |
...
| [fffaraz/awesome-cpp](https://github.com/fffaraz/awesome-cpp) | ⭐ 73.4k |  | 精选的优质 C++（及 C）框架、库、资源与趣味项目列表，灵感源自各类「awesome」清单项目。 |
...
| [stablyai/orca](https://github.com/stablyai/orca) | ⭐ 72.8k | TypeScript | Orca is the ADE for working with a fleet of parallel agents. Run any coding agen… |
...
| [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | ⭐ 69.6k | TypeScript | 适用于 AI 编码助手的规范驱动开发（SDD）。 |
...
| [cline/cline](https://github.com/cline/cline) | ⭐ 68.8k | TypeScript | 可作为 SDK、IDE 扩展或 CLI 助手使用的自主编码智能体 |
| [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) | ⭐ 67.9k | Rust | 用 Rust 编写的非官方兼容 Bitwarden 的服务端，曾用名 bitwarden_rs |
| [tw93/Mole](https://github.com/tw93/Mole) | ⭐ 67.8k | Shell | 🐹 清理、卸载、分析、优化与监控你的 Mac。免费开源命令行工具，另有原生 Mac 应用。 |
| [tt-a1i/archify](https://github.com/tt-a1i/archify) | ⭐ 67.6k | JavaScript | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flo… |
...
| [byoungd/up](https://github.com/byoungd/up) | ⭐ 63.3k | JavaScript | An advanced guide which might benefit you a lot 🎉 . 韩先凯的人生进阶指南 离谱的人生/人生进阶 离谱的英语学… |
...
| [jingyaogong/minimind](https://github.com/jingyaogong/minimind) | ⭐ 61.7k | Python | 🧠 仅需2小时从零训练一个64M参数的LLM！ |
...
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 58.8k | Python | 用于编排角色扮演型自主AI智能体的框架。CrewAI 通过培养协作智能，赋能智能体无缝协作，处理复杂任务。 |
...
| [chen08209/FlClash](https://github.com/chen08209/FlClash) | ⭐ 52.7k | Dart | 基于 ClashMeta 的多平台代理客户端，简洁易用，开源无广告。 |
...
| [Aider-AI/aider](https://github.com/Aider-AI/aider) | ⭐ 49.1k | Python | aider 是你终端里的 AI 结对编程工具 |
...
| [QuantumNous/new-api](https://github.com/QuantumNous/new-api) | ⭐ 48.5k | Go | 一个用于聚合与分发的统一AI模型 hub，支持将各类大语言模型转换为兼容OpenAI、Claude或Gemini的格式，是供个人与企业进行模型管理的集中网关。 |
...
| [karanpratapsingh/system-design](https://github.com/karanpratapsingh/system-design) | ⭐ 46.2k |  | 学习如何设计大规模系统，备战系统设计面试 |
...
| [exelban/stats](https://github.com/exelban/stats) | ⭐ 42.0k | Swift | 常驻菜单栏的 macOS 系统监视器 |
...
| [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) | ⭐ 39.3k | TypeScript | 面向Teams的Claude Code多智能体编排工具 |
...
| [searxng/searxng](https://github.com/searxng/searxng) | ⭐ 37.4k | Python | SearXNG 是一款免费的互联网元搜索引擎，可聚合来自多种搜索服务与数据库的搜索结果。它不会追踪用户，也不会为用户建立画像。 |
...
| [DayuanJiang/next-ai-draw-io](https://github.com/DayuanJiang/next-ai-draw-io) | ⭐ 36.0k | TypeScript | 这是集成了AI能力与draw.io图表的next.js网页应用，支持你通过自然语言指令和AI辅助可视化来创建、修改与优化图表。 |
...
| [rustfs/rustfs](https://github.com/rustfs/rustfs) | ⭐ 33.4k | Rust | 处理4KB对象载荷时，速度比MinIO快2.3倍。RustFS是开源的S3兼容高性能对象存储系统，支持与MinIO、Ceph等其他兼容S3的平台迁移共存。 |
| [maboloshi/github-chinese](https://github.com/maboloshi/github-chinese) | ⭐ 33.2k | JavaScript | GitHub 汉化插件，GitHub 中文化界面。 (GitHub Translation To Chinese) |
| [iOfficeAI/AionUi](https://github.com/iOfficeAI/AionUi) | ⭐ 33.0k | TypeScript | 适配 OpenClaw、Hermes、Claude Code、Codex、OpenCode 等二十余种 CLI 智能代理的开源全天候协作应用，支持自定义助手、组… |
...
| [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) | ⭐ 32.0k | TypeScript | ⌥ Coding agent with the IDE wired in |
| [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | ⭐ 32.0k | Python | 构建并运行你看得见、摸得透、信得过的智能体。 |
...
| [vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills) | ⭐ 31.4k | JavaScript | Vercel 官方智能体技能合集 |
...
| [521xueweihan/GitHub520](https://github.com/521xueweihan/GitHub520) | ⭐ 29.8k | Python | :kissing_heart: 让你“爱”上 GitHub，解决访问时图裂、加载慢的问题。（无需安装） |
...
| [karakeep-app/karakeep](https://github.com/karakeep-app/karakeep) | ⭐ 29.2k | TypeScript | 支持自托管的全类型书签应用，可收纳链接、笔记与图片，带AI自动 tagging 和全文搜索 |
| [wezterm/wezterm](https://github.com/wezterm/wezterm) | ⭐ 29.0k | Rust | 由 @wez 使用 Rust 开发的GPU加速跨平台终端模拟器与多路复用器 |
...
| [manaflow-ai/cmux](https://github.com/manaflow-ai/cmux) | ⭐ 27.3k | Swift | 基于 Ghostty 开源改造的 macOS 终端，支持垂直标签页与 AI 编码代理通知，专为多任务处理、有序组织与可编程性打造。 |
...
| [AZeC4/TelegramGroup](https://github.com/AZeC4/TelegramGroup) | ⭐ 23.3k |  | 2026最新悄咪咪收集的10000+个Telegram群合集，附全网最有趣好用的机器人BOT🤖【dianbaodaohang.com】 |
...
| [jlcodes99/cockpit-tools](https://github.com/jlcodes99/cockpit-tools) | ⭐ 18.0k | Rust | 🚀 通用 AI IDE 账号管理工具：支持 Antigravity / Codex / GitHub Copilot / Windsurf / Kiro / C… |
...
| [microsoft/mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners) | ⭐ 17.3k | Jupyter Notebook | 这套开源课程通过 .NET、Java、TypeScript、JavaScript、Rust 和 Python 的真实跨语言示例，讲解模型上下文协议（MCP）的基… |
...
| [coder/coder](https://github.com/coder/coder) | ⭐ 15.7k | Go | 为开发者及其智能代理提供安全环境 |
...
| [coderamp-labs/gitingest](https://github.com/coderamp-labs/gitingest) | ⭐ 15.6k | Python | 在任意 GitHub URL 中将 `hub` 替换为 `ingest`，即可获取适配大模型提示词的代码库提取内容 |
...
| [sirmalloc/ccstatusline](https://github.com/sirmalloc/ccstatusline) | ⭐ 13.0k | TypeScript | 🚀 为 Claude Code CLI 打造的美观高度可自定义状态栏，支持 powerline、内置主题等诸多功能。 |
...
| [mengxi-ream/read-frog](https://github.com/mengxi-ream/read-frog) | ⭐ 9.8k | TypeScript | 🐸 Read Frog - Language Learning & Translate | 🐸 陪读蛙 - 语言学习与翻译 |
...
| [wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP) | ⭐ 9.7k | TypeScript | 这是面向Claude的MCP服务器，可为其提供终端控制、文件系统搜索和差异文件编辑能力。 |
...
| [zhukunpenglinyutong/desktop-cc-gui](https://github.com/zhukunpenglinyutong/desktop-cc-gui) | ⭐ 4.3k | TypeScript | 基于Tauri构建的多引擎AI编码桌面客户端，在一个GUI中集成Claude Code、Codex、Gemini、OpenCode、DeepSeek Harne… |
...
| [mimo-x/Code-Review-GPT-Gitlab](https://github.com/mimo-x/Code-Review-GPT-Gitlab) | ⭐ 819 | Python | 🤖 GPT（ Deepseek and more ） Code Review for Gitlab （针对于 Gitlab 的 LLM 辅助 Code Revi… |
...
| [WakeUp-Jin/Practical-Guide-to-Context-Engineering](https://github.com/WakeUp-Jin/Practical-Guide-to-Context-Engineering) | ⭐ 809 |  | 大模型应用开发的方向，上下文工程是设计原则，Agent Harness 是构建目标，本项目的目标，是为开发者和研究者提供一份大模型应用开发的骨架思路 |
...
| [OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL](https://github.com/OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL) | ⭐ 804 |  | 去AI味提示词-作家增强-SKILL |
...
| [zkep/my-geektime](https://github.com/zkep/my-geektime) | ⭐ 793 | Go | 👏 Make learning a lifelong habit. 学无止境 |
| [findmover/wxread](https://github.com/findmover/wxread) | ⭐ 791 | Python | 微信读书刷时长助你成为霸榜“大佬” |
| [bilibili/vim-vide](https://github.com/bilibili/vim-vide) | ⭐ 786 | Vim Script | Lightest vimrc, while strong enough. 最轻的vim配置，却足够强！ |
| [huangguang1999/ccstatusline-zh](https://github.com/huangguang1999/ccstatusline-zh) | ⭐ 782 | TypeScript | ccstatusline 的中文汉化版 - Claude Code CLI 可定制状态栏格式化工具 |
...
| [MAXeaglet/commandcode-proxy](https://github.com/MAXeaglet/commandcode-proxy) | ⭐ 650 | JavaScript | Command Code API 反代代理，兼容 OpenAI 与 Anthropic 接口 | Reverse proxy exposing Command… |
| [JackyST0/awesome-agent-skills](https://github.com/JackyST0/awesome-agent-skills) | ⭐ 640 | Shell | 🤖 精选的 AI Agent Skills 列表，适用于 Cursor、Claude Code、GitHub Copilot 等 AI 编程工具 |
...
| [WoJiSama/skill-based-architecture](https://github.com/WoJiSama/skill-based-architecture) | ⭐ 596 | Shell | 这是一项可以生成技能的元技能：指向任意代码库后，它就能把项目的规则、工作流与经验教训提取出来，整理存入专用的`skills/<项目名>/`目录中——这个项目技能… |
...
| [wzsx150/MobaXterm_CN](https://github.com/wzsx150/MobaXterm_CN) | ⭐ 581 |  | MobaXterm 综合远程工具 汉化版 |
| [ccpopy/antissh](https://github.com/ccpopy/antissh) | ⭐ 579 | Shell | 反重力Agent代理一键脚本，支持WSL、SSH远程 |
...
| [Haleclipse/codex🔀](https://github.com/Haleclipse/codex) | ⭐ 560 | Rust | 可在终端运行的轻量级编程代理 |
...
| [catlog22/maestro-flow](https://github.com/catlog22/maestro-flow) | ⭐ 554 | TypeScript | 面向多智能体AI开发的意图驱动工作流编排——适配Claude Code、Gemini、Codex等工具的自适应生命周期引擎、自强化知识图谱与可视化仪表盘 |
...
| [cocojojo5213/phonics-app](https://github.com/cocojojo5213/phonics-app) | ⭐ 443 | JavaScript | 真正从基础开始学英语 - 自然拼读练习应用 |
...
| [CooperJiang/coding-tool](https://github.com/CooperJiang/coding-tool) | ⭐ 414 | JavaScript | claudecode|codex|gemini  cli增强工具。 |
| [itandelin/qoder-free](https://github.com/itandelin/qoder-free) | ⭐ 410 | Python | 一个用于重置 Qoder 应用程序用户身份信息的现代化图形界面工具。 |
...
| [rashidazarang/chatgpt-chat-exporter](https://github.com/rashidazarang/chatgpt-chat-exporter) | ⭐ 387 | JavaScript | 一款轻量级浏览器端工具，可将你的ChatGPT对话导出为美观的Markdown或PDF格式。 |
...
| [Baseult/NetLimiterCrack](https://github.com/Baseult/NetLimiterCrack) | ⭐ 307 | C# | 一个用于免费获取 NetLimiter Premium 的简单补丁程序 |
...
| [dxxzst/mml-book-chinese](https://github.com/dxxzst/mml-book-chinese) | ⭐ 262 | Python | mml-book-chinese《Mathematics For Machine Learning》机器学习中的数学 中文版 |
...
| [thep0y/monaco-nerd-font](https://github.com/thep0y/monaco-nerd-font) | ⭐ 245 | Shell | 已添加粗体、斜体和粗斜体的 Monaco Nerd Font |
...
| [sergiye/winUpdateMiniTool](https://github.com/sergiye/winUpdateMiniTool) | ⭐ 208 | C# | Windows Update Mini Tool 是一款用于在 Windows 操作系统上管理 Microsoft 产品更新的工具 |
...
| [Ayi1337/gpt6-astra-one-shot-games](https://github.com/Ayi1337/gpt6-astra-one-shot-games) | ⭐ 53 | HTML | GPT-6 Astra 的 One Shot 游戏测试，包含原始 Prompt 与可直接运行的单文件 HTML。 |
