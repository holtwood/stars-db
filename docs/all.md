...
> 全部 **1353** 个 Star 项目,按 ⭐ 排序

| 项目 | 星数 | 语言 | 描述 |
|------|------|------|------|
| [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | ⭐ 546.1k | Markdown | 通过从零重写你喜爱的技术来精通编程。 |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 504.3k |  | 汇集各类趣味主题的超棒精选列表【注：在我处理完现有PR前，暂时关闭拉取请求提交】 |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 477.7k | Python | 免费API集合列表 |
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | ⭐ 455.2k | TypeScript | freeCodeCamp.org 的开源代码库与课程。免费学习数学、编程与计算机科学。 |
| [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | ⭐ 396.3k | Python | :books: 免费开源编程书籍 |
| [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | ⭐ 368.8k | Python | 学习如何设计大规模系统，备战系统设计面试，包含Anki闪卡。 |
| [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | ⭐ 366.6k | TypeScript | 助力开发者职业成长的交互式路线图、指南及其他教育内容。 |
| [jwasham/coding-interview-university](https://github.com/jwasham/coding-interview-university) | ⭐ 360.6k |  | 一份成为软件工程师的完整计算机科学学习计划 |
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 319.4k | Python | 专门解答「我想用Python做X该用什么工具？」的权威工具清单 |
| [obra/superpowers](https://github.com/obra/superpowers) | ⭐ 283.4k | Shell | 一套行之有效的智能体技能框架与软件开发方法论。 |
| [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | ⭐ 282.7k | Python | 精选基于项目的教程列表 |
| [mattpocock/skills](https://github.com/mattpocock/skills) | ⭐ 257.1k | Shell | 真正工程师必备技能，直接来自我的.agents目录。 |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 254.4k | JavaScript | 这是智能代理性能优化系统，为 Claude Code、Codex、Opencode、Cursor 及更多 AI 编码工具提供技能、本能、记忆、安全能力与研究优先… |
| [react/react](https://github.com/react/react) | ⭐ 249.7k | JavaScript | 用于构建网页和原生用户界面的库。 |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | ⭐ 243.5k | Python | The agent that grows with you |
| [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) | ⭐ 224.4k | Python | 用Python实现的所有算法 |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 216.4k | TypeScript | DeepSeek Harness：万物皆插件。 |
| [vuejs/vue](https://github.com/vuejs/vue) | ⭐ 212.1k | TypeScript | 这是 Vue 2 的仓库。Vue 3 请访问 https://github.com/vuejs/core |
| [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | ⭐ 211.5k |  | 基于Andrej Karpathy对大语言模型编码陷阱的观察，通过单个CLAUDE.md文件优化Claude Code的行为。 |
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | ⭐ 206.0k | TypeScript | 开源编码智能体 |
| [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | ⭐ 198.3k | Markdown | 为所有人提供免费域名注册与实用DNS学习资源 |
| [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) | ⭐ 189.8k | Batchfile | 开源Windows和Office激活工具，支持HWID、Ohook、TSforge和在线KMS激活方式，同时具备高级故障排查功能 |
...
| [jackfrued/Python-100-Days](https://github.com/jackfrued/Python-100-Days) | ⭐ 186.2k | Jupyter Notebook | Python - 100天从新手到大师 |
| [CyC2018/CS-Notes](https://github.com/CyC2018/CS-Notes) | ⭐ 185.9k |  | :books: 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计 |
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | ⭐ 181.8k | Python | 用于将文件和办公文档转换为 Markdown 的 Python 工具 |
| [ollama/ollama](https://github.com/ollama/ollama) | ⭐ 180.5k | Go | 快速上手 Kimi-K2.6、GLM-5.2、MiniMax、DeepSeek、gpt-oss、Qwen、Gemma 等各类大模型。 |
| [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | ⭐ 175.5k | Python | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source proj… |
| [anthropics/skills](https://github.com/anthropics/skills) | ⭐ 175.3k | Python | Agent 技能公开仓库 |
| [jlevy/the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) | ⭐ 162.3k |  | 掌握命令行，只需一页 |
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 151.4k | Python | 易用的 AI 界面（支持 Ollama、OpenAI API 等） |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.0k | Python | 智能体工程开发平台 |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | ⭐ 144.5k | Python | Claude Code 是一款可在终端内运行的智能编码工具，它能理解你的代码库，通过自然语言命令帮你完成例行任务、讲解复杂代码、处理 git 工作流，让你的编码… |
...
| [golang/go](https://github.com/golang/go) | ⭐ 138.0k | Go | Go 编程语言 |
| [labuladong/fucking-algorithm](https://github.com/labuladong/fucking-algorithm) | ⭐ 135.8k | Markdown | 破解LeetCode，不仅要知其然，更要知其所以然。 |
| [github/spec-kit](https://github.com/github/spec-kit) | ⭐ 134.2k | Python | 用于帮助你上手规范驱动开发的工具套件 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | ⭐ 131.8k | Rust | 适用于 Claude Code、Codex、OpenCode、OpenClaw、Grok Build 与 Hermes Agent 的跨平台桌面一站式助手。唯一… |
| [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | ⭐ 126.2k | Python | 一款可为多平台构建专业UI/UX提供设计智能支持的AI技能。 |
| [openai/codex](https://github.com/openai/codex) | ⭐ 122.6k | Rust | 可在终端运行的轻量级编码智能体 |
| [microsoft/generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners) | ⭐ 119.4k | Jupyter Notebook | 21节课，从零开始构建生成式AI项目 |
...
| [openai/whisper](https://github.com/openai/whisper) | ⭐ 108.8k | Python | 基于大规模弱监督的稳健语音识别 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | ⭐ 106.9k | TypeScript | 一款可将 Gemini 的能力直接引入终端的开源 AI 智能体 |
| [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | ⭐ 104.4k | Go | 🪨 能少用token干嘛用那么多——这是Claude Code技能，模仿原始人说话帮你砍掉65%的token用量 |
| [earendil-works/pi](https://github.com/earendil-works/pi) | ⭐ 103.2k | TypeScript | AI 智能体工具包：统一大语言模型API、智能体循环、终端用户界面、编程智能体命令行工具 |
| [neovim/neovim](https://github.com/neovim/neovim) | ⭐ 102.2k | Vim Script | 专注于可扩展性与易用性的 Vim 分支 |
| [ruanyf/weekly](https://github.com/ruanyf/weekly) | ⭐ 102.2k |  | 科技爱好者周刊，每周五发布 |
...
| [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 94.7k |  | MCP 服务器集合 |
...
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | ⭐ 82.1k | Python | 这是一个可完成调研、编码与创作的开源长周期SuperAgent框架。借助沙箱、记忆、工具、技能、子代理与消息网关，它能处理耗时数分钟到数小时的不同层级任务。 |
| [d2l-ai/d2l-zh](https://github.com/d2l-ai/d2l-zh) | ⭐ 80.4k | Python | 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被70多个国家的500多所大学用于教学。 |
...
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | ⭐ 79.6k | Rust | CLI 代理，可将常用开发命令的 LLM 令牌消耗降低 60-90%，单Rust二进制文件，零依赖 |
...
| [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code) | ⭐ 78.3k | Python | 上传截图，即可将其转换为整洁的代码（HTML/Tailwind/React/Vue） |
...
| [datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents) | ⭐ 77.8k | Python | 📚 《从零开始构建智能体》——从零开始的智能体原理与实践教程 |
...
| [caddyserver/caddy](https://github.com/caddyserver/caddy) | ⭐ 75.6k | Go | 快速可扩展的多平台 HTTP/1-2-3 Web 服务器，自带自动 HTTPS |
| [PKUFlyingPig/cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning) | ⭐ 75.5k | HTML | 计算机自学指南 |
| [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | ⭐ 74.7k | Python | 精选的优质Claude技能、资源与工具列表，用于定制Claude AI工作流 |
...
| [Asabeneh/30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python) | ⭐ 73.2k | Python | 「Python编程30天挑战是一份分步骤的Python语言学习指南，总学习时长可能超过100天，你可以按照自己的节奏学习。这些视频也可能对你有帮助：https:… |
| [toeverything/AFFiNE](https://github.com/toeverything/AFFiNE) | ⭐ 72.4k | TypeScript | 不止有 Notion 和 Miro。AFFiNE（发音[ə‘fain]）是将规划、整理与创作整合为一体的下一代知识库。隐私优先、开源可定制，开箱即用。 |
...
| [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | ⭐ 67.7k | TypeScript | 适用于 AI 编码助手的规范驱动开发（SDD）。 |
| [cline/cline](https://github.com/cline/cline) | ⭐ 67.7k | TypeScript | 可作为 SDK、IDE 扩展或 CLI 助手使用的自主编码智能体 |
...
| [tw93/Mole](https://github.com/tw93/Mole) | ⭐ 66.6k | Shell | 🐹 清理、卸载、分析、优化与监控你的 Mac。免费开源命令行工具，另有原生 Mac 应用。 |
...
| [usememos/memos](https://github.com/usememos/memos) | ⭐ 62.9k | Go | 开源自托管笔记工具，专为快速记笔记打造。原生支持Markdown，轻量省心，完全归你所有。 |
| [byoungd/up](https://github.com/byoungd/up) | ⭐ 62.5k | JavaScript | An advanced guide which might benefit you a lot 🎉 . 韩先凯的人生进阶指南 离谱的人生/人生进阶 离谱的英语学… |
...
| [upstash/context7](https://github.com/upstash/context7) | ⭐ 61.8k | TypeScript | Context7 平台——为大语言模型和 AI 代码编辑器提供最新的代码文档 |
...
| [ghostty-org/ghostty](https://github.com/ghostty-org/ghostty) | ⭐ 60.9k | Zig | 👻 Ghostty 是一款快速、功能丰富的跨平台终端模拟器，采用平台原生 UI 与 GPU 加速。 |
...
| [jingyaogong/minimind](https://github.com/jingyaogong/minimind) | ⭐ 60.0k | Python | 🧠 仅需2小时从零训练一个64M参数的LLM！ |
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 58.3k | Python | 用于编排角色扮演型自主AI智能体的框架。CrewAI 通过培养协作智能，赋能智能体无缝协作，处理复杂任务。 |
...
| [karpathy/nanochat](https://github.com/karpathy/nanochat) | ⭐ 57.9k | Python | 花一百美元能买到的顶级ChatGPT体验。 |
...
| [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) | ⭐ 53.7k | Python | 这里精选了适用于 Claude Code 的优质资源，Claude Code 是 Anthropic PBC 开发的公认最强编码助手。这个集合展示了顶尖技能、双… |
...
| [bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) | ⭐ 52.8k | Python | 敏捷AI驱动开发的突破性方法 |
...
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | ⭐ 51.4k | TypeScript | 面向编程代理的 Chrome DevTools |
...
| [sgl-project/sglang](https://github.com/sgl-project/sglang) | ⭐ 35.7k | Python | SGLang 是面向大语言模型和多模态模型的高性能服务框架。 |
...
| [aristocratos/btop](https://github.com/aristocratos/btop) | ⭐ 34.5k | C++ | 资源监控器 |
...
| [datawhalechina/happy-llm](https://github.com/datawhalechina/happy-llm) | ⭐ 33.6k | Jupyter Notebook | 📚 从零开始构建大模型 |
...
| [maboloshi/github-chinese](https://github.com/maboloshi/github-chinese) | ⭐ 32.5k | JavaScript | GitHub 汉化插件，GitHub 中文化界面。 (GitHub Translation To Chinese) |
...
| [rustfs/rustfs](https://github.com/rustfs/rustfs) | ⭐ 31.9k | Rust | 处理4KB对象载荷时，速度比MinIO快2.3倍。RustFS是开源的S3兼容高性能对象存储系统，支持与MinIO、Ceph等其他兼容S3的平台迁移共存。 |
...
| [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | ⭐ 31.1k | Python | 构建并运行你看得见、摸得透、信得过的智能体。 |
...
| [vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills) | ⭐ 31.0k | JavaScript | Vercel 官方智能体技能合集 |
...
| [getzep/graphiti](https://github.com/getzep/graphiti) | ⭐ 30.7k | Python | 为 AI 代理构建实时知识图谱 |
| [facebook/folly](https://github.com/facebook/folly) | ⭐ 30.5k | C++ | 由 Facebook 开发并使用的开源 C++ 库。 |
| [BigPizzaV3/CodexPlusPlus](https://github.com/BigPizzaV3/CodexPlusPlus) | ⭐ 30.5k | Rust | An enhanced tool for CodexApp, striving to make Codex better to use and more com… |
...
| [liquidslr/leetcode-company-wise-problems](https://github.com/liquidslr/leetcode-company-wise-problems) | ⭐ 29.8k |  | 按公司分类的题目列表。companies 目录下每个 csv 文件对应特定公司根据 LeetCode 公司标签整理的 Leetcode 题目列表，更新至 202… |
...
| [oraios/serena](https://github.com/oraios/serena) | ⭐ 29.0k | Python | 面向编码开发的强大 MCP 工具包，提供语义检索与编辑能力——它是智能体的专属IDE |
...
| [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) | ⭐ 27.7k | TypeScript | 一个运行在你终端中的开源 AI 编程代理 |
...
| [manaflow-ai/cmux](https://github.com/manaflow-ai/cmux) | ⭐ 26.9k | Swift | 基于 Ghostty 开源改造的 macOS 终端，支持垂直标签页与 AI 编码代理通知，专为多任务处理、有序组织与可编程性打造。 |
| [OthmanAdi/planning-with-files](https://github.com/OthmanAdi/planning-with-files) | ⭐ 26.7k | Python | 为 AI 编码智能体与长时任务提供持久化文件化规划。防崩溃 markdown 规划，支持/clear清理后会话恢复与压缩，每轮重新注入应对上下文漂移，确定性完成… |
| [xai-org/grok-build](https://github.com/xai-org/grok-build) | ⭐ 26.6k | Rust | SpaceXAI 的编程代理框架与 TUI 应用。支持全屏、鼠标交互，可扩展。 |
...
| [fmtlib/fmt](https://github.com/fmtlib/fmt) | ⭐ 25.7k | C++ | 现代格式化库 |
...
| [Vonng/ddia](https://github.com/Vonng/ddia) | ⭐ 23.5k | Python | 《Designing Data-Intensive Application》DDIA 第一版 / 第二版 中文翻译 |
...
| [docmost/docmost](https://github.com/docmost/docmost) | ⭐ 21.6k | TypeScript | Docmost is an open-source collaborative wiki and documentation software. It is a… |
| [twpayne/chezmoi](https://github.com/twpayne/chezmoi) | ⭐ 21.5k | Go | 跨不同设备安全管理你的dotfiles。 |
| [p0deje/Maccy](https://github.com/p0deje/Maccy) | ⭐ 21.5k | Swift | Lightweight clipboard manager for macOS |
...
| [ccusage/ccusage](https://github.com/ccusage/ccusage) | ⭐ 18.4k | Rust | 运行 npx ccusage |
...
| [jlcodes99/cockpit-tools](https://github.com/jlcodes99/cockpit-tools) | ⭐ 17.3k | Rust | 🚀 通用 AI IDE 账号管理工具：支持 Antigravity / Codex / GitHub Copilot / Windsurf / Kiro / C… |
...
| [bin456789/reinstall](https://github.com/bin456789/reinstall) | ⭐ 13.2k | Shell | 一键DD/重装脚本 (One-click reinstall OS on VPS) |
...
| [FluentRead/FluentRead](https://github.com/FluentRead/FluentRead) | ⭐ 7.9k | TypeScript | An open-source browser extension for bilingual webpages, instant selection trans… |
...
| [zhukunpenglinyutong/jetbrains-cc-gui](https://github.com/zhukunpenglinyutong/jetbrains-cc-gui) | ⭐ 6.0k | Java | Jetbrains Claude Code 与 Codex GUI 插件 |
...
| [binaricat/Netcatty](https://github.com/binaricat/Netcatty) | ⭐ 5.8k | TypeScript | 集SSH工作区、SFTP和终端于一体 |
...
| [DetachHead/rebased🔀](https://github.com/DetachHead/rebased) | ⭐ 5.5k | Java | 基于 IntelliJ 平台的 Git 客户端 |
...
| [Buernia/Zhudou-Sans](https://github.com/Buernia/Zhudou-Sans) | ⭐ 949 |  | 煮豆黑体，Noto 风格中日韩标点符号字体。A font family for CJK symbols and punctuation, derived fro… |
| [chronolaw/cpp_study](https://github.com/chronolaw/cpp_study) | ⭐ 949 | C++ | 跟我一起学现代C++ |
| [Auto-Plugin/milkup](https://github.com/Auto-Plugin/milkup) | ⭐ 944 | TypeScript | A cross-platform, instant-rendering desktop Markdown editor 一个跨平台的、即时渲染桌面端 Markd… |
...
| [sunbigfly/ppt-agent-skills](https://github.com/sunbigfly/ppt-agent-skills) | ⭐ 892 | Python | A code-driven presentation generation framework. 像构建软件工程一样生成演示文稿。 |
...
| [terryso/claude-auto-resume](https://github.com/terryso/claude-auto-resume) | ⭐ 819 | Shell | 一款可在使用限额解除后自动恢复 Claude CLI 任务的 shell 脚本工具 |
...
| [qy527145/acemcp](https://github.com/qy527145/acemcp) | ⭐ 805 | Python | 一个将ACE(Augment Context Engine) 做成MCP的项目 |
...
| [findmover/wxread](https://github.com/findmover/wxread) | ⭐ 784 | Python | 微信读书刷时长助你成为霸榜“大佬” |
...
| [DJB-Developer/wechat-android-history-versions](https://github.com/DJB-Developer/wechat-android-history-versions) | ⭐ 762 | JavaScript | 微信Android 微信安卓版 微信安卓 历史版本 官方下载地址 |
...
| [F8F-1BearCat/CtCI-6th-Edition-CN](https://github.com/F8F-1BearCat/CtCI-6th-Edition-CN) | ⭐ 692 |  | 《Cracking the Coding Interview, 6th Edition》CtCI中文翻译 |
...
| [JackyST0/awesome-agent-skills](https://github.com/JackyST0/awesome-agent-skills) | ⭐ 633 | Shell | 🤖 精选的 AI Agent Skills 列表，适用于 Cursor、Claude Code、GitHub Copilot 等 AI 编程工具 |
...
| [nutstore/obsidian-nutstore-sync](https://github.com/nutstore/obsidian-nutstore-sync) | ⭐ 608 | TypeScript |  |
| [alexkirsz/dispatch](https://github.com/alexkirsz/dispatch) | ⭐ 597 | Rust | 合并多个网络连接，提升你的下载速度 |
...
| [Mercurygram/Mercurygram🔀](https://github.com/Mercurygram/Mercurygram) | ⭐ 586 | Java | Android 版官方 Telegram 客户端的非官方、对自由开源软件友好的分支 |
...
| [CyanoHao/Resource-Han-Rounded](https://github.com/CyanoHao/Resource-Han-Rounded) | ⭐ 578 | JavaScript | Resource Han Rounded，一款源自Source Han Sans的圆角字体家族。 |
| [Paper-Dragon/mobaxterm-crack](https://github.com/Paper-Dragon/mobaxterm-crack) | ⭐ 576 | TypeScript | 破解MobaXterm的高级版，生成密钥，支持几乎所有版本。 |
...
| [Lularible/storage-book](https://github.com/Lularible/storage-book) | ⭐ 563 | C | 一本关于存储技术与文件系统的开源书籍。从绳结记事到Flash物理特性，从FAT到LittleFS —— 还附带教学级日志结构嵌入式文件系统KnotFS（约840… |
...
| [WoJiSama/skill-based-architecture](https://github.com/WoJiSama/skill-based-architecture) | ⭐ 562 | Shell | 这是一项可以生成技能的元技能：指向任意代码库后，它就能把项目的规则、工作流与经验教训提取出来，整理存入专用的`skills/<项目名>/`目录中——这个项目技能… |
| [wzsx150/MobaXterm_CN](https://github.com/wzsx150/MobaXterm_CN) | ⭐ 560 |  | MobaXterm 综合远程工具 汉化版 |
...
| [vannvan/yuque-tools](https://github.com/vannvan/yuque-tools) | ⭐ 556 | TypeScript | 🧰 玩转语雀-朴实无华的语雀资源导出工具，语雀知识库+团队资源批量导出/备份工具(无需Token) |
...
| [baidu-baige/LoongForge](https://github.com/baidu-baige/LoongForge) | ⭐ 551 | Python | 一个用于在NVIDIA GPU和昆仑芯XPU上训练大语言模型、视觉语言模型、扩散模型以及具身智能模型的高性能框架 |
...
| [catlog22/maestro-flow](https://github.com/catlog22/maestro-flow) | ⭐ 547 | TypeScript | 面向多智能体AI开发的意图驱动工作流编排——适配Claude Code、Gemini、Codex等工具的自适应生命周期引擎、自强化知识图谱与可视化仪表盘 |
...
| [chengazhen/gitlens-pro](https://github.com/chengazhen/gitlens-pro) | ⭐ 484 | Go | 一个用于激活 GitLens Pro 的工具。 |
| [EdisonLeeeee/Awesome-Learning-Resource](https://github.com/EdisonLeeeee/Awesome-Learning-Resource) | ⭐ 480 |  | 精心整理的各类学习资源合集，涵盖博客、书籍、视频等内容 |
...
| [cocojojo5213/phonics-app](https://github.com/cocojojo5213/phonics-app) | ⭐ 441 | JavaScript | 真正从基础开始学英语 - 自然拼读练习应用 |
...
| [rashidazarang/chatgpt-chat-exporter](https://github.com/rashidazarang/chatgpt-chat-exporter) | ⭐ 377 | JavaScript | 一款轻量级浏览器端工具，可将你的ChatGPT对话导出为美观的Markdown或PDF格式。 |
...
| [yjh051108/dsh-router-standard🟡](https://github.com/yjh051108/dsh-router-standard) | ⭐ 360 | JavaScript | 已并入 dsh-routing-suite（单仓库化）；本仓库为历史镜像/归档 —— 注意力工程主线 v1.19.1/v34 研发线未发布。新代码见 githu… |
...
| [Lin-jun-xiang/awesome-vscode-extensions](https://github.com/Lin-jun-xiang/awesome-vscode-extensions) | ⭐ 300 | PowerShell | :gem:热门 VSCode 扩展精选 |
...
| [335234131/agent-browser-mcp](https://github.com/335234131/agent-browser-mcp) | ⭐ 242 | Python | 让 Agent 直接操作真实 Chrome 的 MCP 服务，支持页面扫描、CDP、截图与物理输入 |
| [thep0y/monaco-nerd-font](https://github.com/thep0y/monaco-nerd-font) | ⭐ 242 | Shell | 已添加粗体、斜体和粗斜体的 Monaco Nerd Font |
...
| [holtwood/awesome-cursorrules-zh](https://github.com/holtwood/awesome-cursorrules-zh) | ⭐ 233 | JavaScript | Cursor AI 编程规则精选集 | 132+ 规则，覆盖前端/后端/AI/DevOps 等 32 个领域 |
...
| [gally16/LLM-Jailbreaking-Guide](https://github.com/gally16/LLM-Jailbreaking-Guide) | ⭐ 151 |  | LLM Jailbreaking Guide主流大语言模型越狱指南 |
...
| [Ssabby1/repo-to-resume-tailor](https://github.com/Ssabby1/repo-to-resume-tailor) | ⭐ 123 | Python | 可根据目标岗位或职位描述，将代码仓库转换为适配简历的项目经历描述 |
...
| [TideTree/50projects50days-zh](https://github.com/TideTree/50projects50days-zh) | ⭐ 7 | CSS | 🎯 通过50个精心设计的前端项目掌握HTML5、CSS3、JavaScript技能 |
