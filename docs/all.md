...
| 项目 | 星数 | 语言 | 描述 |
|------|------|------|------|
| [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | ⭐ 546.4k | Markdown | 通过从零重写你喜爱的技术来精通编程。 |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 504.9k |  | 汇集各类趣味主题的超棒精选列表【注：在我处理完现有PR前，暂时关闭拉取请求提交】 |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 478.7k | Python | 免费API集合列表 |
...
| [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | ⭐ 396.5k | Python | :books: 免费开源编程书籍 |
| [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | ⭐ 369.3k | Python | 学习如何设计大规模系统，备战系统设计面试，包含Anki闪卡。 |
...
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 319.9k | Python | 专门解答「我想用Python做X该用什么工具？」的权威工具清单 |
| [obra/superpowers](https://github.com/obra/superpowers) | ⭐ 284.8k | Shell | 一套行之有效的智能体技能框架与软件开发方法论。 |
| [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | ⭐ 282.9k | Python | 精选基于项目的教程列表 |
| [mattpocock/skills](https://github.com/mattpocock/skills) | ⭐ 259.0k | Shell | 真正工程师必备技能，直接来自我的.agents目录。 |
...
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | ⭐ 244.3k | Python | The agent that grows with you |
...
| [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | ⭐ 198.6k | Markdown | 为所有人提供免费域名注册与实用DNS学习资源 |
| [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) | ⭐ 190.1k | Batchfile | 开源Windows和Office激活工具，支持HWID、Ohook、TSforge和在线KMS激活方式，同时具备高级故障排查功能 |
...
| [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | ⭐ 175.9k | Python | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source proj… |
| [anthropics/skills](https://github.com/anthropics/skills) | ⭐ 175.7k | Python | Agent 技能公开仓库 |
...
| [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) | ⭐ 143.7k | TypeScript | 基于 Tauri 构建的现代化图形界面客户端，支持在 Windows、macOS 和 Linux 运行，提供定制化代理体验 |
...
| [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code) | ⭐ 78.5k | Python | 上传截图，即可将其转换为整洁的代码（HTML/Tailwind/React/Vue） |
...
| [Asabeneh/30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python) | ⭐ 73.4k | Python | 「Python编程30天挑战是一份分步骤的Python语言学习指南，总学习时长可能超过100天，你可以按照自己的节奏学习。这些视频也可能对你有帮助：https:… |
...
| [tw93/Mole](https://github.com/tw93/Mole) | ⭐ 66.8k | Shell | 🐹 清理、卸载、分析、优化与监控你的 Mac。免费开源命令行工具，另有原生 Mac 应用。 |
...
| [tt-a1i/archify](https://github.com/tt-a1i/archify) | ⭐ 57.6k | JavaScript | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flo… |
...
| [chen08209/FlClash](https://github.com/chen08209/FlClash) | ⭐ 51.7k | Dart | 基于 ClashMeta 的多平台代理客户端，简洁易用，开源无广告。 |
...
| [QuantumNous/new-api](https://github.com/QuantumNous/new-api) | ⭐ 47.8k | Go | 一个用于聚合与分发的统一AI模型 hub，支持将各类大语言模型转换为兼容OpenAI、Claude或Gemini的格式，是供个人与企业进行模型管理的集中网关。 |
...
| [files-community/Files](https://github.com/files-community/Files) | ⭐ 45.2k | C# | 一款可帮助用户整理文件与文件夹的现代化文件管理器 |
...
| [maboloshi/github-chinese](https://github.com/maboloshi/github-chinese) | ⭐ 32.6k | JavaScript | GitHub 汉化插件，GitHub 中文化界面。 (GitHub Translation To Chinese) |
...
| [OpenBMB/MiniCPM](https://github.com/OpenBMB/MiniCPM) | ⭐ 10.8k | Jupyter Notebook | MiniCPM5: SOTA on-device LLMs, small yet powerful. |
...
| [huifer/WellAlly-health](https://github.com/huifer/WellAlly-health) | ⭐ 947 | Shell | Ally-Health 是一款智能医疗助手，它依托先进AI技术与医学专业知识革新个人健康管理。它通过自然语言交互帮助用户记录症状、管理用药、整理病历并获取多学科… |
...
| [zkep/my-geektime](https://github.com/zkep/my-geektime) | ⭐ 788 | Go | 👏 Make learning a lifelong habit. 学无止境 |
...
| [Delppine1024/TGreen](https://github.com/Delppine1024/TGreen) | ⭐ 773 |  | 部分文件在 T v1.1 上可正常运行（最新支持版本为 v1.9.5/1.9.2-dev），基于 TC 开发 |
| [OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL](https://github.com/OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL) | ⭐ 771 |  | 去AI味提示词-作家增强-SKILL |
...
| [Kuddev/pebrel](https://github.com/Kuddev/pebrel) | ⭐ 724 | Rust | AI-native, GPU-accelerated terminal emulator for Windows with SSH, persistent se… |
...
| [CyanoHao/Resource-Han-Rounded](https://github.com/CyanoHao/Resource-Han-Rounded) | ⭐ 579 | JavaScript | Resource Han Rounded，一款源自Source Han Sans的圆角字体家族。 |
...
| [ChengShiest/LAST-ViT](https://github.com/ChengShiest/LAST-ViT) | ⭐ 459 | Python | [CVPR 2026] 论文《Vision Transformer Needs More Than Registers》的官方PyTorch实现 |
...
| [RethinkFun/DeepLearning](https://github.com/RethinkFun/DeepLearning) | ⭐ 454 | Python |  |
...
| [datawhalechina/awesome-compression](https://github.com/datawhalechina/awesome-compression) | ⭐ 383 |  | 模型压缩的小白入门教程，PDF下载地址 https://github.com/datawhalechina/awesome-compression/releas… |
| [MAXeaglet/commandcode-proxy](https://github.com/MAXeaglet/commandcode-proxy) | ⭐ 381 | JavaScript | Command Code API 反代代理，兼容 OpenAI 与 Anthropic 接口 | Reverse proxy exposing Command… |
...
| [thep0y/monaco-nerd-font](https://github.com/thep0y/monaco-nerd-font) | ⭐ 243 | Shell | 已添加粗体、斜体和粗斜体的 Monaco Nerd Font |
