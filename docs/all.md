...
> 全部 **1362** 个 Star 项目,按 ⭐ 排序

| 项目 | 星数 | 语言 | 描述 |
|------|------|------|------|
| [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | ⭐ 548.1k | Markdown | 通过从零重写你喜爱的技术来精通编程。 |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 507.6k |  | 汇集各类趣味主题的超棒精选列表【注：在我处理完现有PR前，暂时关闭拉取请求提交】 |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 481.5k | Python | 免费API集合列表 |
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | ⭐ 455.7k | TypeScript | freeCodeCamp.org 的开源代码库与课程。免费学习数学、编程与计算机科学。 |
| [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | ⭐ 397.2k | Python | :books: 免费开源编程书籍 |
| [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | ⭐ 370.7k | Python | 学习如何设计大规模系统，备战系统设计面试，包含Anki闪卡。 |
| [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | ⭐ 367.6k | TypeScript | 助力开发者职业成长的交互式路线图、指南及其他教育内容。 |
| [jwasham/coding-interview-university](https://github.com/jwasham/coding-interview-university) | ⭐ 361.2k |  | 一份成为软件工程师的完整计算机科学学习计划 |
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 321.6k | Python | 专门解答「我想用Python做X该用什么工具？」的权威工具清单 |
| [obra/superpowers](https://github.com/obra/superpowers) | ⭐ 288.6k | Shell | 一套行之有效的智能体技能框架与软件开发方法论。 |
| [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | ⭐ 283.8k | Python | 精选基于项目的教程列表 |
| [mattpocock/skills](https://github.com/mattpocock/skills) | ⭐ 265.3k | Shell | 真正工程师必备技能，直接来自我的.agents目录。 |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 262.1k | JavaScript | 这是智能代理性能优化系统，为 Claude Code、Codex、Opencode、Cursor 及更多 AI 编码工具提供技能、本能、记忆、安全能力与研究优先… |
| [react/react](https://github.com/react/react) | ⭐ 250.6k | JavaScript | 用于构建网页和原生用户界面的库。 |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | ⭐ 246.9k | Python | The agent that grows with you |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 229.2k | TypeScript | DeepSeek Harness：万物皆插件。 |
| [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) | ⭐ 224.7k | Python | 用Python实现的所有算法 |
| [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | ⭐ 214.0k |  | 基于Andrej Karpathy对大语言模型编码陷阱的观察，通过单个CLAUDE.md文件优化Claude Code的行为。 |
| [vuejs/vue](https://github.com/vuejs/vue) | ⭐ 212.8k | TypeScript | 这是 Vue 2 的仓库。Vue 3 请访问 https://github.com/vuejs/core |
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | ⭐ 208.5k | TypeScript | 开源编码智能体 |
| [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | ⭐ 200.1k | Markdown | 为所有人提供免费域名注册与实用DNS学习资源 |
| [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) | ⭐ 191.2k | Batchfile | 开源Windows和Office激活工具，支持HWID、Ohook、TSforge和在线KMS激活方式，同时具备高级故障排查功能 |
| [Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | ⭐ 187.4k | Python | AutoGPT 的愿景是让所有人都能便捷使用并基于它开发人工智能。我们的使命是提供工具，让你专注于真正重要的事。 |
| [jackfrued/Python-100-Days](https://github.com/jackfrued/Python-100-Days) | ⭐ 186.6k | Jupyter Notebook | Python - 100天从新手到大师 |
| [CyC2018/CS-Notes](https://github.com/CyC2018/CS-Notes) | ⭐ 186.2k |  | :books: 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计 |
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | ⭐ 185.4k | Python | 用于将文件和办公文档转换为 Markdown 的 Python 工具 |
| [ollama/ollama](https://github.com/ollama/ollama) | ⭐ 181.2k | Go | 快速上手 Kimi-K2.6、GLM-5.2、MiniMax、DeepSeek、gpt-oss、Qwen、Gemma 等各类大模型。 |
| [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | ⭐ 177.4k | Python | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source proj… |
| [anthropics/skills](https://github.com/anthropics/skills) | ⭐ 177.1k | Python | Agent 技能公开仓库 |
| [jlevy/the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) | ⭐ 162.4k |  | 掌握命令行，只需一页 |
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 152.5k | Python | 易用的 AI 界面（支持 Ollama、OpenAI API 等） |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.6k | Python | 智能体工程开发平台 |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | ⭐ 146.3k | TypeScript | Claude Code 是一款可在终端内运行的智能编码工具，它能理解你的代码库，通过自然语言命令帮你完成例行任务、讲解复杂代码、处理 git 工作流，让你的编码… |
| [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) | ⭐ 145.3k | Rust | 基于 Tauri 构建的现代化图形界面客户端，支持在 Windows、macOS 和 Linux 运行，提供定制化代理体验 |
| [x1xhlol/system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | ⭐ 143.7k |  | 包含FULL Augment Code、Claude Code、Cluely、CodeBuddy、Comet、Cursor、Devin AI、Junie、Kir… |
| [golang/go](https://github.com/golang/go) | ⭐ 138.9k | Go | Go 编程语言 |
| [github/spec-kit](https://github.com/github/spec-kit) | ⭐ 137.8k | Python | 用于帮助你上手规范驱动开发的工具套件 |
| [labuladong/fucking-algorithm](https://github.com/labuladong/fucking-algorithm) | ⭐ 135.9k | Markdown | 破解LeetCode，不仅要知其然，更要知其所以然。 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | ⭐ 133.6k | Rust | 适用于 Claude Code、Codex、OpenCode、OpenClaw、Grok Build 与 Hermes Agent 的跨平台桌面一站式助手。唯一… |
| [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | ⭐ 128.9k | Python | 一款可为多平台构建专业UI/UX提供设计智能支持的AI技能。 |
| [openai/codex](https://github.com/openai/codex) | ⭐ 125.2k | Rust | 可在终端运行的轻量级编码智能体 |
| [microsoft/generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners) | ⭐ 120.0k | Jupyter Notebook | 21节课，从零开始构建生成式AI项目 |
| [justjavac/free-programming-books-zh_CN](https://github.com/justjavac/free-programming-books-zh_CN) | ⭐ 119.0k |  | :books: 免费的计算机编程类中文书籍，欢迎投稿 |
| [2dust/v2rayN](https://github.com/2dust/v2rayN) | ⭐ 116.5k | C# | 支持Xray、sing-box等的多平台GUI客户端，兼容Windows、Linux与macOS |
| [openai/whisper](https://github.com/openai/whisper) | ⭐ 109.3k | Python | 基于大规模弱监督的稳健语音识别 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | ⭐ 107.1k | TypeScript | 一款可将 Gemini 的能力直接引入终端的开源 AI 智能体 |
| [earendil-works/pi](https://github.com/earendil-works/pi) | ⭐ 107.1k | TypeScript | AI 智能体工具包：统一大语言模型API、智能体循环、终端用户界面、编程智能体命令行工具 |
| [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | ⭐ 106.6k | Go | 🪨 能少用token干嘛用那么多——这是Claude Code技能，模仿原始人说话帮你砍掉65%的token用量 |
| [ruanyf/weekly](https://github.com/ruanyf/weekly) | ⭐ 102.9k |  | 科技爱好者周刊，每周五发布 |
| [fastapi/fastapi](https://github.com/fastapi/fastapi) | ⭐ 102.4k | Python | FastAPI 框架，高性能，易学习，编码快，可用于生产环境 |
...
| [hacksider/Deep-Live-Cam](https://github.com/hacksider/Deep-Live-Cam) | ⭐ 96.7k | Python | 仅需单张图片即可实现实时换脸与一键视频深度伪造 |
| [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 95.2k |  | MCP 服务器集合 |
| [localsend/localsend](https://github.com/localsend/localsend) | ⭐ 92.0k | Dart | AirDrop 的开源跨平台替代工具 |
| [deepseek-ai/DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) | ⭐ 92.0k |  |  |
| [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) | ⭐ 91.5k | JavaScript | 酷炫的自托管监控工具 |
...
| [macrozheng/mall](https://github.com/macrozheng/mall) | ⭐ 84.8k | Java | mall项目是一套电商系统，包括前台商城系统及后台管理系统，基于Spring Boot+MyBatis实现，采用Docker容器化部署。 前台商城系统包含首页门… |
| [DopplerHQ/awesome-interview-questions🟡](https://github.com/DopplerHQ/awesome-interview-questions) | ⭐ 84.6k |  | :octocat: 精心整理的面试题清单合集，欢迎贡献！ :mortar_board: |
| [junegunn/fzf](https://github.com/junegunn/fzf) | ⭐ 83.1k | Go | :cherry_blossom: 命令行模糊查找器 |
| [mlabonne/llm-course](https://github.com/mlabonne/llm-course) | ⭐ 83.0k |  | 带你入门大语言模型（LLM）的课程，包含学习路线图与 Colab 笔记本。 |
| [vitejs/vite](https://github.com/vitejs/vite) | ⭐ 82.9k | TypeScript | 下一代前端工具链，极速体验！ |
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | ⭐ 82.7k | Python | 这是一个可完成调研、编码与创作的开源长周期SuperAgent框架。借助沙箱、记忆、工具、技能、子代理与消息网关，它能处理耗时数分钟到数小时的不同层级任务。 |
| [lobehub/lobehub](https://github.com/lobehub/lobehub) | ⭐ 82.6k | TypeScript | 🤯 LobeHub 是你的智能体总运营官，可通过招聘、排程与全团队报表，将你的 AI 智能体组建成 7×24 不间断运作的团队。 |
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | ⭐ 81.0k | Rust | CLI 代理，可将常用开发命令的 LLM 令牌消耗降低 60-90%，单Rust二进制文件，零依赖 |
| [d2l-ai/d2l-zh](https://github.com/d2l-ai/d2l-zh) | ⭐ 80.8k | Python | 《动手学深度学习》：面向中文读者、能运行、可讨论。中英文版被70多个国家的500多所大学用于教学。 |
...
| [datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents) | ⭐ 79.8k | Python | 📚 《从零开始构建智能体》——从零开始的智能体原理与实践教程 |
| [coder/code-server](https://github.com/coder/code-server) | ⭐ 79.4k | TypeScript | 浏览器中的 VS Code |
| [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code) | ⭐ 79.3k | Python | 上传截图，即可将其转换为整洁的代码（HTML/Tailwind/React/Vue） |
...
| [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) | ⭐ 78.5k | MDX | 用于提示工程、上下文工程、RAG 与 AI 智能体的指南、论文、教程、笔记与资源汇总 |
...
| [redis/redis](https://github.com/redis/redis) | ⭐ 76.4k | C | 对于构建实时数据驱动应用的开发者而言，Redis是首选的、性能最快、功能最丰富的缓存、数据结构服务器，以及文档与向量查询引擎。 |
| [ocornut/imgui](https://github.com/ocornut/imgui) | ⭐ 76.3k | C++ | Dear ImGui：适用于C++的低依赖、无冗余图形用户界面 |
| [openai/openai-cookbook](https://github.com/openai/openai-cookbook) | ⭐ 76.1k | Jupyter Notebook | OpenAI API 使用示例与指南 |
| [caddyserver/caddy](https://github.com/caddyserver/caddy) | ⭐ 75.8k | Go | 快速可扩展的多平台 HTTP/1-2-3 Web 服务器，自带自动 HTTPS |
| [PKUFlyingPig/cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning) | ⭐ 75.7k | HTML | 计算机自学指南 |
| [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | ⭐ 75.3k | Python | 精选的优质Claude技能、资源与工具列表，用于定制Claude AI工作流 |
| [Asabeneh/30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python) | ⭐ 74.1k | Python | 「Python编程30天挑战是一份分步骤的Python语言学习指南，总学习时长可能超过100天，你可以按照自己的节奏学习。这些视频也可能对你有帮助：https:… |
...
| [fffaraz/awesome-cpp](https://github.com/fffaraz/awesome-cpp) | ⭐ 73.3k |  | 精选的优质 C++（及 C）框架、库、资源与趣味项目列表，灵感源自各类「awesome」清单项目。 |
| [toeverything/AFFiNE](https://github.com/toeverything/AFFiNE) | ⭐ 72.8k | TypeScript | 不止有 Notion 和 Miro。AFFiNE（发音[ə‘fain]）是将规划、整理与创作整合为一体的下一代知识库。隐私优先、开源可定制，开箱即用。 |
| [stablyai/orca](https://github.com/stablyai/orca) | ⭐ 72.0k | TypeScript | Orca is the ADE for working with a fleet of parallel agents. Run any coding agen… |
| [protocolbuffers/protobuf](https://github.com/protocolbuffers/protobuf) | ⭐ 72.0k | C++ | Protocol Buffers — Google 的数据交换格式 |
| [FoundationAgents/MetaGPT](https://github.com/FoundationAgents/MetaGPT) | ⭐ 70.5k | Python | 🌟 多智能体框架：首个AI软件公司，向着自然语言编程前进 |
| [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | ⭐ 69.4k | TypeScript | 适用于 AI 编码助手的规范驱动开发（SDD）。 |
| [code-yeongyu/oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) | ⭐ 69.2k | TypeScript | omo/lazycodex：面向token优化者的编码智能体；唯一可驾驭复杂代码库的智能体框架。为你的Codex、为你的OpenCode打造 |
| [cline/cline](https://github.com/cline/cline) | ⭐ 68.7k | TypeScript | 可作为 SDK、IDE 扩展或 CLI 助手使用的自主编码智能体 |
| [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) | ⭐ 67.8k | Rust | 用 Rust 编写的非官方兼容 Bitwarden 的服务端，曾用名 bitwarden_rs |
| [tw93/Mole](https://github.com/tw93/Mole) | ⭐ 67.7k | Shell | 🐹 清理、卸载、分析、优化与监控你的 Mac。免费开源命令行工具，另有原生 Mac 应用。 |
| [apache/echarts](https://github.com/apache/echarts) | ⭐ 67.3k | TypeScript | Apache ECharts 是一款功能强大、可交互的浏览器端图表与数据可视化库 |
| [tt-a1i/archify](https://github.com/tt-a1i/archify) | ⭐ 66.9k | JavaScript | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flo… |
...
| [warpdotdev/warp](https://github.com/warpdotdev/warp) | ⭐ 65.1k | Rust | Warp 是源自终端的智能体开发环境。 |
...
| [usememos/memos](https://github.com/usememos/memos) | ⭐ 63.2k | Go | 开源自托管笔记工具，专为快速记笔记打造。原生支持Markdown，轻量省心，完全归你所有。 |
| [byoungd/up](https://github.com/byoungd/up) | ⭐ 63.2k | JavaScript | An advanced guide which might benefit you a lot 🎉 . 韩先凯的人生进阶指南 离谱的人生/人生进阶 离谱的英语学… |
| [2dust/v2rayNG](https://github.com/2dust/v2rayNG) | ⭐ 62.8k | Kotlin | 适用于 Android 的 V2Ray 客户端，支持 Xray 核心与 v2fly 核心 |
| [youngyangyang04/leetcode-master](https://github.com/youngyangyang04/leetcode-master) | ⭐ 62.5k | Shell | 《代码随想录》LeetCode 刷题攻略：200道经典题目刷题顺序，共60w字的详细图解，视频难点剖析，50余张思维导图，支持C++，Java，Python，G… |
| [upstash/context7](https://github.com/upstash/context7) | ⭐ 62.2k | TypeScript | Context7 平台——为大语言模型和 AI 代码编辑器提供最新的代码文档 |
| [jingyaogong/minimind](https://github.com/jingyaogong/minimind) | ⭐ 61.6k | Python | 🧠 仅需2小时从零训练一个64M参数的LLM！ |
| [tw93/Pake](https://github.com/tw93/Pake) | ⭐ 61.5k | Rust | 🤱🏻 一条命令即可把任意网页打包为桌面应用。 |
| [1c7/chinese-independent-developer](https://github.com/1c7/chinese-independent-developer) | ⭐ 61.5k |  | 👩🏿‍💻👨🏾‍💻👩🏼‍💻👨🏽‍💻👩🏻‍💻中国独立开发者项目列表 -- 分享大家都在做什么 |
| [minio/minio🟡](https://github.com/minio/minio) | ⭐ 61.4k | Go | MinIO 是一款高性能、兼容 S3 的对象存储，以 GNU AGPLv3 许可证开源。 |
| [ghostty-org/ghostty](https://github.com/ghostty-org/ghostty) | ⭐ 61.3k | Zig | 👻 Ghostty 是一款快速、功能丰富的跨平台终端模拟器，采用平台原生 UI 与 GPU 加速。 |
| [pocketbase/pocketbase](https://github.com/pocketbase/pocketbase) | ⭐ 61.1k | Go | 单文件开源实时后端 |
| [xingshaocheng/architect-awesome](https://github.com/xingshaocheng/architect-awesome) | ⭐ 60.9k |  | 后端架构师技术图谱 |
| [sharkdp/bat](https://github.com/sharkdp/bat) | ⭐ 60.5k | Rust | 带翅膀的 cat(1) 克隆版 |
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 58.7k | Python | 用于编排角色扮演型自主AI智能体的框架。CrewAI 通过培养协作智能，赋能智能体无缝协作，处理复杂任务。 |
| [FoundationAgents/OpenManus](https://github.com/FoundationAgents/OpenManus) | ⭐ 58.3k | Python | 没有堡垒，唯有纯粹的开阔之地。OpenManus，即将到来。 |
| [karpathy/nanochat](https://github.com/karpathy/nanochat) | ⭐ 58.1k | Python | 花一百美元能买到的顶级ChatGPT体验。 |
| [go-gitea/gitea](https://github.com/go-gitea/gitea) | ⭐ 58.1k | Go | 品茶般顺畅的Git体验！无痛一键自托管一体化软件开发服务，涵盖Git托管、代码评审、团队协作、软件包注册表与CI/CD |
...
| [typst/typst](https://github.com/typst/typst) | ⭐ 56.1k | Rust | 基于标记、功能强大且易于学习的排版系统 |
...
| [aaif-goose/goose](https://github.com/aaif-goose/goose) | ⭐ 54.5k | Rust | 开源可扩展AI agent，不止提供代码建议——可搭配任意LLM完成安装、执行、编辑与测试 |
| [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) | ⭐ 54.3k | Python | 这里精选了适用于 Claude Code 的优质资源，Claude Code 是 Anthropic PBC 开发的公认最强编码助手。这个集合展示了顶尖技能、双… |
| [ElemeFE/element](https://github.com/ElemeFE/element) | ⭐ 54.0k | Vue | 适用于Web的Vue.js 2.0 UI组件库 |
| [bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) | ⭐ 53.2k | Python | 敏捷AI驱动开发的突破性方法 |
...
| [chen08209/FlClash](https://github.com/chen08209/FlClash) | ⭐ 52.6k | Dart | 基于 ClashMeta 的多平台代理客户端，简洁易用，开源无广告。 |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | ⭐ 52.3k | TypeScript | 面向编程代理的 Chrome DevTools |
...
| [Aider-AI/aider](https://github.com/Aider-AI/aider) | ⭐ 49.0k | Python | aider 是你终端里的 AI 结对编程工具 |
...
| [QuantumNous/new-api](https://github.com/QuantumNous/new-api) | ⭐ 48.4k | Go | 一个用于聚合与分发的统一AI模型 hub，支持将各类大语言模型转换为兼容OpenAI、Claude或Gemini的格式，是供个人与企业进行模型管理的集中网关。 |
...
| [nvm-windows/nvm](https://github.com/nvm-windows/nvm) | ⭐ 47.7k | Inno Setup | 适用于 Windows 的 Node.js 版本管理器。 |
...
| [9001/copyparty](https://github.com/9001/copyparty) | ⭐ 46.7k | Python | 一体化便携文件服务器，支持断点续传加速、去重、WebDAV、SFTP、FTP、TFTP、零配置、媒体索引、缩略图生成，所有功能集成于单个文件 |
| [iina/iina](https://github.com/iina/iina) | ⭐ 46.4k | Swift | 适用于 macOS 的现代化视频播放器。 |
| [MetaCubeX/ClashMetaForAndroid🔀](https://github.com/MetaCubeX/ClashMetaForAndroid) | ⭐ 46.4k | Kotlin | 适用于 Android 的基于规则的隧道工具 |
| [docker/awesome-compose](https://github.com/docker/awesome-compose) | ⭐ 46.4k | HTML | 精选 Docker Compose 示例 |
| [helix-editor/helix](https://github.com/helix-editor/helix) | ⭐ 46.3k | Rust | 后现代模态文本编辑器。 |
| [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) | ⭐ 46.2k | TypeScript | 🧡 一切皆可RSS |
| [karanpratapsingh/system-design](https://github.com/karanpratapsingh/system-design) | ⭐ 46.1k |  | 学习如何设计大规模系统，备战系统设计面试 |
...
| [paperless-ngx/paperless-ngx](https://github.com/paperless-ngx/paperless-ngx) | ⭐ 45.3k | Python | 社区驱动的增强型文档管理系统：扫描、索引并归档您所有的文档 |
| [spf13/cobra](https://github.com/spf13/cobra) | ⭐ 44.6k | Go | 现代 Go CLI 交互的命令框架 |
| [janhq/jan](https://github.com/janhq/jan) | ⭐ 44.6k | TypeScript | Jan 是可 100% 在你电脑本地离线运行的开源 ChatGPT 替代方案。 |
| [sharkdp/fd](https://github.com/sharkdp/fd) | ⭐ 44.5k | Rust | find 的简单、快速、易用替代工具 |
...
| [microsoft/BitNet](https://github.com/microsoft/BitNet) | ⭐ 40.3k | C++ | 1位大语言模型的官方推理框架 |
...
| [wshobson/agents](https://github.com/wshobson/agents) | ⭐ 39.8k | Python | 适用于 Claude Code、Codex、Cursor、OpenCode、GitHub Copilot 和 Google Antigravity 的多线束智能… |
...
| [Yeachan-Heo/oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) | ⭐ 39.2k | TypeScript | 面向Teams的Claude Code多智能体编排工具 |
...
| [TriliumNext/Trilium](https://github.com/TriliumNext/Trilium) | ⭐ 37.9k | TypeScript | 使用 Trilium Notes 构建你的个人知识库 |
| [exacity/deeplearningbook-chinese](https://github.com/exacity/deeplearningbook-chinese) | ⭐ 37.5k | TeX | 《深度学习》一书中文译本 |
| [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) | ⭐ 37.3k | TypeScript | 为每个AI代理提供统一本地控制平面：跨模型路由、融合新能力、编排工具，全程完全自主掌控。 |
| [searxng/searxng](https://github.com/searxng/searxng) | ⭐ 37.3k | Python | SearXNG 是一款免费的互联网元搜索引擎，可聚合来自多种搜索服务与数据库的搜索结果。它不会追踪用户，也不会为用户建立画像。 |
| [PDFMathTranslate/PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate) | ⭐ 37.1k | Python | [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 A… |
| [songquanpeng/one-api](https://github.com/songquanpeng/one-api) | ⭐ 37.0k | JavaScript | LLM API 管理 & 分发系统，支持 OpenAI、Azure、Anthropic Claude、Google Gemini、DeepSeek、字节豆包、C… |
...
| [sgl-project/sglang](https://github.com/sgl-project/sglang) | ⭐ 36.2k | Python | SGLang 是面向大语言模型和多模态模型的高性能服务框架。 |
...
| [DayuanJiang/next-ai-draw-io](https://github.com/DayuanJiang/next-ai-draw-io) | ⭐ 35.9k | TypeScript | 这是集成了AI能力与draw.io图表的next.js网页应用，支持你通过自然语言指令和AI辅助可视化来创建、修改与优化图表。 |
...
| [aristocratos/btop](https://github.com/aristocratos/btop) | ⭐ 34.6k | C++ | 资源监控器 |
| [xitu/gold-miner](https://github.com/xitu/gold-miner) | ⭐ 34.3k |  | 🥇掘金翻译计划，可能是世界最大最好的英译中技术社区，最懂读者和译者的翻译平台： |
| [valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher) | ⭐ 33.9k | C | 本项目旨在优化 Windows 平台的工作环境 |
| [datawhalechina/happy-llm](https://github.com/datawhalechina/happy-llm) | ⭐ 33.9k | Jupyter Notebook | 📚 从零开始构建大模型 |
...
| [waydabber/BetterDisplay](https://github.com/waydabber/BetterDisplay) | ⭐ 33.7k |  | 解锁你的 Mac 显示器！支持灵活的 HiDPI 缩放、XDR/HDR 额外亮度、虚拟屏幕、DDC 控制、深度调光、画中画/投屏、EDID 覆盖等更多功能！ |
| [rustfs/rustfs](https://github.com/rustfs/rustfs) | ⭐ 33.2k | Rust | 处理4KB对象载荷时，速度比MinIO快2.3倍。RustFS是开源的S3兼容高性能对象存储系统，支持与MinIO、Ceph等其他兼容S3的平台迁移共存。 |
| [maboloshi/github-chinese](https://github.com/maboloshi/github-chinese) | ⭐ 33.1k | JavaScript | GitHub 汉化插件，GitHub 中文化界面。 (GitHub Translation To Chinese) |
| [iOfficeAI/AionUi](https://github.com/iOfficeAI/AionUi) | ⭐ 32.9k | TypeScript | 适配 OpenClaw、Hermes、Claude Code、Codex、OpenCode 等二十余种 CLI 智能代理的开源全天候协作应用，支持自定义助手、组… |
...
| [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | ⭐ 31.9k | Python | 构建并运行你看得见、摸得透、信得过的智能体。 |
| [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) | ⭐ 31.8k | TypeScript | ⌥ Coding agent with the IDE wired in |
...
| [lbjlaq/Antigravity-Manager](https://github.com/lbjlaq/Antigravity-Manager) | ⭐ 31.5k | Rust | Professional Antigravity Account Manager & Switcher. One-click seamless account… |
| [imthenachoman/How-To-Secure-A-Linux-Server](https://github.com/imthenachoman/How-To-Secure-A-Linux-Server) | ⭐ 31.4k |  | 一份不断更新的Linux服务器安全防护实操指南 |
| [vercel-labs/agent-skills](https://github.com/vercel-labs/agent-skills) | ⭐ 31.3k | JavaScript | Vercel 官方智能体技能合集 |
| [BigPizzaV3/CodexPlusPlus](https://github.com/BigPizzaV3/CodexPlusPlus) | ⭐ 31.2k | Rust | An enhanced tool for CodexApp, striving to make Codex better to use and more com… |
...
| [getzep/graphiti](https://github.com/getzep/graphiti) | ⭐ 31.0k | Python | 为 AI 代理构建实时知识图谱 |
...
| [Johnshall/Shadowrocket-ADBlock-Rules-Forever](https://github.com/Johnshall/Shadowrocket-ADBlock-Rules-Forever) | ⭐ 30.3k |  | 提供多款 Shadowrocket 规则，拥有强劲的广告过滤功能。每日 8 时重新构建规则。 |
| [AllThingsSmitty/css-protips](https://github.com/AllThingsSmitty/css-protips) | ⭐ 30.3k |  | 帮助你把CSS技能练到专业级的技巧合集 |
| [liquidslr/leetcode-company-wise-problems](https://github.com/liquidslr/leetcode-company-wise-problems) | ⭐ 30.2k |  | 按公司分类的题目列表。companies 目录下每个 csv 文件对应特定公司根据 LeetCode 公司标签整理的 Leetcode 题目列表，更新至 202… |
...
| [521xueweihan/GitHub520](https://github.com/521xueweihan/GitHub520) | ⭐ 29.7k | Python | :kissing_heart: 让你“爱”上 GitHub，解决访问时图裂、加载慢的问题。（无需安装） |
...
| [oraios/serena](https://github.com/oraios/serena) | ⭐ 29.6k | Python | 面向编码开发的强大 MCP 工具包，提供语义检索与编辑能力——它是智能体的专属IDE |
| [aosabook/500lines](https://github.com/aosabook/500lines) | ⭐ 29.6k | JavaScript | 500行以内项目 |
| [aishwaryanr/awesome-generative-ai-guide](https://github.com/aishwaryanr/awesome-generative-ai-guide) | ⭐ 29.5k | HTML | 生成式AI研究动态、面试资料、Notebook等资源的一站式仓库 |
| [karakeep-app/karakeep](https://github.com/karakeep-app/karakeep) | ⭐ 29.1k | TypeScript | 支持自托管的全类型书签应用，可收纳链接、笔记与图片，带AI自动 tagging 和全文搜索 |
| [wezterm/wezterm](https://github.com/wezterm/wezterm) | ⭐ 28.9k | Rust | 由 @wez 使用 Rust 开发的GPU加速跨平台终端模拟器与多路复用器 |
...
| [subframe7536/maple-font](https://github.com/subframe7536/maple-font) | ⭐ 28.9k | Python | Maple Mono: Open source monospace font with round corner, ligatures and Nerd-Fon… |
...
| [yamadashy/repomix](https://github.com/yamadashy/repomix) | ⭐ 28.4k | TypeScript | 📦 Repomix 是一款强大工具，可将整个代码仓库打包为单个对 AI 友好的文件。非常适合需要把代码库喂给大语言模型（LLM）或 Claude、ChatGPT… |
...
| [charmbracelet/crush](https://github.com/charmbracelet/crush) | ⭐ 28.2k | Go | 让所有人都能用上魅力十足的智能编码代理 |
| [BloopAI/vibe-kanban](https://github.com/BloopAI/vibe-kanban) | ⭐ 28.1k | Rust | 让 Claude Code、Codex 或任何编程智能体的效能提升 10 倍 |
| [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) | ⭐ 28.0k | TypeScript | 一个运行在你终端中的开源 AI 编程代理 |
...
| [forthespada/CS-Books](https://github.com/forthespada/CS-Books) | ⭐ 27.3k |  | 🔥🔥超过1000本的计算机经典书籍、个人笔记资料以及本人在各平台发表文章中所涉及的资源等。书籍资源包括C/C++、Java、Python、Go语言、数据结构与算… |
...
| [OthmanAdi/planning-with-files](https://github.com/OthmanAdi/planning-with-files) | ⭐ 27.0k | Shell | 为 AI 编码智能体与长时任务提供持久化文件化规划。防崩溃 markdown 规划，支持/clear清理后会话恢复与压缩，每轮重新注入应对上下文漂移，确定性完成… |
| [xai-org/grok-build](https://github.com/xai-org/grok-build) | ⭐ 26.9k | Rust | SpaceXAI 的编程代理框架与 TUI 应用。支持全屏、鼠标交互，可扩展。 |
| [lissy93/dashy](https://github.com/lissy93/dashy) | ⭐ 26.5k | Vue | 🚀 可自行部署的个人自定义仪表盘，支持状态检查、小组件、主题、图标包、可视化编辑器，还有超多功能！ |
| [google/flatbuffers](https://github.com/google/flatbuffers) | ⭐ 26.5k | C++ | FlatBuffers：内存高效的序列化库 |
| [mihomo-party-org/clash-party](https://github.com/mihomo-party-org/clash-party) | ⭐ 26.5k | TypeScript | :electron: 又一款 Mihomo 图形界面 |
...
| [humanlayer/12-factor-agents](https://github.com/humanlayer/12-factor-agents) | ⭐ 26.3k | TypeScript | 我们可遵循哪些原则，才能构建出足以投入生产环境交付给客户使用的高质量 LLM 赋能软件？ |
...
| [henrygd/beszel](https://github.com/henrygd/beszel) | ⭐ 25.5k | Go | 轻量服务器监控，支持历史数据、Docker 统计和告警。 |
...
| [OpenListTeam/OpenList](https://github.com/OpenListTeam/OpenList) | ⭐ 24.7k | Go | 专为应对Trust Crisis的全新AList分支 |
...
| [modelcontextprotocol/python-sdk](https://github.com/modelcontextprotocol/python-sdk) | ⭐ 24.3k | Python | 适用于Model Context Protocol服务端与客户端的官方Python SDK |
| [RooCodeInc/Roo-Code🟡](https://github.com/RooCodeInc/Roo-Code) | ⭐ 24.3k | TypeScript | Roo Code 为你的代码编辑器带来一整支由 AI 智能体组成的开发团队。 |
| [uutils/coreutils](https://github.com/uutils/coreutils) | ⭐ 24.1k | Rust | GNU coreutils 的跨平台 Rust 重写实现 |
| [SuperClaude-Org/SuperClaude_Framework](https://github.com/SuperClaude-Org/SuperClaude_Framework) | ⭐ 23.9k | Python | 一个为 Claude Code 增强了专用命令、认知 persona 和开发方法的配置框架 |
| [Vonng/ddia](https://github.com/Vonng/ddia) | ⭐ 23.7k | Python | 《Designing Data-Intensive Application》DDIA 第一版 / 第二版 中文翻译 |
| [facebookresearch/audiocraft](https://github.com/facebookresearch/audiocraft) | ⭐ 23.6k | Jupyter Notebook | Audiocraft 是一个用于深度学习音频处理与生成的库，它包含最先进的 EnCodec 音频压缩器/分词器，以及支持文本与旋律条件输入、简单可控的音乐生成语… |
...
| [AlDanial/cloc](https://github.com/AlDanial/cloc) | ⭐ 23.5k | Perl | cloc 可统计多种编程语言的空白行、注释行与源代码物理行数。 |
...
| [AZeC4/TelegramGroup](https://github.com/AZeC4/TelegramGroup) | ⭐ 23.2k |  | 2026最新悄咪咪收集的10000+个Telegram群合集，附全网最有趣好用的机器人BOT🤖【dianbaodaohang.com】 |
...
| [scottbez1/smartknob](https://github.com/scottbez1/smartknob) | ⭐ 22.1k | C++ | 带软件定义限位和虚拟卡位的触觉输入旋钮 |
...
| [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent) | ⭐ 21.9k | Shell | Xray、Tuic、hysteria2、sing-box 八合一一键脚本 |
...
| [twpayne/chezmoi](https://github.com/twpayne/chezmoi) | ⭐ 21.7k | Go | 跨不同设备安全管理你的dotfiles。 |
...
| [triton-lang/triton](https://github.com/triton-lang/triton) | ⭐ 20.2k | MLIR | Triton 语言和编译器的开发仓库 |
| [inancgumus/learngo](https://github.com/inancgumus/learngo) | ⭐ 20.1k | Go | ❤️ 1000+ 个手工整理的 Go 示例、习题与测验。🚀 通过修复上千个微型程序来学习 Go。 |
| [BluePointLilac/ContextMenuManager](https://github.com/BluePointLilac/ContextMenuManager) | ⭐ 20.1k | C# | 🖱️ 纯粹的Windows右键菜单管理程序 |
...
| [putyy/res-downloader](https://github.com/putyy/res-downloader) | ⭐ 19.9k | Go | 视频号、小程序、抖音、快手、小红书、直播流、m3u8、酷狗、QQ音乐等常见网络资源下载! |
...
| [danielmiessler/LifeOS](https://github.com/danielmiessler/LifeOS) | ⭐ 19.1k | TypeScript | ⛰️ 人生操作系统——一个意图工程平台，帮你在生活与工作中从现状抵达理想状态。 |
...
| [ccusage/ccusage](https://github.com/ccusage/ccusage) | ⭐ 18.6k | Rust | 运行 npx ccusage |
| [bggRGjQaUbCoE/PiliPlus](https://github.com/bggRGjQaUbCoE/PiliPlus) | ⭐ 18.5k | Dart | PiliPlus |
| [nukeop/nuclear](https://github.com/nukeop/nuclear) | ⭐ 18.5k | TypeScript | 可帮你查找免费音乐的流媒体音乐播放器 |
...
| [bleedline/aimoneyhunter](https://github.com/bleedline/aimoneyhunter) | ⭐ 18.1k |  | ai副业赚钱大集合，教你如何利用ai做一些副业项目，赚取更多额外收益。The Ultimate Guide to Making Money with AI Si… |
...
| [muratcankoylan/Agent-Skills-for-Context-Engineering](https://github.com/muratcankoylan/Agent-Skills-for-Context-Engineering) | ⭐ 18.0k | Python | 面向上下文工程、多智能体架构与生产级智能体系统的全面智能体技能集合。适用于构建、优化或调试需要高效上下文管理的智能体系统。 |
| [AsyncFuncAI/deepwiki-open](https://github.com/AsyncFuncAI/deepwiki-open) | ⭐ 18.0k | Python | 开源 DeepWiki：适用于 GitHub/Gitlab/Bitbucket 仓库的 AI 驱动 Wiki 生成工具。加入我们的 discord：https:… |
| [amir1376/ab-download-manager](https://github.com/amir1376/ab-download-manager) | ⭐ 18.0k | Kotlin | 一款可提升下载速度的下载管理器 |
| [ZJU-LLMs/Foundations-of-LLMs](https://github.com/ZJU-LLMs/Foundations-of-LLMs) | ⭐ 18.0k |  | 一本学习LLM基础的书 |
| [jlcodes99/cockpit-tools](https://github.com/jlcodes99/cockpit-tools) | ⭐ 17.9k | Rust | 🚀 通用 AI IDE 账号管理工具：支持 Antigravity / Codex / GitHub Copilot / Windsurf / Kiro / C… |
...
| [iamgio/quarkdown](https://github.com/iamgio/quarkdown) | ⭐ 16.1k | Kotlin | 🪐 拥有超能力的 Markdown：从想法出发，搞定论文、演示文稿、网站、书籍和知识库。 |
| [quickwit-oss/tantivy](https://github.com/quickwit-oss/tantivy) | ⭐ 16.1k | Rust | Tantivy 是一款受 Apache Lucene 启发、用 Rust 编写的全文搜索引擎库 |
...
| [vibrantlabsai/ragas](https://github.com/vibrantlabsai/ragas) | ⭐ 15.8k | Python | 为你的大语言模型应用评估赋能加速🚀 |
...
| [v2rayA/v2rayA](https://github.com/v2rayA/v2rayA) | ⭐ 15.6k | Go | Project V 的网页图形界面客户端，支持 VMess、VLESS、SS、SSR、Trojan、Tuic 与 Juicity 协议。 |
| [coderamp-labs/gitingest](https://github.com/coderamp-labs/gitingest) | ⭐ 15.5k | Python | 在任意 GitHub URL 中将 `hub` 替换为 `ingest`，即可获取适配大模型提示词的代码库提取内容 |
...
| [GeeeekExplorer/nano-vllm](https://github.com/GeeeekExplorer/nano-vllm) | ⭐ 15.5k | Python | Nano vLLM |
...
| [coder/coder](https://github.com/coder/coder) | ⭐ 15.3k | Go | 为开发者及其智能代理提供安全环境 |
...
| [KaringX/karing](https://github.com/KaringX/karing) | ⭐ 14.9k | Dart | 简单强大的代理工具，支持 clash/sing-box 路由规则 |
...
| [srwi/EverythingToolbar](https://github.com/srwi/EverythingToolbar) | ⭐ 14.8k | C | 为 Windows 任务栏提供全方面整合。 |
...
| [mindfold-ai/Trellis](https://github.com/mindfold-ai/Trellis) | ⭐ 14.7k | TypeScript | 最出色的智能代理开发工具框架 |
| [tisfeng/Easydict](https://github.com/tisfeng/Easydict) | ⭐ 14.7k | Swift | 一个简洁优雅的词典翻译 macOS App。开箱即用，支持离线 OCR 识别，支持有道词典，🍎 苹果系统词典，🍎 苹果系统翻译，OpenAI，Gemini，De… |
| [microsoft/edit](https://github.com/microsoft/edit) | ⭐ 14.6k | Rust | 我们皆可编辑。 |
...
| [lsdefine/GenericAgent](https://github.com/lsdefine/GenericAgent) | ⭐ 14.2k | Python | 自进化智能体：从3300行代码种子生长出技能树，实现全系统控制，令牌消耗降低6倍 |
...
| [coleam00/context-engineering-intro](https://github.com/coleam00/context-engineering-intro) | ⭐ 13.8k | Python | 上下文工程是新一代氛围编程——它是真正让AI编码助手发挥作用的方法。Claude Code最适配这套方案，因此本仓库围绕它搭建，但这套策略也可以用在任何AI编码… |
...
| [microsoft/TRELLIS](https://github.com/microsoft/TRELLIS) | ⭐ 13.7k | Python | CVPR 2025  Spotlight论文《Structured 3D Latents for Scalable and Versatile 3D Gener… |
...
| [XiaomiMiMo/MiMo-Code](https://github.com/XiaomiMiMo/MiMo-Code) | ⭐ 13.2k | TypeScript | MiMo Code：模型与智能体共同进化之地 |
...
| [sirmalloc/ccstatusline](https://github.com/sirmalloc/ccstatusline) | ⭐ 12.9k | TypeScript | 🚀 为 Claude Code CLI 打造的美观高度可自定义状态栏，支持 powerline、内置主题等诸多功能。 |
...
| [OdysseusYuan/LKY_OfficeTools](https://github.com/OdysseusYuan/LKY_OfficeTools) | ⭐ 12.7k | C# | 一键自动化 下载、安装、激活 Office 的利器。 |
...
| [breezy-weather/breezy-weather](https://github.com/breezy-weather/breezy-weather) | ⭐ 11.4k | Kotlin | 功能丰富的天气应用，拥有出色可视化效果，支持超过50个数据源。 |
...
| [datawhalechina/all-in-rag](https://github.com/datawhalechina/all-in-rag) | ⭐ 11.2k | Python | 🔍大模型应用开发实战一：RAG 技术全栈指南，在线阅读地址：https://datawhalechina.github.io/all-in-rag/ |
...
| [OpenBMB/MiniCPM](https://github.com/OpenBMB/MiniCPM) | ⭐ 11.1k | Jupyter Notebook | MiniCPM5: SOTA on-device LLMs, small yet powerful. |
...
| [openchamber/openchamber](https://github.com/openchamber/openchamber) | ⭐ 10.1k | TypeScript | Agentic Development Environment based on OpenCode AI agent |
...
| [mengxi-ream/read-frog](https://github.com/mengxi-ream/read-frog) | ⭐ 9.7k | TypeScript | 🐸 Read Frog - Language Learning & Translate | 🐸 陪读蛙 - 语言学习与翻译 |
...
| [Maciek-roboblog/Claude-Code-Usage-Monitor](https://github.com/Maciek-roboblog/Claude-Code-Usage-Monitor) | ⭐ 8.7k | Python | 带预测和警告功能的实时 Claude Code 使用监控器 |
...
| [anthropics/claude-agent-sdk-python](https://github.com/anthropics/claude-agent-sdk-python) | ⭐ 8.1k | Python |  |
...
| [ai-dynamo/dynamo](https://github.com/ai-dynamo/dynamo) | ⭐ 8.1k | Rust | 数据中心级分布式推理服务框架 |
...
| [rikkahub/rikkahub](https://github.com/rikkahub/rikkahub) | ⭐ 7.7k | Kotlin | RikkaHub 是一款支持多个大语言模型服务商的 Android 应用 |
...
| [MoonshotAI/kimi-code](https://github.com/MoonshotAI/kimi-code) | ⭐ 7.5k | TypeScript | Kimi Code CLI  —  下一代智能体的起点 |
...
| [lintsinghua/DeepAudit](https://github.com/lintsinghua/DeepAudit) | ⭐ 7.0k | Python | DeepAudit：人人拥有的 AI 黑客战队，让漏洞挖掘触手可及。国内首个开源的代码漏洞挖掘多智能体系统。小白一键部署运行，自主协作审计 + 自动化沙箱 Po… |
...
| [gpu-mode/lectures](https://github.com/gpu-mode/lectures) | ⭐ 6.6k | Jupyter Notebook | GPU模式讲座的资料 |
...
| [zhukunpenglinyutong/jetbrains-cc-gui](https://github.com/zhukunpenglinyutong/jetbrains-cc-gui) | ⭐ 6.4k | Java | Jetbrains Claude Code 与 Codex GUI 插件 |
...
| [deepseek-ai/awesome-deepseek-agent](https://github.com/deepseek-ai/awesome-deepseek-agent) | ⭐ 6.1k |  |  |
...
| [Mai-with-u/MaiBot](https://github.com/Mai-with-u/MaiBot) | ⭐ 6.0k | Python | 基于LLM的智能体MaiSaka是一个致力于理解你、以真人风格与你互动的数字生命。她不追求完美，也不追求效率，看重的是温暖、真诚与真挚的联结。 |
...
| [DetachHead/rebased🔀](https://github.com/DetachHead/rebased) | ⭐ 5.6k | Java | 基于 IntelliJ 平台的 Git 客户端 |
...
| [junhoyeo/tokscale](https://github.com/junhoyeo/tokscale) | ⭐ 5.5k | Rust | 🛰️ 在终端追踪所有AI编码代理的令牌使用量。🏅 全球排行榜已累计追踪数万亿美元令牌。 |
...
| [royeo/awesome-programming-books](https://github.com/royeo/awesome-programming-books) | ⭐ 4.9k |  | 📚 经典技术书籍推荐，持续更新... |
...
| [nlp-with-transformers/notebooks](https://github.com/nlp-with-transformers/notebooks) | ⭐ 4.8k | Jupyter Notebook | 《基于Transformers的自然语言处理》一书配套Jupyter笔记本 |
...
| [AndrewStetsenko/tech-jobs-with-relocation](https://github.com/AndrewStetsenko/tech-jobs-with-relocation) | ⭐ 4.5k |  | 海外技术求职一站式指南 |
...
| [zhukunpenglinyutong/desktop-cc-gui](https://github.com/zhukunpenglinyutong/desktop-cc-gui) | ⭐ 4.2k | TypeScript | 基于Tauri构建的多引擎AI编码桌面客户端，在一个GUI中集成Claude Code、Codex、Gemini、OpenCode、DeepSeek Harne… |
...
| [yuaotian/antigravity-proxy](https://github.com/yuaotian/antigravity-proxy) | ⭐ 4.2k | C++ | 🚀 Transparent proxy injector for Antigravity. Force SOCKS5/HTTP proxy without TU… |
...
| [cybergeekgyan/Quant-Developers-Resources](https://github.com/cybergeekgyan/Quant-Developers-Resources) | ⭐ 3.9k | Python | 适合准备应聘量化交易公司、高频交易公司、对冲基金的量化开发工程师、量化研究员、量化交易员、量化分析师、软件工程师的备考资源 |
...
| [ljinkai/weekly](https://github.com/ljinkai/weekly) | ⭐ 3.7k |  | 独立开发产品变现周刊，每周五发布。 |
...
| [psmux/psmux](https://github.com/psmux/psmux) | ⭐ 3.5k | PowerShell | Windows PowerShell 上的 Tmux — 适用于 PowerShell、Windows Terminal、cmd.exe 的 tmux。包含 p… |
...
| [Visualize-ML/Linear-Algebra-Made-Easy---Learn-with-Python-and-Visualization](https://github.com/Visualize-ML/Linear-Algebra-Made-Easy---Learn-with-Python-and-Visualization) | ⭐ 3.4k | Jupyter Notebook | ”数学不难“  之  《线性代数不难》上下册，66话题完册；欢迎批评指正 |
...
| [pionxzh/chatgpt-exporter](https://github.com/pionxzh/chatgpt-exporter) | ⭐ 2.7k | TypeScript | 导出并分享你的 ChatGPT 对话记录 |
...
| [Haleclipse/CodexDesktop-Rebuild](https://github.com/Haleclipse/CodexDesktop-Rebuild) | ⭐ 2.7k | JavaScript | Codex 桌面应用——跨平台重构项目 |
...
| [vnmakarov/mir](https://github.com/vnmakarov/mir) | ⭐ 2.7k | C | 基于MIR（Medium Internal Representation，中型中间表示）的轻量级JIT编译器，以及基于MIR的C11 JIT编译器与解释器 |
...
| [LearnPrompt/LearnPrompt](https://github.com/LearnPrompt/LearnPrompt) | ⭐ 2.6k | MDX | 永久免费开源的 AIGC 课程, 目前已支持Claude Code，Codex，Hermes，OpenClaw，Obsidian，Prompt Engineer… |
| [lydrainbowcat/tedukuri](https://github.com/lydrainbowcat/tedukuri) | ⭐ 2.6k | Roff | 《算法竞赛进阶指南》资源社区 |
| [mhx/dwarfs](https://github.com/mhx/dwarfs) | ⭐ 2.6k | C++ | 适用于 Linux、FreeBSD、macOS 和 Windows 的快速高压缩比只读文件系统 |
...
| [geekgeekrun/geekgeekrun](https://github.com/geekgeekrun/geekgeekrun) | ⭐ 2.4k | Vue | 牛人快跑 - GeekGeekRun，求职找工作自动化工具，基于 Puppeteer、Electron。界面友好，简单易用！开源，免费！快速海投、自动开聊、已读… |
...
| [LigphiDonk/academic-figure-generator](https://github.com/LigphiDonk/academic-figure-generator) | ⭐ 2.4k | Python | AI 驱动的学术论文配图生成平台。上传论文 → AI 分析内容生成 Prompt → 一键生成高质量科研配图，还有配套的skill可在主流agent中使用 |
...
| [PasteBar/PasteBarApp](https://github.com/PasteBar/PasteBarApp) | ⭐ 2.2k | TypeScript | PasteBar - 适用于 Mac 和 Windows 的无限制免费剪贴板管理器 |
...
| [Kuddev/pebrel](https://github.com/Kuddev/pebrel) | ⭐ 1.9k | Rust | AI-native, GPU-accelerated terminal emulator for Windows with SSH, persistent se… |
...
| [rust-boom/rust-boom](https://github.com/rust-boom/rust-boom) | ⭐ 1.7k | Rust | Awesome Rust (Rust 资源 | 学习 | 书 ). 💥 |
...
| [AgibotTech/agibot_x1_train](https://github.com/AgibotTech/agibot_x1_train) | ⭐ 1.7k | Python | AgiBot X1 的强化学习训练代码。 |
| [shayne/go-wsl2-host](https://github.com/shayne/go-wsl2-host) | ⭐ 1.7k | Go | 使用 WSL2 VM IP 地址自动更新你的 Windows hosts 文件 |
| [trustmaster/goflow](https://github.com/trustmaster/goflow) | ⭐ 1.7k | Go | 面向 Go（golang）的基于流的数据流编程库 |
| [LLM-Red-Team/kimi-cc](https://github.com/LLM-Red-Team/kimi-cc) | ⭐ 1.7k | Shell | 使用 Kimi 最新模型（kimi-k2-0711-preview）驱动你的 Claude Code。 |
| [wozulong/fuclaude](https://github.com/wozulong/fuclaude) | ⭐ 1.6k |  | 法克劳德，啥也不是。 |
...
| [DamionGans/ubuntu-wsl2-systemd-script🟡](https://github.com/DamionGans/ubuntu-wsl2-systemd-script) | ⭐ 1.6k | Shell | [已停止维护！] 用于为当前 Ubuntu WSL2 镜像启用 systemd 支持的脚本 |
...
| [eatmoreduck/boss-zhipin-scraper](https://github.com/eatmoreduck/boss-zhipin-scraper) | ⭐ 1.4k | Python | Boss直聘爬虫 / BOSS直聘职位数据抓取工具，基于 Chrome CDP 协议复用真实登录态，绕过字体反爬，输出明文薪资 JSON/CSV + 薪资技能分… |
...
| [GanyuanRan/Aegis](https://github.com/GanyuanRan/Aegis) | ⭐ 1.2k | Python | 让AI编程代理具备架构感知能力：先做基线、验证证据、检查漂移，在长任务中全程保障安全。 |
...
| [Rath-Team/OpenRath](https://github.com/Rath-Team/OpenRath) | ⭐ 1.1k | Python | 面向动态多智能体与多会话工作流的类PyTorch开源运行时 |
...
| [InkSha/rust-tutorial](https://github.com/InkSha/rust-tutorial) | ⭐ 999 | Rust | 一个针对新手的 Rust 快速教程，从零开始写一个管理 Todos 的命令行程序 |
...
| [yuaotian/go-augment-cleaner](https://github.com/yuaotian/go-augment-cleaner) | ⭐ 958 |  | 清理Augment缓存和生成设备SessionId/解决 VSCode、Cursor、JetBrains 系列 IDE 中 Augment 插件无法登录的问题（… |
...
| [Auto-Plugin/milkup](https://github.com/Auto-Plugin/milkup) | ⭐ 949 | TypeScript | A cross-platform, instant-rendering desktop Markdown editor 一个跨平台的、即时渲染桌面端 Markd… |
| [chronolaw/cpp_study](https://github.com/chronolaw/cpp_study) | ⭐ 948 | C++ | 跟我一起学现代C++ |
| [markhorn-dev/astro-nano](https://github.com/markhorn-dev/astro-nano) | ⭐ 938 | Astro | Astro Nano is a static, minimalist, lightweight, lightning fast portfolio and bl… |
...
| [sunbigfly/ppt-agent-skills](https://github.com/sunbigfly/ppt-agent-skills) | ⭐ 899 | Python | A code-driven presentation generation framework. 像构建软件工程一样生成演示文稿。 |
| [golangboy/wxocr](https://github.com/golangboy/wxocr) | ⭐ 895 |  | 无内容 |
| [rmyorston/busybox-w32](https://github.com/rmyorston/busybox-w32) | ⭐ 888 | C | BusyBox 的 WIN32 原生移植版。 |
| [yann0917/dedao-dl](https://github.com/yann0917/dedao-dl) | ⭐ 887 | Go | 得到 APP 课程下载工具，可在终端查看文章内容，可生成 PDF，音频文件，markdown 文稿，可下载电子书。可结合 openclaw +skill 等使用 |
...
| [ahpxex/Aictionary](https://github.com/ahpxex/Aictionary) | ⭐ 824 | TypeScript | 另一款桌面词典，但速度快得多，释义更丰富，助你真正通晓语言。 |
| [jingtian11/EasyOffer](https://github.com/jingtian11/EasyOffer) | ⭐ 823 | Jupyter Notebook | 《EasyOffer》（<大模型面经合集>）是针对LLM宝宝们量身打造的大模型暑期实习Offer指南，主要记录大模型暑期实习和秋招准备的一些常见大厂手撕代码、大… |
...
| [WakeUp-Jin/Practical-Guide-to-Context-Engineering](https://github.com/WakeUp-Jin/Practical-Guide-to-Context-Engineering) | ⭐ 808 |  | 大模型应用开发的方向，上下文工程是设计原则，Agent Harness 是构建目标，本项目的目标，是为开发者和研究者提供一份大模型应用开发的骨架思路 |
| [Iamshankhadeep/ccseva](https://github.com/Iamshankhadeep/ccseva) | ⭐ 808 | TypeScript | 一款美观的 macOS 菜单栏应用，可实时追踪你的 Claude Code 使用量。 |
...
| [OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL](https://github.com/OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL) | ⭐ 802 |  | 去AI味提示词-作家增强-SKILL |
...
| [zkep/my-geektime](https://github.com/zkep/my-geektime) | ⭐ 792 | Go | 👏 Make learning a lifelong habit. 学无止境 |
| [findmover/wxread](https://github.com/findmover/wxread) | ⭐ 790 | Python | 微信读书刷时长助你成为霸榜“大佬” |
| [bilibili/vim-vide](https://github.com/bilibili/vim-vide) | ⭐ 786 | Vim Script | Lightest vimrc, while strong enough. 最轻的vim配置，却足够强！ |
| [huangguang1999/ccstatusline-zh](https://github.com/huangguang1999/ccstatusline-zh) | ⭐ 781 | TypeScript | ccstatusline 的中文汉化版 - Claude Code CLI 可定制状态栏格式化工具 |
| [Delppine1024/TGreen](https://github.com/Delppine1024/TGreen) | ⭐ 779 |  | 部分文件在 T v1.1 上可正常运行（最新支持版本为 v1.9.5/1.9.2-dev），基于 TC 开发 |
| [DJB-Developer/wechat-android-history-versions](https://github.com/DJB-Developer/wechat-android-history-versions) | ⭐ 769 | JavaScript | 微信Android 微信安卓版 微信安卓 历史版本 官方下载地址 |
...
| [ZeroTang05/VideoAdGuard](https://github.com/ZeroTang05/VideoAdGuard) | ⭐ 752 | TypeScript | 哔哩哔哩浏览器插件：基于大语言模型，对B站视频中的植入广告进行检测。一键跳过视频中的植入/口播广告。 |
...
| [rachitiitr/modern-cpp-tricks](https://github.com/rachitiitr/modern-cpp-tricks) | ⭐ 718 |  | 常用于编码面试和竞赛编程的现代C++实用技巧 |
...
| [hellowind777/hello2cc](https://github.com/hellowind777/hello2cc) | ⭐ 692 | JavaScript | 面向第三方模型的原生优先 Claude Code 插件，支持静默代理模型注入与输出样式定制。 |
...
| [JackyST0/awesome-agent-skills](https://github.com/JackyST0/awesome-agent-skills) | ⭐ 639 | Shell | 🤖 精选的 AI Agent Skills 列表，适用于 Cursor、Claude Code、GitHub Copilot 等 AI 编程工具 |
...
| [MAXeaglet/commandcode-proxy](https://github.com/MAXeaglet/commandcode-proxy) | ⭐ 634 | JavaScript | Command Code API 反代代理，兼容 OpenAI 与 Anthropic 接口 | Reverse proxy exposing Command… |
| [LambdaLabsML/distributed-training-guide](https://github.com/LambdaLabsML/distributed-training-guide) | ⭐ 631 | Python | 编写分布式 PyTorch 训练代码的最佳实践与指南 |
...
| [bbruceyuan/AI-Interview-Code](https://github.com/bbruceyuan/AI-Interview-Code) | ⭐ 614 | Jupyter Notebook | LLM大模型（重点）以及搜广推等 AI 算法中手写的面试题，（非 LeetCode），比如 Self-Attention, AUC等，一般比 LeetCode… |
...
| [Mercurygram/Mercurygram🔀](https://github.com/Mercurygram/Mercurygram) | ⭐ 596 | Java | Android 版官方 Telegram 客户端的非官方、对自由开源软件友好的分支 |
...
| [WoJiSama/skill-based-architecture](https://github.com/WoJiSama/skill-based-architecture) | ⭐ 594 | Shell | 这是一项可以生成技能的元技能：指向任意代码库后，它就能把项目的规则、工作流与经验教训提取出来，整理存入专用的`skills/<项目名>/`目录中——这个项目技能… |
| [MoonshotAI/K2-Vendor-Verifier](https://github.com/MoonshotAI/K2-Vendor-Verifier) | ⭐ 592 | Python | 验证所有提供 Kimi K2 API 厂商的精度 |
| [CyanoHao/Resource-Han-Rounded](https://github.com/CyanoHao/Resource-Han-Rounded) | ⭐ 587 | JavaScript | Resource Han Rounded，一款源自Source Han Sans的圆角字体家族。 |
...
| [wzsx150/MobaXterm_CN](https://github.com/wzsx150/MobaXterm_CN) | ⭐ 580 |  | MobaXterm 综合远程工具 汉化版 |
| [ccpopy/antissh](https://github.com/ccpopy/antissh) | ⭐ 578 | Shell | 反重力Agent代理一键脚本，支持WSL、SSH远程 |
...
| [baidu-baige/LoongForge](https://github.com/baidu-baige/LoongForge) | ⭐ 572 | Python | 一个用于在NVIDIA GPU和昆仑芯XPU上训练大语言模型、视觉语言模型、扩散模型以及具身智能模型的高性能框架 |
| [carlvellotti/claude-code-everyone-course](https://github.com/carlvellotti/claude-code-everyone-course) | ⭐ 568 | MDX | 人人可用的 Claude Code —— 在 Claude Code 中学习 Claude Code |
| [Lularible/storage-book](https://github.com/Lularible/storage-book) | ⭐ 567 | C | 一本关于存储技术与文件系统的开源书籍。从绳结记事到Flash物理特性，从FAT到LittleFS —— 还附带教学级日志结构嵌入式文件系统KnotFS（约840… |
...
| [Haleclipse/codex🔀](https://github.com/Haleclipse/codex) | ⭐ 558 | Rust | 可在终端运行的轻量级编程代理 |
...
| [catlog22/maestro-flow](https://github.com/catlog22/maestro-flow) | ⭐ 553 | TypeScript | 面向多智能体AI开发的意图驱动工作流编排——适配Claude Code、Gemini、Codex等工具的自适应生命周期引擎、自强化知识图谱与可视化仪表盘 |
| [xujiangjiang/Easy-Cat-Timer](https://github.com/xujiangjiang/Easy-Cat-Timer) | ⭐ 552 | C# | This is a very simple cat timer, made using WPF（这是一个非常简单的猫咪计时器，使用WPF制作） |
...
| [mxyhi/ok-skills](https://github.com/mxyhi/ok-skills) | ⭐ 490 | HTML | 为 Codex、Claude Code、Cursor、OpenClaw 及其他兼容 SKILL.md 的工具整理精选 AI 编码代理技能与 AGENTS.md… |
| [chengazhen/gitlens-pro](https://github.com/chengazhen/gitlens-pro) | ⭐ 490 | Go | 一个用于激活 GitLens Pro 的工具。 |
...
| [ChengShiest/LAST-ViT](https://github.com/ChengShiest/LAST-ViT) | ⭐ 464 | Python | [CVPR 2026] 论文《Vision Transformer Needs More Than Registers》的官方PyTorch实现 |
| [hmarr/vitals](https://github.com/hmarr/vitals) | ⭐ 464 | Swift | 📊 轻量macOS进程监视器 |
...
| [RethinkFun/DeepLearning](https://github.com/RethinkFun/DeepLearning) | ⭐ 456 | Python |  |
...
| [lzskyline/VocabMeld](https://github.com/lzskyline/VocabMeld) | ⭐ 447 | JavaScript | 智能替换网页词汇，创造沉浸式双语学习环境，在日常浏览中自然习得语言。 |
| [cocojojo5213/phonics-app](https://github.com/cocojojo5213/phonics-app) | ⭐ 442 | JavaScript | 真正从基础开始学英语 - 自然拼读练习应用 |
...
| [CooperJiang/coding-tool](https://github.com/CooperJiang/coding-tool) | ⭐ 415 | JavaScript | claudecode|codex|gemini  cli增强工具。 |
| [uaxe/geektime-pdfs](https://github.com/uaxe/geektime-pdfs) | ⭐ 409 |  | 👏极客时间 pdf |
| [itandelin/qoder-free](https://github.com/itandelin/qoder-free) | ⭐ 409 | Python | 一个用于重置 Qoder 应用程序用户身份信息的现代化图形界面工具。 |
...
| [rashidazarang/chatgpt-chat-exporter](https://github.com/rashidazarang/chatgpt-chat-exporter) | ⭐ 385 | JavaScript | 一款轻量级浏览器端工具，可将你的ChatGPT对话导出为美观的Markdown或PDF格式。 |
...
| [liangdabiao/Claude-Code-Stock-Deep-Research-Agent](https://github.com/liangdabiao/Claude-Code-Stock-Deep-Research-Agent) | ⭐ 372 |  | 本研究基于 Claude Code Deep Research 系统：  方法论: 8阶段股票投资尽调框架 智能体: 28个并行研究智能体 工具: WebSea… |
...
| [funny-vibes/agent-vibes](https://github.com/funny-vibes/agent-vibes) | ⭐ 361 | TypeScript | 统一代理网关 — 让 Claude Code CLI 和 Cursor IDE 通过协议转换使用免费 AI 后端（Antigravity、Codex） |
| [rational-stars/GitHub-Freshness](https://github.com/rational-stars/GitHub-Freshness) | ⭐ 359 | JavaScript | GitHub Freshness 在线文档 |
| [yjh051108/dsh-router-standard🟡](https://github.com/yjh051108/dsh-router-standard) | ⭐ 357 | JavaScript | 已并入 dsh-routing-suite（单仓库化）；本仓库为历史镜像/归档 —— 注意力工程主线 v1.19.1/v34 研发线未发布。新代码见 githu… |
...
| [NiuTrans/ABigSurveyOfLLMs](https://github.com/NiuTrans/ABigSurveyOfLLMs) | ⭐ 353 |  | 150+份大语言模型相关调研的合集 |
| [upupming/algorithm](https://github.com/upupming/algorithm) | ⭐ 345 | C++ | acwing, leetcode, kickstart, 算法模板, PAT 等等 |
...
| [realYurk/translation-Introduction-to-HPC](https://github.com/realYurk/translation-Introduction-to-HPC) | ⭐ 336 | C | 为 Eijhout 教授的Introduction to HPC提供中文翻译、 PPT和Lab。 |
...
| [andrewkchan/deepseek.cpp](https://github.com/andrewkchan/deepseek.cpp) | ⭐ 324 | C++ | 基于 C++ 的 DeepSeek 系列大语言模型 CPU 推理 |
| [zoicware/RepairBadTweaks](https://github.com/zoicware/RepairBadTweaks) | ⭐ 311 | PowerShell | 修复常用Windows优化调整项 |
| [Baseult/NetLimiterCrack](https://github.com/Baseult/NetLimiterCrack) | ⭐ 306 | C# | 一个用于免费获取 NetLimiter Premium 的简单补丁程序 |
| [TopChina/proxy-list](https://github.com/TopChina/proxy-list) | ⭐ 306 |  | 免费代理列表，含HTTP、Socks4与Socks5开放代理 |
| [WangQrkkk/PaperQuay](https://github.com/WangQrkkk/PaperQuay) | ⭐ 303 | TypeScript | 优先适配桌面端的文献管理工具，支持PDF阅读、翻译、论文概览与AI智能体工作流。 |
...
| [dstdev/awesome-hpc](https://github.com/dstdev/awesome-hpc) | ⭐ 271 |  | 精选HPC优秀软件与工具合集 |
| [numba/nvidia-cuda-tutorial](https://github.com/numba/nvidia-cuda-tutorial) | ⭐ 269 | Jupyter Notebook | 英伟达贡献了面向Numba的CUDA教程 |
| [dxxzst/mml-book-chinese](https://github.com/dxxzst/mml-book-chinese) | ⭐ 261 | Python | mml-book-chinese《Mathematics For Machine Learning》机器学习中的数学 中文版 |
...
| [llnl/HPC-Tutorials](https://github.com/llnl/HPC-Tutorials) | ⭐ 257 | C | hpc-tutorials.llnl.gov 的未来建站地址 |
...
| [thep0y/monaco-nerd-font](https://github.com/thep0y/monaco-nerd-font) | ⭐ 244 | Shell | 已添加粗体、斜体和粗斜体的 Monaco Nerd Font |
...
| [335234131/agent-browser-mcp](https://github.com/335234131/agent-browser-mcp) | ⭐ 243 | Python | 让 Agent 直接操作真实 Chrome 的 MCP 服务，支持页面扫描、CDP、截图与物理输入 |
...
| [sergiye/winUpdateMiniTool](https://github.com/sergiye/winUpdateMiniTool) | ⭐ 207 | C# | Windows Update Mini Tool 是一款用于在 Windows 操作系统上管理 Microsoft 产品更新的工具 |
...
| [microwind/algorithms](https://github.com/microwind/algorithms) | ⭐ 177 | Java | 🚀AI时代，人人都是算法思想工程师。本项目含各种数据结构与经典算法，充分举例说明，用C/Java/Python/JS/Go/Rust等不同语言实现，一边学算法一… |
...
| [gally16/LLM-Jailbreaking-Guide](https://github.com/gally16/LLM-Jailbreaking-Guide) | ⭐ 157 |  | LLM Jailbreaking Guide主流大语言模型越狱指南 |
...
| [10D24D/NiceFont](https://github.com/10D24D/NiceFont) | ⭐ 150 | JavaScript | NiceFont —— 一款优化网页字体显示的工具，让浏览更清晰、舒适！“真正调整字体，而非页面缩放，拒绝将就”！可直接修改网页的字体大小与风格，保存你的字体设… |
...
| [ahpxex/open-dictionary](https://github.com/ahpxex/open-dictionary) | ⭐ 137 | Python | 基于维基词典构建、借助大语言模型丰富释义的真正开放词典 |
...
| [bean-du/SpeakSense](https://github.com/bean-du/SpeakSense) | ⭐ 117 | Rust | SpeakSense 是一款高性能 ASR（自动语音识别）服务端实现，同时支持 gRPC 和 REST API。 |
...
| [cpulxb/WSL-Image-Clipboard-Helper](https://github.com/cpulxb/WSL-Image-Clipboard-Helper) | ⭐ 96 | Rust | 该工具用于在 Windows 中配合 WSL 环境下的 Claude Code、CodeX、OpenCode等 AI 工具，快速保存剪贴板图片并将其转换为 WS… |
| [whtiehack/XiaoMi-Air](https://github.com/whtiehack/XiaoMi-Air) | ⭐ 96 | ASL | 适用于 macOS High Sierra、Sierra 和 Big Sur 的小米笔记本 Air 驱动配置 |
| [breaker505/resumify](https://github.com/breaker505/resumify) | ⭐ 95 |  | Resumify — 别再说“我只是做了测试”。让AI帮你讲出漂亮的经历故事。✨ |
...
| [lvbibir/JetBrainsLxgwNerdMono](https://github.com/lvbibir/JetBrainsLxgwNerdMono) | ⭐ 82 | Python | JetBrains Mono NerdFont 加霞鹜文楷，就是自带NerdFont图标的完美2:1比例CJK等宽字体 |
...
| [CometixAI/Cometix-Indexer](https://github.com/CometixAI/Cometix-Indexer) | ⭐ 67 | TypeScript | 基于 Cursor Codebase Indexer 构建的 MCP |
...
| [Ayi1337/gpt6-astra-one-shot-games](https://github.com/Ayi1337/gpt6-astra-one-shot-games) | ⭐ 52 | HTML | GPT-6 Astra 的 One Shot 游戏测试，包含原始 Prompt 与可直接运行的单文件 HTML。 |
...
| [52cik/vscode-keyboard-shortcuts](https://github.com/52cik/vscode-keyboard-shortcuts) | ⭐ 48 | HTML | vscode 快捷键参考 中文翻译 |
...
| [ZhaoXingPeng/DBJavaGenix](https://github.com/ZhaoXingPeng/DBJavaGenix) | ⭐ 35 | Python | 智能数据库代码生成工具基于MCP架构，支持MySQL等多种数据库，自动生成Entity、DAO、Service及Controller等完整分层代码，大幅提升开发… |
...
| [PerceptivePenguin/GPT-exporter](https://github.com/PerceptivePenguin/GPT-exporter) | ⭐ 29 | TypeScript | 一款可将 ChatGPT 对话导出为 Markdown 并生成 AI 摘要的浏览器扩展，支持 Chrome、Edge 和 Firefox。 |
...
| [lulab/teaching_book_beta🟡](https://github.com/lulab/teaching_book_beta) | ⭐ 11 |  |  |
...
| [holtwood/cmdc-statusline](https://github.com/holtwood/cmdc-statusline) | ⭐ 7 | TypeScript | 📊 Command Code 状态栏 — 模型 · 渐变上下文进度条 · 缓存命中率 · 会话花费 · 输出速度 · 子代理用量 · 会话名 · git 状态 |
| [microbiome-immunity-project/metagenome_assembly](https://github.com/microbiome-immunity-project/metagenome_assembly) | ⭐ 7 | Roff | 用于宏基因组组装的WDL工作流 |
| [hpc-workbench/cpp-high-performance-guide](https://github.com/hpc-workbench/cpp-high-performance-guide) | ⭐ 6 | C++ | 可运行的 C++20 性能工程指南：示例、基准测试与 VitePress 文档站 |
| [TideTree/awesome-zh](https://github.com/TideTree/awesome-zh) | ⭐ 6 |  | 📚 awesome 技术资源精选，优质项目与文章导航中文版 |
| [alexpacheco/hpc-training](https://github.com/alexpacheco/hpc-training) | ⭐ 6 | HTML | 用于存储本人HPC培训的演示文稿、TeX和PDF文件的仓库。 |
| [Hao-Zou-lab/Deep-scSTAR](https://github.com/Hao-Zou-lab/Deep-scSTAR) | ⭐ 6 | Jupyter Notebook |  |
| [unclemcz/wodict](https://github.com/unclemcz/wodict) | ⭐ 6 | JavaScript | wodict是一个基于electron开发的网络环境下泛用型翻译（词典）工具，支持通过配置的方式接入百度翻译开放平台、网易有道翻译等。支持的语言由翻译引擎决定，… |
...
| [open-genomics/fastq-tools](https://github.com/open-genomics/fastq-tools) | ⭐ 4 | C++ | 高性能 FASTQ 质控工具（统计/过滤）；零拷贝 I/O、TBB 流水线、C++23 |
| [open-genomics/fq-compressor](https://github.com/open-genomics/fq-compressor) | ⭐ 4 | C++ | FASTQ 专用压缩归档：列式分离 + 2-bit 碱基打包 + Zstd，三层 XXH64 校验，内存有界。C++23 并发流水线。 |
| [open-infra-ai/trifuse](https://github.com/open-infra-ai/trifuse) | ⭐ 4 | Python | 面向 Transformer 推理的可验证 Triton 融合算子与 torch.library 集成 |
| [yyxyz/OSOperateSkills](https://github.com/yyxyz/OSOperateSkills) | ⭐ 4 |  |  |
| [hpc-workbench/bitcal](https://github.com/hpc-workbench/bitcal) | ⭐ 3 | C++ | 纯头文件 C++23 位运算练习库，x86-64 + AVX2，实验性 |
| [open-genomics/awesome-bioinfo-algorithms](https://github.com/open-genomics/awesome-bioinfo-algorithms) | ⭐ 3 | Python | 精选生物信息学算法知识库，含复杂度分析、CLI 维护工具与双语文档。 |
| [TideTree/awesome-python-zh](https://github.com/TideTree/awesome-python-zh) | ⭐ 3 | Python | 🧠 Awesome-Python 精选Python教程资源中文版 |
| [holtwood/LessUp](https://github.com/holtwood/LessUp) | ⭐ 3 |  | Personal Project Hub: AI Infrastructure & High-Performance Computing Engineering… |
| [cr-zhichen/vscode-diagnostics-dumper🔀](https://github.com/cr-zhichen/vscode-diagnostics-dumper) | ⭐ 3 | TypeScript |  |
...
| [build-workbench/bookmarks-cleaner](https://github.com/build-workbench/bookmarks-cleaner) | ⭐ 1 | Python | 离线书签自动分类引擎:规则优先 · ML 辅助 · LLM 可选 | Offline bookmark auto-classification engine:… |
| [build-workbench/yolo-toys](https://github.com/build-workbench/yolo-toys) | ⭐ 1 | Python | 多模型视觉推理服务 - YOLOv8 / DETR / OWL-ViT / Grounding DINO / BLIP 统一 FastAPI 接口 | Unif… |
