...
> 全部 **1346** 个 Star 项目,按 ⭐ 排序

| 项目 | 星数 | 语言 | 描述 |
|------|------|------|------|
| [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | ⭐ 545.1k | Markdown | 通过从零重写你喜爱的技术来精通编程。 |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 502.7k |  | 汇集各类趣味主题的超棒精选列表【注：在我处理完现有PR前，暂时关闭拉取请求提交】 |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 475.0k | Python | 免费API集合列表 |
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | ⭐ 455.0k | TypeScript | freeCodeCamp.org 的开源代码库与课程。免费学习数学、编程与计算机科学。 |
| [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | ⭐ 395.9k | Python | :books: 免费开源编程书籍 |
...
| [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | ⭐ 366.3k | TypeScript | 助力开发者职业成长的交互式路线图、指南及其他教育内容。 |
| [jwasham/coding-interview-university](https://github.com/jwasham/coding-interview-university) | ⭐ 360.3k |  | 一份成为软件工程师的完整计算机科学学习计划 |
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 318.1k | Python | 专门解答「我想用Python做X该用什么工具？」的权威工具清单 |
| [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | ⭐ 282.0k | Python | 精选基于项目的教程列表 |
| [obra/superpowers](https://github.com/obra/superpowers) | ⭐ 281.4k | Shell | 一套行之有效的智能体技能框架与软件开发方法论。 |
| [react/react](https://github.com/react/react) | ⭐ 249.1k | JavaScript | 用于构建网页和原生用户界面的库。 |
| [mattpocock/skills](https://github.com/mattpocock/skills) | ⭐ 247.7k | Shell | 真正工程师必备技能，直接来自我的.agents目录。 |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 247.3k | JavaScript | 这是智能代理性能优化系统，为 Claude Code、Codex、Opencode、Cursor 及更多 AI 编码工具提供技能、本能、记忆、安全能力与研究优先… |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | ⭐ 240.9k | Python | The agent that grows with you |
...
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 211.2k | TypeScript | DeepSeek Harness：万物皆插件。 |
| [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | ⭐ 209.9k |  | 基于Andrej Karpathy对大语言模型编码陷阱的观察，通过单个CLAUDE.md文件优化Claude Code的行为。 |
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | ⭐ 203.6k | TypeScript | 开源编码智能体 |
| [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | ⭐ 197.5k | Markdown | 为所有人提供免费域名注册与实用DNS学习资源 |
| [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) | ⭐ 189.3k | Batchfile | 开源Windows和Office激活工具，支持HWID、Ohook、TSforge和在线KMS激活方式，同时具备高级故障排查功能 |
...
| [ollama/ollama](https://github.com/ollama/ollama) | ⭐ 180.1k | Go | 快速上手 Kimi-K2.6、GLM-5.2、MiniMax、DeepSeek、gpt-oss、Qwen、Gemma 等各类大模型。 |
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | ⭐ 178.0k | Python | 用于将文件和办公文档转换为 Markdown 的 Python 工具 |
| [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | ⭐ 174.6k | Python | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source proj… |
| [anthropics/skills](https://github.com/anthropics/skills) | ⭐ 173.7k | Python | Agent 技能公开仓库 |
| [jlevy/the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) | ⭐ 162.2k |  | 掌握命令行，只需一页 |
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 150.9k | Python | 易用的 AI 界面（支持 Ollama、OpenAI API 等） |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 145.6k | Python | 智能体工程开发平台 |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | ⭐ 144.0k | Python | Claude Code 是一款可在终端内运行的智能编码工具，它能理解你的代码库，通过自然语言命令帮你完成例行任务、讲解复杂代码、处理 git 工作流，让你的编码… |
...
| [github/spec-kit](https://github.com/github/spec-kit) | ⭐ 133.4k | Python | 用于帮助你上手规范驱动开发的工具套件 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | ⭐ 131.0k | Rust | 适用于 Claude Code、Codex、OpenCode、OpenClaw、Grok Build 与 Hermes Agent 的跨平台桌面一站式助手。唯一… |
| [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | ⭐ 124.7k | Python | 一款可为多平台构建专业UI/UX提供设计智能支持的AI技能。 |
| [openai/codex](https://github.com/openai/codex) | ⭐ 121.3k | Rust | 可在终端运行的轻量级编码智能体 |
| [microsoft/generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners) | ⭐ 119.1k | Jupyter Notebook | 21节课，从零开始构建生成式AI项目 |
...
| [openai/whisper](https://github.com/openai/whisper) | ⭐ 108.4k | Python | 基于大规模弱监督的稳健语音识别 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | ⭐ 106.8k | TypeScript | 一款可将 Gemini 的能力直接引入终端的开源 AI 智能体 |
| [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | ⭐ 103.2k | Go | 🪨 能少用token干嘛用那么多——这是Claude Code技能，模仿原始人说话帮你砍掉65%的token用量 |
...
| [earendil-works/pi](https://github.com/earendil-works/pi) | ⭐ 101.5k | TypeScript | AI 智能体工具包：统一大语言模型API、智能体循环、终端用户界面、编程智能体命令行工具 |
...
| [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 94.0k |  | MCP 服务器集合 |
...
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | ⭐ 78.5k | Rust | CLI 代理，可将常用开发命令的 LLM 令牌消耗降低 60-90%，单Rust二进制文件，零依赖 |
...
| [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code) | ⭐ 77.5k | Python | 上传截图，即可将其转换为整洁的代码（HTML/Tailwind/React/Vue） |
| [datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents) | ⭐ 76.8k | Python | 📚 《从零开始构建智能体》——从零开始的智能体原理与实践教程 |
...
| [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | ⭐ 74.4k | Python | 精选的优质Claude技能、资源与工具列表，用于定制Claude AI工作流 |
...
| [Asabeneh/30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python) | ⭐ 72.8k | Python | 「Python编程30天挑战是一份分步骤的Python语言学习指南，总学习时长可能超过100天，你可以按照自己的节奏学习。这些视频也可能对你有帮助：https:… |
...
| [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | ⭐ 67.2k | TypeScript | 适用于 AI 编码助手的规范驱动开发（SDD）。 |
...
| [tw93/Mole](https://github.com/tw93/Mole) | ⭐ 66.0k | Shell | 🐹 清理、卸载、分析、优化与监控你的 Mac。免费开源命令行工具，另有原生 Mac 应用。 |
...
| [upstash/context7](https://github.com/upstash/context7) | ⭐ 61.6k | TypeScript | Context7 平台——为大语言模型和 AI 代码编辑器提供最新的代码文档 |
...
| [ghostty-org/ghostty](https://github.com/ghostty-org/ghostty) | ⭐ 60.7k | Zig | 👻 Ghostty 是一款快速、功能丰富的跨平台终端模拟器，采用平台原生 UI 与 GPU 加速。 |
| [sharkdp/bat](https://github.com/sharkdp/bat) | ⭐ 60.4k | Rust | 带翅膀的 cat(1) 克隆版 |
| [jingyaogong/minimind](https://github.com/jingyaogong/minimind) | ⭐ 58.3k | Python | 🧠 仅需2小时从零训练一个64M参数的LLM！ |
...
| [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) | ⭐ 53.5k | Python | 这里精选了适用于 Claude Code 的优质资源，Claude Code 是 Anthropic PBC 开发的公认最强编码助手。这个集合展示了顶尖技能、双… |
...
| [bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) | ⭐ 52.7k | JavaScript | 敏捷AI驱动开发的突破性方法 |
| [charlax/professional-programming](https://github.com/charlax/professional-programming) | ⭐ 51.5k | Python | 供求知的软件工程师使用的学习资源合集 |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | ⭐ 50.9k | TypeScript | 面向编程代理的 Chrome DevTools |
...
| [tt-a1i/archify](https://github.com/tt-a1i/archify) | ⭐ 46.2k | JavaScript | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flo… |
...
| [ShareX/ShareX](https://github.com/ShareX/ShareX) | ⭐ 39.4k | C# | ShareX is a free and open-source application that enables users to capture or re… |
...
| [searxng/searxng](https://github.com/searxng/searxng) | ⭐ 36.5k | Python | SearXNG 是一款免费的互联网元搜索引擎，可聚合来自多种搜索服务与数据库的搜索结果。它不会追踪用户，也不会为用户建立画像。 |
...
| [sgl-project/sglang](https://github.com/sgl-project/sglang) | ⭐ 34.1k | Python | SGLang 是面向大语言模型和多模态模型的高性能服务框架。 |
...
| [lbjlaq/Antigravity-Manager](https://github.com/lbjlaq/Antigravity-Manager) | ⭐ 31.0k | Rust | Professional Antigravity Account Manager & Switcher. One-click seamless account… |
...
| [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | ⭐ 30.6k | Python | 构建并运行你看得见、摸得透、信得过的智能体。 |
...
| [BigPizzaV3/CodexPlusPlus](https://github.com/BigPizzaV3/CodexPlusPlus) | ⭐ 30.2k | Rust | An enhanced tool for CodexApp, striving to make Codex better to use and more com… |
...
| [fmtlib/fmt](https://github.com/fmtlib/fmt) | ⭐ 25.2k | C++ | 现代格式化库 |
...
| [amir1376/ab-download-manager](https://github.com/amir1376/ab-download-manager) | ⭐ 17.7k | Kotlin | 一款可提升下载速度的下载管理器 |
...
| [jlcodes99/cockpit-tools](https://github.com/jlcodes99/cockpit-tools) | ⭐ 17.0k | Rust | 🚀 通用 AI IDE 账号管理工具：支持 Antigravity / Codex / GitHub Copilot / Windsurf / Kiro / C… |
...
| [alibaba/zvec](https://github.com/alibaba/zvec) | ⭐ 15.7k | C++ | A lightweight, lightning-fast, in-process vector database |
...
| [tisfeng/Easydict](https://github.com/tisfeng/Easydict) | ⭐ 14.5k | Swift | 一个简洁优雅的词典翻译 macOS App。开箱即用，支持离线 OCR 识别，支持有道词典，🍎 苹果系统词典，🍎 苹果系统翻译，OpenAI，Gemini，De… |
...
| [wong2/chatgpt-google-extension](https://github.com/wong2/chatgpt-google-extension) | ⭐ 13.1k | TypeScript | 本项目已停止维护，请查看我的新项目 ChatHub： |
...
| [yjh051108/dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite) | ⭐ 7.1k | JavaScript | dsh-routing-suite — 注入器+路由标准工具包：先安装运行时注入器，再安装任务感知推理模式路由预设（已测试P1-P23）。 |
...
| [findmover/wxread](https://github.com/findmover/wxread) | ⭐ 780 | Python | 微信读书刷时长助你成为霸榜“大佬” |
...
| [Delppine1024/TGreen](https://github.com/Delppine1024/TGreen) | ⭐ 764 |  | 部分文件在 T v1.1 上可正常运行（最新支持版本为 v1.9.5/1.9.2-dev），基于 TC 开发 |
...
| [OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL](https://github.com/OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL) | ⭐ 746 | JavaScript | 去AI味提示词-作家增强-SKILL |
...
| [Kuddev/nebula](https://github.com/Kuddev/nebula) | ⭐ 650 | Rust | AI-native, GPU-accelerated terminal emulator for Windows with SSH, persistent se… |
...
| [LambdaLabsML/distributed-training-guide](https://github.com/LambdaLabsML/distributed-training-guide) | ⭐ 630 | Python | 编写分布式 PyTorch 训练代码的最佳实践与指南 |
...
| [neolee/pilot](https://github.com/neolee/pilot) | ⭐ 610 | Jupyter Notebook | 进入编程世界的第一课 |
| [bbruceyuan/AI-Interview-Code](https://github.com/bbruceyuan/AI-Interview-Code) | ⭐ 609 | Jupyter Notebook | LLM大模型（重点）以及搜广推等 AI 算法中手写的面试题，（非 LeetCode），比如 Self-Attention, AUC等，一般比 LeetCode… |
...
| [r-smith/vmPing](https://github.com/r-smith/vmPing) | ⭐ 593 | C# | 可视化多Ping，用于监控多台主机的色标编码Ping工具 |
...
| [ZMGID/kivio](https://github.com/ZMGID/kivio) | ⭐ 573 | Rust |  |
...
| [wzsx150/MobaXterm_CN](https://github.com/wzsx150/MobaXterm_CN) | ⭐ 549 |  | MobaXterm 综合远程工具 汉化版 |
| [WoJiSama/skill-based-architecture](https://github.com/WoJiSama/skill-based-architecture) | ⭐ 549 | Shell | 这是一项可以生成技能的元技能：指向任意代码库后，它就能把项目的规则、工作流与经验教训提取出来，整理存入专用的`skills/<项目名>/`目录中——这个项目技能… |
...
| [catlog22/maestro-flow](https://github.com/catlog22/maestro-flow) | ⭐ 545 | TypeScript | 面向多智能体AI开发的意图驱动工作流编排——适配Claude Code、Gemini、Codex等工具的自适应生命周期引擎、自强化知识图谱与可视化仪表盘 |
...
| [chengazhen/gitlens-pro](https://github.com/chengazhen/gitlens-pro) | ⭐ 480 | Go | 一个用于激活 GitLens Pro 的工具。 |
...
| [MikeWang000000/vscode-server-centos7](https://github.com/MikeWang000000/vscode-server-centos7) | ⭐ 450 | C | 在 RHEL/CentOS 7 上运行最新版 vscode-server！ |
...
| [rashidazarang/chatgpt-chat-exporter](https://github.com/rashidazarang/chatgpt-chat-exporter) | ⭐ 371 | JavaScript | 一款轻量级浏览器端工具，可将你的ChatGPT对话导出为美观的Markdown或PDF格式。 |
...
| [yjh051108/dsh-router-standard🟡](https://github.com/yjh051108/dsh-router-standard) | ⭐ 363 | JavaScript | 已并入 dsh-routing-suite（单仓库化）；本仓库为历史镜像/归档 —— 注意力工程主线 v1.19.1/v34 研发线未发布。新代码见 githu… |
...
| [WangQrkkk/PaperQuay](https://github.com/WangQrkkk/PaperQuay) | ⭐ 291 | TypeScript | 优先适配桌面端的文献管理工具，支持PDF阅读、翻译、论文概览与AI智能体工作流。 |
| [MAXeaglet/commandcode-proxy](https://github.com/MAXeaglet/commandcode-proxy) | ⭐ 289 | JavaScript | Command Code API → OpenAI 兼容接口的反代代理 |
...
| [lx-s/WinMute](https://github.com/lx-s/WinMute) | ⭐ 244 | C++ | WinMute 可让你在特定事件（例如屏保启动、工作站锁定、关机等）发生时自动静音你的 PC 音量。 |
...
| [thep0y/monaco-nerd-font](https://github.com/thep0y/monaco-nerd-font) | ⭐ 241 | Shell | 已添加粗体、斜体和粗斜体的 Monaco Nerd Font |
...
| [sergiye/winUpdateMiniTool](https://github.com/sergiye/winUpdateMiniTool) | ⭐ 204 | C# | Windows Update Mini Tool 是一款用于在 Windows 操作系统上管理 Microsoft 产品更新的工具 |
