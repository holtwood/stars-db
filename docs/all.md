...
> 全部 **1351** 个 Star 项目,按 ⭐ 排序

| 项目 | 星数 | 语言 | 描述 |
|------|------|------|------|
| [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | ⭐ 545.9k | Markdown | 通过从零重写你喜爱的技术来精通编程。 |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 504.0k |  | 汇集各类趣味主题的超棒精选列表【注：在我处理完现有PR前，暂时关闭拉取请求提交】 |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 477.1k | Python | 免费API集合列表 |
...
| [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | ⭐ 396.2k | Python | :books: 免费开源编程书籍 |
| [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | ⭐ 368.6k | Python | 学习如何设计大规模系统，备战系统设计面试，包含Anki闪卡。 |
| [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | ⭐ 366.5k | TypeScript | 助力开发者职业成长的交互式路线图、指南及其他教育内容。 |
| [jwasham/coding-interview-university](https://github.com/jwasham/coding-interview-university) | ⭐ 360.5k |  | 一份成为软件工程师的完整计算机科学学习计划 |
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 319.2k | Python | 专门解答「我想用Python做X该用什么工具？」的权威工具清单 |
| [obra/superpowers](https://github.com/obra/superpowers) | ⭐ 282.9k | Shell | 一套行之有效的智能体技能框架与软件开发方法论。 |
| [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | ⭐ 282.5k | Python | 精选基于项目的教程列表 |
| [mattpocock/skills](https://github.com/mattpocock/skills) | ⭐ 256.2k | Shell | 真正工程师必备技能，直接来自我的.agents目录。 |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 253.0k | JavaScript | 这是智能代理性能优化系统，为 Claude Code、Codex、Opencode、Cursor 及更多 AI 编码工具提供技能、本能、记忆、安全能力与研究优先… |
| [react/react](https://github.com/react/react) | ⭐ 249.6k | JavaScript | 用于构建网页和原生用户界面的库。 |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | ⭐ 243.1k | Python | The agent that grows with you |
| [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) | ⭐ 224.4k | Python | 用Python实现的所有算法 |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 215.3k | TypeScript | DeepSeek Harness：万物皆插件。 |
| [vuejs/vue](https://github.com/vuejs/vue) | ⭐ 212.1k | TypeScript | 这是 Vue 2 的仓库。Vue 3 请访问 https://github.com/vuejs/core |
| [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | ⭐ 211.0k |  | 基于Andrej Karpathy对大语言模型编码陷阱的观察，通过单个CLAUDE.md文件优化Claude Code的行为。 |
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | ⭐ 205.7k | TypeScript | 开源编码智能体 |
| [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | ⭐ 198.1k | Markdown | 为所有人提供免费域名注册与实用DNS学习资源 |
| [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) | ⭐ 189.7k | Batchfile | 开源Windows和Office激活工具，支持HWID、Ohook、TSforge和在线KMS激活方式，同时具备高级故障排查功能 |
...
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | ⭐ 180.5k | Python | 用于将文件和办公文档转换为 Markdown 的 Python 工具 |
| [ollama/ollama](https://github.com/ollama/ollama) | ⭐ 180.4k | Go | 快速上手 Kimi-K2.6、GLM-5.2、MiniMax、DeepSeek、gpt-oss、Qwen、Gemma 等各类大模型。 |
| [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | ⭐ 175.3k | Python | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source proj… |
| [anthropics/skills](https://github.com/anthropics/skills) | ⭐ 175.1k | Python | Agent 技能公开仓库 |
| [jlevy/the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) | ⭐ 162.3k |  | 掌握命令行，只需一页 |
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 151.3k | Python | 易用的 AI 界面（支持 Ollama、OpenAI API 等） |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 145.9k | Python | 智能体工程开发平台 |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | ⭐ 144.4k | Python | Claude Code 是一款可在终端内运行的智能编码工具，它能理解你的代码库，通过自然语言命令帮你完成例行任务、讲解复杂代码、处理 git 工作流，让你的编码… |
...
| [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) | ⭐ 142.9k | TypeScript | 基于 Tauri 构建的现代化图形界面客户端，支持在 Windows、macOS 和 Linux 运行，提供定制化代理体验 |
...
| [github/spec-kit](https://github.com/github/spec-kit) | ⭐ 133.9k | Python | 用于帮助你上手规范驱动开发的工具套件 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | ⭐ 131.6k | Rust | 适用于 Claude Code、Codex、OpenCode、OpenClaw、Grok Build 与 Hermes Agent 的跨平台桌面一站式助手。唯一… |
| [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | ⭐ 125.9k | Python | 一款可为多平台构建专业UI/UX提供设计智能支持的AI技能。 |
| [openai/codex](https://github.com/openai/codex) | ⭐ 122.3k | Rust | 可在终端运行的轻量级编码智能体 |
...
| [openai/whisper](https://github.com/openai/whisper) | ⭐ 108.7k | Python | 基于大规模弱监督的稳健语音识别 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | ⭐ 106.9k | TypeScript | 一款可将 Gemini 的能力直接引入终端的开源 AI 智能体 |
| [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | ⭐ 104.2k | Go | 🪨 能少用token干嘛用那么多——这是Claude Code技能，模仿原始人说话帮你砍掉65%的token用量 |
| [earendil-works/pi](https://github.com/earendil-works/pi) | ⭐ 102.8k | TypeScript | AI 智能体工具包：统一大语言模型API、智能体循环、终端用户界面、编程智能体命令行工具 |
...
| [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 94.6k |  | MCP 服务器集合 |
...
| [localsend/localsend](https://github.com/localsend/localsend) | ⭐ 90.3k | Dart | AirDrop 的开源跨平台替代工具 |
...
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | ⭐ 81.9k | Python | 这是一个可完成调研、编码与创作的开源长周期SuperAgent框架。借助沙箱、记忆、工具、技能、子代理与消息网关，它能处理耗时数分钟到数小时的不同层级任务。 |
...
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | ⭐ 79.3k | Rust | CLI 代理，可将常用开发命令的 LLM 令牌消耗降低 60-90%，单Rust二进制文件，零依赖 |
...
| [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code) | ⭐ 78.2k | Python | 上传截图，即可将其转换为整洁的代码（HTML/Tailwind/React/Vue） |
...
| [datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents) | ⭐ 77.6k | Python | 📚 《从零开始构建智能体》——从零开始的智能体原理与实践教程 |
...
| [Asabeneh/30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python) | ⭐ 73.1k | Python | 「Python编程30天挑战是一份分步骤的Python语言学习指南，总学习时长可能超过100天，你可以按照自己的节奏学习。这些视频也可能对你有帮助：https:… |
| [toeverything/AFFiNE](https://github.com/toeverything/AFFiNE) | ⭐ 72.3k | TypeScript | 不止有 Notion 和 Miro。AFFiNE（发音[ə‘fain]）是将规划、整理与创作整合为一体的下一代知识库。隐私优先、开源可定制，开箱即用。 |
...
| [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | ⭐ 67.6k | TypeScript | 适用于 AI 编码助手的规范驱动开发（SDD）。 |
...
| [tw93/Mole](https://github.com/tw93/Mole) | ⭐ 66.5k | Shell | 🐹 清理、卸载、分析、优化与监控你的 Mac。免费开源命令行工具，另有原生 Mac 应用。 |
...
| [jingyaogong/minimind](https://github.com/jingyaogong/minimind) | ⭐ 59.6k | Python | 🧠 仅需2小时从零训练一个64M参数的LLM！ |
...
| [tt-a1i/archify](https://github.com/tt-a1i/archify) | ⭐ 53.2k | JavaScript | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flo… |
...
| [chen08209/FlClash](https://github.com/chen08209/FlClash) | ⭐ 51.3k | Dart | 基于 ClashMeta 的多平台代理客户端，简洁易用，开源无广告。 |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | ⭐ 51.3k | TypeScript | 面向编程代理的 Chrome DevTools |
...
| [MetaCubeX/ClashMetaForAndroid🔀](https://github.com/MetaCubeX/ClashMetaForAndroid) | ⭐ 45.8k | Kotlin | 适用于 Android 的基于规则的隧道工具 |
...
| [sgl-project/sglang](https://github.com/sgl-project/sglang) | ⭐ 35.6k | Python | SGLang 是面向大语言模型和多模态模型的高性能服务框架。 |
...
| [eriklindernoren/ML-From-Scratch](https://github.com/eriklindernoren/ML-From-Scratch) | ⭐ 32.7k | Python | 从零开始学机器学习。用NumPy实现极简的机器学习模型与算法，主打通俗易懂，覆盖范围从线性回归到深度学习一应俱全。 |
...
| [maboloshi/github-chinese](https://github.com/maboloshi/github-chinese) | ⭐ 32.4k | JavaScript | GitHub 汉化插件，GitHub 中文化界面。 (GitHub Translation To Chinese) |
...
| [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | ⭐ 31.0k | Python | 构建并运行你看得见、摸得透、信得过的智能体。 |
...
| [BigPizzaV3/CodexPlusPlus](https://github.com/BigPizzaV3/CodexPlusPlus) | ⭐ 30.4k | Rust | An enhanced tool for CodexApp, striving to make Codex better to use and more com… |
...
| [Caldis/Mos](https://github.com/Caldis/Mos) | ⭐ 21.3k | Swift | 一个用于在 macOS 上平滑你的鼠标滚动效果或单独设置滚动方向的小工具, 让你的滚轮爽如触控板  |  A lightweight tool used to… |
...
| [alibaba/zvec](https://github.com/alibaba/zvec) | ⭐ 15.8k | C++ | A lightweight, lightning-fast, in-process vector database |
...
| [binaricat/Netcatty](https://github.com/binaricat/Netcatty) | ⭐ 5.7k | TypeScript | 集SSH工作区、SFTP和终端于一体 |
...
| [huifer/WellAlly-health](https://github.com/huifer/WellAlly-health) | ⭐ 941 | Shell | Ally-Health 是一款智能医疗助手，它依托先进AI技术与医学专业知识革新个人健康管理。它通过自然语言交互帮助用户记录症状、管理用药、整理病历并获取多学科… |
...
| [OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL](https://github.com/OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL) | ⭐ 758 |  | 去AI味提示词-作家增强-SKILL |
...
| [Kuddev/pebrel](https://github.com/Kuddev/pebrel) | ⭐ 681 | Rust | AI-native, GPU-accelerated terminal emulator for Windows with SSH, persistent se… |
...
| [JackyST0/awesome-agent-skills](https://github.com/JackyST0/awesome-agent-skills) | ⭐ 632 | Shell | 🤖 精选的 AI Agent Skills 列表，适用于 Cursor、Claude Code、GitHub Copilot 等 AI 编程工具 |
...
| [Mercurygram/Mercurygram🔀](https://github.com/Mercurygram/Mercurygram) | ⭐ 584 | Java | Android 版官方 Telegram 客户端的非官方、对自由开源软件友好的分支 |
...
| [ZMGID/kivio](https://github.com/ZMGID/kivio) | ⭐ 578 | Rust |  |
...
| [wzsx150/MobaXterm_CN](https://github.com/wzsx150/MobaXterm_CN) | ⭐ 559 |  | MobaXterm 综合远程工具 汉化版 |
| [WoJiSama/skill-based-architecture](https://github.com/WoJiSama/skill-based-architecture) | ⭐ 558 | Shell | 这是一项可以生成技能的元技能：指向任意代码库后，它就能把项目的规则、工作流与经验教训提取出来，整理存入专用的`skills/<项目名>/`目录中——这个项目技能… |
...
| [catlog22/maestro-flow](https://github.com/catlog22/maestro-flow) | ⭐ 546 | TypeScript | 面向多智能体AI开发的意图驱动工作流编排——适配Claude Code、Gemini、Codex等工具的自适应生命周期引擎、自强化知识图谱与可视化仪表盘 |
...
| [chengazhen/gitlens-pro](https://github.com/chengazhen/gitlens-pro) | ⭐ 483 | Go | 一个用于激活 GitLens Pro 的工具。 |
...
| [rashidazarang/chatgpt-chat-exporter](https://github.com/rashidazarang/chatgpt-chat-exporter) | ⭐ 376 | JavaScript | 一款轻量级浏览器端工具，可将你的ChatGPT对话导出为美观的Markdown或PDF格式。 |
...
| [MAXeaglet/commandcode-proxy](https://github.com/MAXeaglet/commandcode-proxy) | ⭐ 319 | JavaScript | Command Code API 反代代理，兼容 OpenAI 与 Anthropic 接口 | Reverse proxy exposing Command… |
...
| [CometixAI/Cometix-Indexer](https://github.com/CometixAI/Cometix-Indexer) | ⭐ 68 | TypeScript | 基于 Cursor Codebase Indexer 构建的 MCP |
...
| [Ayi1337/gpt6-astra-one-shot-games](https://github.com/Ayi1337/gpt6-astra-one-shot-games) | ⭐ 24 | HTML | GPT-6 Astra 的 One Shot 游戏测试，包含原始 Prompt 与可直接运行的单文件 HTML。 |
