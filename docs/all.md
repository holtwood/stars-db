...
| 项目 | 星数 | 语言 | 描述 |
|------|------|------|------|
| [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | ⭐ 547.9k | Markdown | 通过从零重写你喜爱的技术来精通编程。 |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 507.2k |  | 汇集各类趣味主题的超棒精选列表【注：在我处理完现有PR前，暂时关闭拉取请求提交】 |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 481.3k | Python | 免费API集合列表 |
...
| [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | ⭐ 397.1k | Python | :books: 免费开源编程书籍 |
| [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | ⭐ 370.6k | Python | 学习如何设计大规模系统，备战系统设计面试，包含Anki闪卡。 |
| [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | ⭐ 367.6k | TypeScript | 助力开发者职业成长的交互式路线图、指南及其他教育内容。 |
| [jwasham/coding-interview-university](https://github.com/jwasham/coding-interview-university) | ⭐ 361.1k |  | 一份成为软件工程师的完整计算机科学学习计划 |
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 321.4k | Python | 专门解答「我想用Python做X该用什么工具？」的权威工具清单 |
| [obra/superpowers](https://github.com/obra/superpowers) | ⭐ 288.2k | Shell | 一套行之有效的智能体技能框架与软件开发方法论。 |
| [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | ⭐ 283.7k | Python | 精选基于项目的教程列表 |
| [mattpocock/skills](https://github.com/mattpocock/skills) | ⭐ 264.6k | Shell | 真正工程师必备技能，直接来自我的.agents目录。 |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 261.3k | JavaScript | 这是智能代理性能优化系统，为 Claude Code、Codex、Opencode、Cursor 及更多 AI 编码工具提供技能、本能、记忆、安全能力与研究优先… |
| [react/react](https://github.com/react/react) | ⭐ 250.6k | JavaScript | 用于构建网页和原生用户界面的库。 |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | ⭐ 246.6k | Python | The agent that grows with you |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 228.2k | TypeScript | DeepSeek Harness：万物皆插件。 |
| [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) | ⭐ 224.7k | Python | 用Python实现的所有算法 |
| [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | ⭐ 213.8k |  | 基于Andrej Karpathy对大语言模型编码陷阱的观察，通过单个CLAUDE.md文件优化Claude Code的行为。 |
| [vuejs/vue](https://github.com/vuejs/vue) | ⭐ 212.8k | TypeScript | 这是 Vue 2 的仓库。Vue 3 请访问 https://github.com/vuejs/core |
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | ⭐ 208.2k | TypeScript | 开源编码智能体 |
| [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | ⭐ 199.9k | Markdown | 为所有人提供免费域名注册与实用DNS学习资源 |
...
| [CyC2018/CS-Notes](https://github.com/CyC2018/CS-Notes) | ⭐ 186.1k |  | :books: 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计 |
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | ⭐ 185.2k | Python | 用于将文件和办公文档转换为 Markdown 的 Python 工具 |
| [ollama/ollama](https://github.com/ollama/ollama) | ⭐ 181.2k | Go | 快速上手 Kimi-K2.6、GLM-5.2、MiniMax、DeepSeek、gpt-oss、Qwen、Gemma 等各类大模型。 |
| [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | ⭐ 177.2k | Python | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source proj… |
| [anthropics/skills](https://github.com/anthropics/skills) | ⭐ 176.9k | Python | Agent 技能公开仓库 |
| [jlevy/the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) | ⭐ 162.4k |  | 掌握命令行，只需一页 |
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 152.4k | Python | 易用的 AI 界面（支持 Ollama、OpenAI API 等） |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.6k | Python | 智能体工程开发平台 |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | ⭐ 145.9k | TypeScript | Claude Code 是一款可在终端内运行的智能编码工具，它能理解你的代码库，通过自然语言命令帮你完成例行任务、讲解复杂代码、处理 git 工作流，让你的编码… |
| [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) | ⭐ 145.1k | Rust | 基于 Tauri 构建的现代化图形界面客户端，支持在 Windows、macOS 和 Linux 运行，提供定制化代理体验 |
...
| [github/spec-kit](https://github.com/github/spec-kit) | ⭐ 137.7k | Python | 用于帮助你上手规范驱动开发的工具套件 |
| [labuladong/fucking-algorithm](https://github.com/labuladong/fucking-algorithm) | ⭐ 135.9k | Markdown | 破解LeetCode，不仅要知其然，更要知其所以然。 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | ⭐ 133.4k | Rust | 适用于 Claude Code、Codex、OpenCode、OpenClaw、Grok Build 与 Hermes Agent 的跨平台桌面一站式助手。唯一… |
| [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | ⭐ 128.6k | Python | 一款可为多平台构建专业UI/UX提供设计智能支持的AI技能。 |
| [openai/codex](https://github.com/openai/codex) | ⭐ 125.0k | Rust | 可在终端运行的轻量级编码智能体 |
...
| [2dust/v2rayN](https://github.com/2dust/v2rayN) | ⭐ 116.4k | C# | 支持Xray、sing-box等的多平台GUI客户端，兼容Windows、Linux与macOS |
| [openai/whisper](https://github.com/openai/whisper) | ⭐ 109.3k | Python | 基于大规模弱监督的稳健语音识别 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | ⭐ 107.0k | TypeScript | 一款可将 Gemini 的能力直接引入终端的开源 AI 智能体 |
| [earendil-works/pi](https://github.com/earendil-works/pi) | ⭐ 106.7k | TypeScript | AI 智能体工具包：统一大语言模型API、智能体循环、终端用户界面、编程智能体命令行工具 |
| [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | ⭐ 106.3k | Go | 🪨 能少用token干嘛用那么多——这是Claude Code技能，模仿原始人说话帮你砍掉65%的token用量 |
| [ruanyf/weekly](https://github.com/ruanyf/weekly) | ⭐ 102.8k |  | 科技爱好者周刊，每周五发布 |
...
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | ⭐ 82.6k | Python | 这是一个可完成调研、编码与创作的开源长周期SuperAgent框架。借助沙箱、记忆、工具、技能、子代理与消息网关，它能处理耗时数分钟到数小时的不同层级任务。 |
...
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | ⭐ 80.9k | Rust | CLI 代理，可将常用开发命令的 LLM 令牌消耗降低 60-90%，单Rust二进制文件，零依赖 |
...
| [datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents) | ⭐ 79.7k | Python | 📚 《从零开始构建智能体》——从零开始的智能体原理与实践教程 |
| [coder/code-server](https://github.com/coder/code-server) | ⭐ 79.3k | TypeScript | 浏览器中的 VS Code |
| [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code) | ⭐ 79.2k | Python | 上传截图，即可将其转换为整洁的代码（HTML/Tailwind/React/Vue） |
...
| [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) | ⭐ 78.4k | MDX | 用于提示工程、上下文工程、RAG 与 AI 智能体的指南、论文、教程、笔记与资源汇总 |
...
| [ocornut/imgui](https://github.com/ocornut/imgui) | ⭐ 76.2k | C++ | Dear ImGui：适用于C++的低依赖、无冗余图形用户界面 |
| [openai/openai-cookbook](https://github.com/openai/openai-cookbook) | ⭐ 76.0k | Jupyter Notebook | OpenAI API 使用示例与指南 |
...
| [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | ⭐ 75.2k | Python | 精选的优质Claude技能、资源与工具列表，用于定制Claude AI工作流 |
| [Asabeneh/30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python) | ⭐ 74.0k | Python | 「Python编程30天挑战是一份分步骤的Python语言学习指南，总学习时长可能超过100天，你可以按照自己的节奏学习。这些视频也可能对你有帮助：https:… |
...
| [toeverything/AFFiNE](https://github.com/toeverything/AFFiNE) | ⭐ 72.7k | TypeScript | 不止有 Notion 和 Miro。AFFiNE（发音[ə‘fain]）是将规划、整理与创作整合为一体的下一代知识库。隐私优先、开源可定制，开箱即用。 |
| [protocolbuffers/protobuf](https://github.com/protocolbuffers/protobuf) | ⭐ 72.0k | C++ | Protocol Buffers — Google 的数据交换格式 |
| [stablyai/orca](https://github.com/stablyai/orca) | ⭐ 71.2k | TypeScript | Orca is the ADE for working with a fleet of parallel agents. Run any coding agen… |
...
| [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | ⭐ 69.0k | TypeScript | 适用于 AI 编码助手的规范驱动开发（SDD）。 |
| [cline/cline](https://github.com/cline/cline) | ⭐ 68.6k | TypeScript | 可作为 SDK、IDE 扩展或 CLI 助手使用的自主编码智能体 |
...
| [LadybirdBrowser/ladybird](https://github.com/LadybirdBrowser/ladybird) | ⭐ 66.2k | C++ | 真正独立的网页浏览器 |
| [tt-a1i/archify](https://github.com/tt-a1i/archify) | ⭐ 66.0k | JavaScript | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flo… |
...
| [usememos/memos](https://github.com/usememos/memos) | ⭐ 63.1k | Go | 开源自托管笔记工具，专为快速记笔记打造。原生支持Markdown，轻量省心，完全归你所有。 |
| [byoungd/up](https://github.com/byoungd/up) | ⭐ 62.9k | JavaScript | An advanced guide which might benefit you a lot 🎉 . 韩先凯的人生进阶指南 离谱的人生/人生进阶 离谱的英语学… |
...
| [upstash/context7](https://github.com/upstash/context7) | ⭐ 62.1k | TypeScript | Context7 平台——为大语言模型和 AI 代码编辑器提供最新的代码文档 |
| [jingyaogong/minimind](https://github.com/jingyaogong/minimind) | ⭐ 61.5k | Python | 🧠 仅需2小时从零训练一个64M参数的LLM！ |
...
| [aaif-goose/goose](https://github.com/aaif-goose/goose) | ⭐ 54.4k | Rust | 开源可扩展AI agent，不止提供代码建议——可搭配任意LLM完成安装、执行、编辑与测试 |
| [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) | ⭐ 54.2k | Python | 这里精选了适用于 Claude Code 的优质资源，Claude Code 是 Anthropic PBC 开发的公认最强编码助手。这个集合展示了顶尖技能、双… |
...
| [chen08209/FlClash](https://github.com/chen08209/FlClash) | ⭐ 52.5k | Dart | 基于 ClashMeta 的多平台代理客户端，简洁易用，开源无广告。 |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | ⭐ 52.2k | TypeScript | 面向编程代理的 Chrome DevTools |
...
| [QuantumNous/new-api](https://github.com/QuantumNous/new-api) | ⭐ 48.3k | Go | 一个用于聚合与分发的统一AI模型 hub，支持将各类大语言模型转换为兼容OpenAI、Claude或Gemini的格式，是供个人与企业进行模型管理的集中网关。 |
...
| [MetaCubeX/ClashMetaForAndroid🔀](https://github.com/MetaCubeX/ClashMetaForAndroid) | ⭐ 46.3k | Kotlin | 适用于 Android 的基于规则的隧道工具 |
...
| [janhq/jan](https://github.com/janhq/jan) | ⭐ 44.5k | TypeScript | Jan 是可 100% 在你电脑本地离线运行的开源 ChatGPT 替代方案。 |
| [sharkdp/fd](https://github.com/sharkdp/fd) | ⭐ 44.5k | Rust | find 的简单、快速、易用替代工具 |
| [DataExpert-io/data-engineer-handbook](https://github.com/DataExpert-io/data-engineer-handbook) | ⭐ 44.1k | Jupyter Notebook | 此仓库汇集了所有你学习数据工程会用到的资源链接 |
...
| [PDFMathTranslate/PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate) | ⭐ 37.0k | Python | [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 A… |
...
| [sgl-project/sglang](https://github.com/sgl-project/sglang) | ⭐ 36.1k | Python | SGLang 是面向大语言模型和多模态模型的高性能服务框架。 |
...
| [maboloshi/github-chinese](https://github.com/maboloshi/github-chinese) | ⭐ 33.0k | JavaScript | GitHub 汉化插件，GitHub 中文化界面。 (GitHub Translation To Chinese) |
...
| [rustfs/rustfs](https://github.com/rustfs/rustfs) | ⭐ 32.8k | Rust | 处理4KB对象载荷时，速度比MinIO快2.3倍。RustFS是开源的S3兼容高性能对象存储系统，支持与MinIO、Ceph等其他兼容S3的平台迁移共存。 |
...
| [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) | ⭐ 31.7k | TypeScript | ⌥ Coding agent with the IDE wired in |
...
| [BigPizzaV3/CodexPlusPlus](https://github.com/BigPizzaV3/CodexPlusPlus) | ⭐ 31.1k | Rust | An enhanced tool for CodexApp, striving to make Codex better to use and more com… |
...
| [liquidslr/leetcode-company-wise-problems](https://github.com/liquidslr/leetcode-company-wise-problems) | ⭐ 30.1k |  | 按公司分类的题目列表。companies 目录下每个 csv 文件对应特定公司根据 LeetCode 公司标签整理的 Leetcode 题目列表，更新至 202… |
...
| [oraios/serena](https://github.com/oraios/serena) | ⭐ 29.5k | Python | 面向编码开发的强大 MCP 工具包，提供语义检索与编辑能力——它是智能体的专属IDE |
...
| [QwenLM/qwen-code](https://github.com/QwenLM/qwen-code) | ⭐ 27.9k | TypeScript | 一个运行在你终端中的开源 AI 编程代理 |
...
| [xai-org/grok-build](https://github.com/xai-org/grok-build) | ⭐ 26.8k | Rust | SpaceXAI 的编程代理框架与 TUI 应用。支持全屏、鼠标交互，可扩展。 |
...
| [humanlayer/12-factor-agents](https://github.com/humanlayer/12-factor-agents) | ⭐ 26.2k | TypeScript | 我们可遵循哪些原则，才能构建出足以投入生产环境交付给客户使用的高质量 LLM 赋能软件？ |
...
| [twpayne/chezmoi](https://github.com/twpayne/chezmoi) | ⭐ 21.6k | Go | 跨不同设备安全管理你的dotfiles。 |
...
| [ZJU-LLMs/Foundations-of-LLMs](https://github.com/ZJU-LLMs/Foundations-of-LLMs) | ⭐ 17.9k |  | 一本学习LLM基础的书 |
...
| [Infrasys-AI/AISystem](https://github.com/Infrasys-AI/AISystem) | ⭐ 17.8k | Jupyter Notebook | AISystem 主要是指AI系统，包括AI芯片、AI编译器、AI推理和训练框架等AI全栈底层技术 |
...
| [coder/coder](https://github.com/coder/coder) | ⭐ 14.9k | Go | 为开发者及其智能代理提供安全环境 |
...
| [tisfeng/Easydict](https://github.com/tisfeng/Easydict) | ⭐ 14.6k | Swift | 一个简洁优雅的词典翻译 macOS App。开箱即用，支持离线 OCR 识别，支持有道词典，🍎 苹果系统词典，🍎 苹果系统翻译，OpenAI，Gemini，De… |
...
| [fishjar/kiss-translator](https://github.com/fishjar/kiss-translator) | ⭐ 12.5k | JavaScript | A simple, open source bilingual translation extension & Greasemonkey script (一个简… |
...
| [openchamber/openchamber](https://github.com/openchamber/openchamber) | ⭐ 10.0k | TypeScript | Agentic Development Environment based on OpenCode AI agent |
...
| [FluentRead/FluentRead](https://github.com/FluentRead/FluentRead) | ⭐ 8.1k | TypeScript | An open-source browser extension for bilingual webpages, instant selection trans… |
...
| [MoonshotAI/kimi-code](https://github.com/MoonshotAI/kimi-code) | ⭐ 7.4k | TypeScript | Kimi Code CLI  —  下一代智能体的起点 |
...
| [zhukunpenglinyutong/jetbrains-cc-gui](https://github.com/zhukunpenglinyutong/jetbrains-cc-gui) | ⭐ 6.3k | Java | Jetbrains Claude Code 与 Codex GUI 插件 |
...
| [Kuddev/pebrel](https://github.com/Kuddev/pebrel) | ⭐ 1.8k | Rust | AI-native, GPU-accelerated terminal emulator for Windows with SSH, persistent se… |
...
| [yuaotian/go-augment-cleaner](https://github.com/yuaotian/go-augment-cleaner) | ⭐ 959 |  | 清理Augment缓存和生成设备SessionId/解决 VSCode、Cursor、JetBrains 系列 IDE 中 Augment 插件无法登录的问题（… |
...
| [Auto-Plugin/milkup](https://github.com/Auto-Plugin/milkup) | ⭐ 948 | TypeScript | A cross-platform, instant-rendering desktop Markdown editor 一个跨平台的、即时渲染桌面端 Markd… |
...
| [WakeUp-Jin/Practical-Guide-to-Context-Engineering](https://github.com/WakeUp-Jin/Practical-Guide-to-Context-Engineering) | ⭐ 806 |  | 大模型应用开发的方向，上下文工程是设计原则，Agent Harness 是构建目标，本项目的目标，是为开发者和研究者提供一份大模型应用开发的骨架思路 |
...
| [OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL](https://github.com/OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL) | ⭐ 797 |  | 去AI味提示词-作家增强-SKILL |
| [zkep/my-geektime](https://github.com/zkep/my-geektime) | ⭐ 792 | Go | 👏 Make learning a lifelong habit. 学无止境 |
| [findmover/wxread](https://github.com/findmover/wxread) | ⭐ 789 | Python | 微信读书刷时长助你成为霸榜“大佬” |
| [bilibili/vim-vide](https://github.com/bilibili/vim-vide) | ⭐ 786 | Vim Script | Lightest vimrc, while strong enough. 最轻的vim配置，却足够强！ |
| [huangguang1999/ccstatusline-zh](https://github.com/huangguang1999/ccstatusline-zh) | ⭐ 780 | TypeScript | ccstatusline 的中文汉化版 - Claude Code CLI 可定制状态栏格式化工具 |
| [Delppine1024/TGreen](https://github.com/Delppine1024/TGreen) | ⭐ 780 |  | 部分文件在 T v1.1 上可正常运行（最新支持版本为 v1.9.5/1.9.2-dev），基于 TC 开发 |
...
| [nutstore/obsidian-nutstore-sync](https://github.com/nutstore/obsidian-nutstore-sync) | ⭐ 614 | TypeScript |  |
...
| [MAXeaglet/commandcode-proxy](https://github.com/MAXeaglet/commandcode-proxy) | ⭐ 609 | JavaScript | Command Code API 反代代理，兼容 OpenAI 与 Anthropic 接口 | Reverse proxy exposing Command… |
...
| [WoJiSama/skill-based-architecture](https://github.com/WoJiSama/skill-based-architecture) | ⭐ 592 | Shell | 这是一项可以生成技能的元技能：指向任意代码库后，它就能把项目的规则、工作流与经验教训提取出来，整理存入专用的`skills/<项目名>/`目录中——这个项目技能… |
...
| [baidu-baige/LoongForge](https://github.com/baidu-baige/LoongForge) | ⭐ 570 | Python | 一个用于在NVIDIA GPU和昆仑芯XPU上训练大语言模型、视觉语言模型、扩散模型以及具身智能模型的高性能框架 |
...
| [Haleclipse/codex🔀](https://github.com/Haleclipse/codex) | ⭐ 555 | Rust | 可在终端运行的轻量级编程代理 |
...
| [chengazhen/gitlens-pro](https://github.com/chengazhen/gitlens-pro) | ⭐ 489 | Go | 一个用于激活 GitLens Pro 的工具。 |
| [EdisonLeeeee/Awesome-Learning-Resource](https://github.com/EdisonLeeeee/Awesome-Learning-Resource) | ⭐ 483 |  | 精心整理的各类学习资源合集，涵盖博客、书籍、视频等内容 |
...
| [hantmac/Python-Interview-Customs-Collection](https://github.com/hantmac/Python-Interview-Customs-Collection) | ⭐ 465 |  | Python面试通关宝典，秋招、春招的小伙伴✿✿ヽ(°▽°)ノ✿），有面Python开发方向的，看这一个repo就够啦😘 |
...
| [ChengShiest/LAST-ViT](https://github.com/ChengShiest/LAST-ViT) | ⭐ 461 | Python | [CVPR 2026] 论文《Vision Transformer Needs More Than Registers》的官方PyTorch实现 |
...
| [RethinkFun/DeepLearning](https://github.com/RethinkFun/DeepLearning) | ⭐ 455 | Python |  |
...
| [lzskyline/VocabMeld](https://github.com/lzskyline/VocabMeld) | ⭐ 448 | JavaScript | 智能替换网页词汇，创造沉浸式双语学习环境，在日常浏览中自然习得语言。 |
...
| [itandelin/qoder-free](https://github.com/itandelin/qoder-free) | ⭐ 407 | Python | 一个用于重置 Qoder 应用程序用户身份信息的现代化图形界面工具。 |
...
| [yjh051108/dsh-router-standard🟡](https://github.com/yjh051108/dsh-router-standard) | ⭐ 358 | JavaScript | 已并入 dsh-routing-suite（单仓库化）；本仓库为历史镜像/归档 —— 注意力工程主线 v1.19.1/v34 研发线未发布。新代码见 githu… |
...
| [Baseult/NetLimiterCrack](https://github.com/Baseult/NetLimiterCrack) | ⭐ 305 | C# | 一个用于免费获取 NetLimiter Premium 的简单补丁程序 |
...
| [dstdev/awesome-hpc](https://github.com/dstdev/awesome-hpc) | ⭐ 272 |  | 精选HPC优秀软件与工具合集 |
...
| [holtwood/awesome-cursorrules-zh](https://github.com/holtwood/awesome-cursorrules-zh) | ⭐ 235 | JavaScript | Cursor AI 编程规则精选集 | 132+ 规则，覆盖前端/后端/AI/DevOps 等 32 个领域 |
...
| [microwind/algorithms](https://github.com/microwind/algorithms) | ⭐ 176 | Java | 🚀AI时代，人人都是算法思想工程师。本项目含各种数据结构与经典算法，充分举例说明，用C/Java/Python/JS/Go/Rust等不同语言实现，一边学算法一… |
...
| [ahpxex/open-dictionary](https://github.com/ahpxex/open-dictionary) | ⭐ 136 | Python | 基于维基词典构建、借助大语言模型丰富释义的真正开放词典 |
...
| [Ssabby1/repo-to-resume-tailor](https://github.com/Ssabby1/repo-to-resume-tailor) | ⭐ 126 | Python | 可根据目标岗位或职位描述，将代码仓库转换为适配简历的项目经历描述 |
...
| [breaker505/resumify](https://github.com/breaker505/resumify) | ⭐ 94 |  | Resumify — 别再说“我只是做了测试”。让AI帮你讲出漂亮的经历故事。✨ |
