...
> 全部 **1354** 个 Star 项目,按 ⭐ 排序

| 项目 | 星数 | 语言 | 描述 |
|------|------|------|------|
| [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | ⭐ 547.1k | Markdown | 通过从零重写你喜爱的技术来精通编程。 |
| [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | ⭐ 505.8k |  | 汇集各类趣味主题的超棒精选列表【注：在我处理完现有PR前，暂时关闭拉取请求提交】 |
| [public-apis/public-apis](https://github.com/public-apis/public-apis) | ⭐ 479.8k | Python | 免费API集合列表 |
| [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | ⭐ 455.4k | TypeScript | freeCodeCamp.org 的开源代码库与课程。免费学习数学、编程与计算机科学。 |
| [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | ⭐ 396.7k | Python | :books: 免费开源编程书籍 |
| [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | ⭐ 369.8k | Python | 学习如何设计大规模系统，备战系统设计面试，包含Anki闪卡。 |
| [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | ⭐ 367.1k | TypeScript | 助力开发者职业成长的交互式路线图、指南及其他教育内容。 |
| [jwasham/coding-interview-university](https://github.com/jwasham/coding-interview-university) | ⭐ 360.9k |  | 一份成为软件工程师的完整计算机科学学习计划 |
| [vinta/awesome-python](https://github.com/vinta/awesome-python) | ⭐ 320.5k | Python | 专门解答「我想用Python做X该用什么工具？」的权威工具清单 |
| [obra/superpowers](https://github.com/obra/superpowers) | ⭐ 286.3k | Shell | 一套行之有效的智能体技能框架与软件开发方法论。 |
| [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | ⭐ 283.2k | Python | 精选基于项目的教程列表 |
| [mattpocock/skills](https://github.com/mattpocock/skills) | ⭐ 261.4k | Shell | 真正工程师必备技能，直接来自我的.agents目录。 |
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | ⭐ 257.8k | JavaScript | 这是智能代理性能优化系统，为 Claude Code、Codex、Opencode、Cursor 及更多 AI 编码工具提供技能、本能、记忆、安全能力与研究优先… |
| [react/react](https://github.com/react/react) | ⭐ 250.4k | JavaScript | 用于构建网页和原生用户界面的库。 |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | ⭐ 245.2k | Python | The agent that grows with you |
| [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) | ⭐ 224.6k | Python | 用Python实现的所有算法 |
| [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | ⭐ 222.8k | TypeScript | DeepSeek Harness：万物皆插件。 |
| [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | ⭐ 212.8k |  | 基于Andrej Karpathy对大语言模型编码陷阱的观察，通过单个CLAUDE.md文件优化Claude Code的行为。 |
| [vuejs/vue](https://github.com/vuejs/vue) | ⭐ 212.8k | TypeScript | 这是 Vue 2 的仓库。Vue 3 请访问 https://github.com/vuejs/core |
| [anomalyco/opencode](https://github.com/anomalyco/opencode) | ⭐ 207.2k | TypeScript | 开源编码智能体 |
| [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | ⭐ 199.2k | Markdown | 为所有人提供免费域名注册与实用DNS学习资源 |
...
| [jackfrued/Python-100-Days](https://github.com/jackfrued/Python-100-Days) | ⭐ 186.4k | Jupyter Notebook | Python - 100天从新手到大师 |
| [CyC2018/CS-Notes](https://github.com/CyC2018/CS-Notes) | ⭐ 186.0k |  | :books: 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络、系统设计 |
| [microsoft/markitdown](https://github.com/microsoft/markitdown) | ⭐ 183.7k | Python | 用于将文件和办公文档转换为 Markdown 的 Python 工具 |
| [ollama/ollama](https://github.com/ollama/ollama) | ⭐ 180.8k | Go | 快速上手 Kimi-K2.6、GLM-5.2、MiniMax、DeepSeek、gpt-oss、Qwen、Gemma 等各类大模型。 |
| [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | ⭐ 176.4k | Python | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share interesting, entry-level open source proj… |
| [anthropics/skills](https://github.com/anthropics/skills) | ⭐ 176.2k | Python | Agent 技能公开仓库 |
| [jlevy/the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) | ⭐ 162.4k |  | 掌握命令行，只需一页 |
| [open-webui/open-webui](https://github.com/open-webui/open-webui) | ⭐ 151.9k | Python | 易用的 AI 界面（支持 Ollama、OpenAI API 等） |
| [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | ⭐ 146.3k | Python | 智能体工程开发平台 |
| [anthropics/claude-code](https://github.com/anthropics/claude-code) | ⭐ 145.0k | Python | Claude Code 是一款可在终端内运行的智能编码工具，它能理解你的代码库，通过自然语言命令帮你完成例行任务、讲解复杂代码、处理 git 工作流，让你的编码… |
| [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) | ⭐ 144.3k | Rust | 基于 Tauri 构建的现代化图形界面客户端，支持在 Windows、macOS 和 Linux 运行，提供定制化代理体验 |
| [x1xhlol/system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | ⭐ 143.6k |  | 包含FULL Augment Code、Claude Code、Cluely、CodeBuddy、Comet、Cursor、Devin AI、Junie、Kir… |
| [golang/go](https://github.com/golang/go) | ⭐ 138.8k | Go | Go 编程语言 |
| [github/spec-kit](https://github.com/github/spec-kit) | ⭐ 136.5k | Python | 用于帮助你上手规范驱动开发的工具套件 |
| [labuladong/fucking-algorithm](https://github.com/labuladong/fucking-algorithm) | ⭐ 135.9k | Markdown | 破解LeetCode，不仅要知其然，更要知其所以然。 |
| [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | ⭐ 132.7k | Rust | 适用于 Claude Code、Codex、OpenCode、OpenClaw、Grok Build 与 Hermes Agent 的跨平台桌面一站式助手。唯一… |
| [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | ⭐ 127.4k | Python | 一款可为多平台构建专业UI/UX提供设计智能支持的AI技能。 |
| [openai/codex](https://github.com/openai/codex) | ⭐ 123.9k | Rust | 可在终端运行的轻量级编码智能体 |
| [microsoft/generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners) | ⭐ 119.7k | Jupyter Notebook | 21节课，从零开始构建生成式AI项目 |
...
| [2dust/v2rayN](https://github.com/2dust/v2rayN) | ⭐ 116.1k | C# | 支持Xray、sing-box等的多平台GUI客户端，兼容Windows、Linux与macOS |
| [openai/whisper](https://github.com/openai/whisper) | ⭐ 109.0k | Python | 基于大规模弱监督的稳健语音识别 |
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | ⭐ 107.0k | TypeScript | 一款可将 Gemini 的能力直接引入终端的开源 AI 智能体 |
| [JuliusBrussee/caveman](https://github.com/JuliusBrussee/caveman) | ⭐ 105.4k | Go | 🪨 能少用token干嘛用那么多——这是Claude Code技能，模仿原始人说话帮你砍掉65%的token用量 |
| [earendil-works/pi](https://github.com/earendil-works/pi) | ⭐ 104.8k | TypeScript | AI 智能体工具包：统一大语言模型API、智能体循环、终端用户界面、编程智能体命令行工具 |
| [ruanyf/weekly](https://github.com/ruanyf/weekly) | ⭐ 102.5k |  | 科技爱好者周刊，每周五发布 |
| [fastapi/fastapi](https://github.com/fastapi/fastapi) | ⭐ 102.3k | Python | FastAPI 框架，高性能，易学习，编码快，可用于生产环境 |
...
| [punkpeye/awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers) | ⭐ 94.9k |  | MCP 服务器集合 |
| [deepseek-ai/DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) | ⭐ 92.0k |  |  |
| [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) | ⭐ 91.3k | JavaScript | 酷炫的自托管监控工具 |
| [localsend/localsend](https://github.com/localsend/localsend) | ⭐ 90.9k | Dart | AirDrop 的开源跨平台替代工具 |
...
| [mlabonne/llm-course](https://github.com/mlabonne/llm-course) | ⭐ 82.7k |  | 带你入门大语言模型（LLM）的课程，包含学习路线图与 Colab 笔记本。 |
...
| [bytedance/deer-flow](https://github.com/bytedance/deer-flow) | ⭐ 82.4k | Python | 这是一个可完成调研、编码与创作的开源长周期SuperAgent框架。借助沙箱、记忆、工具、技能、子代理与消息网关，它能处理耗时数分钟到数小时的不同层级任务。 |
...
| [rtk-ai/rtk](https://github.com/rtk-ai/rtk) | ⭐ 80.2k | Rust | CLI 代理，可将常用开发命令的 LLM 令牌消耗降低 60-90%，单Rust二进制文件，零依赖 |
...
| [datawhalechina/hello-agents](https://github.com/datawhalechina/hello-agents) | ⭐ 78.8k | Python | 📚 《从零开始构建智能体》——从零开始的智能体原理与实践教程 |
| [abi/screenshot-to-code](https://github.com/abi/screenshot-to-code) | ⭐ 78.7k | Python | 上传截图，即可将其转换为整洁的代码（HTML/Tailwind/React/Vue） |
| [dair-ai/Prompt-Engineering-Guide](https://github.com/dair-ai/Prompt-Engineering-Guide) | ⭐ 78.3k | MDX | 用于提示工程、上下文工程、RAG 与 AI 智能体的指南、论文、教程、笔记与资源汇总 |
...
| [caddyserver/caddy](https://github.com/caddyserver/caddy) | ⭐ 75.7k | Go | 快速可扩展的多平台 HTTP/1-2-3 Web 服务器，自带自动 HTTPS |
| [PKUFlyingPig/cs-self-learning](https://github.com/PKUFlyingPig/cs-self-learning) | ⭐ 75.6k | HTML | 计算机自学指南 |
| [ComposioHQ/awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills) | ⭐ 75.0k | Python | 精选的优质Claude技能、资源与工具列表，用于定制Claude AI工作流 |
| [Asabeneh/30-Days-Of-Python](https://github.com/Asabeneh/30-Days-Of-Python) | ⭐ 73.7k | Python | 「Python编程30天挑战是一份分步骤的Python语言学习指南，总学习时长可能超过100天，你可以按照自己的节奏学习。这些视频也可能对你有帮助：https:… |
...
| [toeverything/AFFiNE](https://github.com/toeverything/AFFiNE) | ⭐ 72.5k | TypeScript | 不止有 Notion 和 Miro。AFFiNE（发音[ə‘fain]）是将规划、整理与创作整合为一体的下一代知识库。隐私优先、开源可定制，开箱即用。 |
...
| [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | ⭐ 68.2k | TypeScript | 适用于 AI 编码助手的规范驱动开发（SDD）。 |
| [cline/cline](https://github.com/cline/cline) | ⭐ 68.0k | TypeScript | 可作为 SDK、IDE 扩展或 CLI 助手使用的自主编码智能体 |
| [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) | ⭐ 67.4k | Rust | 用 Rust 编写的非官方兼容 Bitwarden 的服务端，曾用名 bitwarden_rs |
...
| [usememos/memos](https://github.com/usememos/memos) | ⭐ 63.0k | Go | 开源自托管笔记工具，专为快速记笔记打造。原生支持Markdown，轻量省心，完全归你所有。 |
| [byoungd/up](https://github.com/byoungd/up) | ⭐ 62.7k | JavaScript | An advanced guide which might benefit you a lot 🎉 . 韩先凯的人生进阶指南 离谱的人生/人生进阶 离谱的英语学… |
...
| [upstash/context7](https://github.com/upstash/context7) | ⭐ 62.0k | TypeScript | Context7 平台——为大语言模型和 AI 代码编辑器提供最新的代码文档 |
| [1c7/chinese-independent-developer](https://github.com/1c7/chinese-independent-developer) | ⭐ 61.4k |  | 👩🏿‍💻👨🏾‍💻👩🏼‍💻👨🏽‍💻👩🏻‍💻中国独立开发者项目列表 -- 分享大家都在做什么 |
...
| [tt-a1i/archify](https://github.com/tt-a1i/archify) | ⭐ 61.0k | JavaScript | Agent skill for beautiful, verifiable architecture, workflow, sequence, data-flo… |
| [jingyaogong/minimind](https://github.com/jingyaogong/minimind) | ⭐ 61.0k | Python | 🧠 仅需2小时从零训练一个64M参数的LLM！ |
...
| [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) | ⭐ 58.5k | Python | 用于编排角色扮演型自主AI智能体的框架。CrewAI 通过培养协作智能，赋能智能体无缝协作，处理复杂任务。 |
| [FoundationAgents/OpenManus](https://github.com/FoundationAgents/OpenManus) | ⭐ 58.3k | Python | 没有堡垒，唯有纯粹的开阔之地。OpenManus，即将到来。 |
| [karpathy/nanochat](https://github.com/karpathy/nanochat) | ⭐ 58.0k | Python | 花一百美元能买到的顶级ChatGPT体验。 |
...
| [aaif-goose/goose](https://github.com/aaif-goose/goose) | ⭐ 54.2k | Rust | 开源可扩展AI agent，不止提供代码建议——可搭配任意LLM完成安装、执行、编辑与测试 |
| [ElemeFE/element](https://github.com/ElemeFE/element) | ⭐ 54.0k | Vue | 适用于Web的Vue.js 2.0 UI组件库 |
| [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code) | ⭐ 54.0k | Python | 这里精选了适用于 Claude Code 的优质资源，Claude Code 是 Anthropic PBC 开发的公认最强编码助手。这个集合展示了顶尖技能、双… |
| [bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) | ⭐ 53.0k | Python | 敏捷AI驱动开发的突破性方法 |
...
| [chen08209/FlClash](https://github.com/chen08209/FlClash) | ⭐ 52.0k | Dart | 基于 ClashMeta 的多平台代理客户端，简洁易用，开源无广告。 |
| [ChromeDevTools/chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp) | ⭐ 51.9k | TypeScript | 面向编程代理的 Chrome DevTools |
...
| [QuantumNous/new-api](https://github.com/QuantumNous/new-api) | ⭐ 48.0k | Go | 一个用于聚合与分发的统一AI模型 hub，支持将各类大语言模型转换为兼容OpenAI、Claude或Gemini的格式，是供个人与企业进行模型管理的集中网关。 |
...
| [MetaCubeX/ClashMetaForAndroid🔀](https://github.com/MetaCubeX/ClashMetaForAndroid) | ⭐ 46.1k | Kotlin | 适用于 Android 的基于规则的隧道工具 |
...
| [wshobson/agents](https://github.com/wshobson/agents) | ⭐ 39.6k | Python | 适用于 Claude Code、Codex、Cursor、OpenCode、GitHub Copilot 和 Google Antigravity 的多线束智能… |
...
| [searxng/searxng](https://github.com/searxng/searxng) | ⭐ 37.0k | Python | SearXNG 是一款免费的互联网元搜索引擎，可聚合来自多种搜索服务与数据库的搜索结果。它不会追踪用户，也不会为用户建立画像。 |
...
| [sgl-project/sglang](https://github.com/sgl-project/sglang) | ⭐ 35.9k | Python | SGLang 是面向大语言模型和多模态模型的高性能服务框架。 |
...
| [maboloshi/github-chinese](https://github.com/maboloshi/github-chinese) | ⭐ 32.8k | JavaScript | GitHub 汉化插件，GitHub 中文化界面。 (GitHub Translation To Chinese) |
...
| [rustfs/rustfs](https://github.com/rustfs/rustfs) | ⭐ 32.1k | Rust | 处理4KB对象载荷时，速度比MinIO快2.3倍。RustFS是开源的S3兼容高性能对象存储系统，支持与MinIO、Ceph等其他兼容S3的平台迁移共存。 |
...
| [agentscope-ai/agentscope](https://github.com/agentscope-ai/agentscope) | ⭐ 31.6k | Python | 构建并运行你看得见、摸得透、信得过的智能体。 |
...
| [lbjlaq/Antigravity-Manager](https://github.com/lbjlaq/Antigravity-Manager) | ⭐ 31.3k | Rust | Professional Antigravity Account Manager & Switcher. One-click seamless account… |
...
| [BigPizzaV3/CodexPlusPlus](https://github.com/BigPizzaV3/CodexPlusPlus) | ⭐ 30.8k | Rust | An enhanced tool for CodexApp, striving to make Codex better to use and more com… |
...
| [Johnshall/Shadowrocket-ADBlock-Rules-Forever](https://github.com/Johnshall/Shadowrocket-ADBlock-Rules-Forever) | ⭐ 30.1k |  | 提供多款 Shadowrocket 规则，拥有强劲的广告过滤功能。每日 8 时重新构建规则。 |
| [liquidslr/leetcode-company-wise-problems](https://github.com/liquidslr/leetcode-company-wise-problems) | ⭐ 30.0k |  | 按公司分类的题目列表。companies 目录下每个 csv 文件对应特定公司根据 LeetCode 公司标签整理的 Leetcode 题目列表，更新至 202… |
...
| [oraios/serena](https://github.com/oraios/serena) | ⭐ 29.3k | Python | 面向编码开发的强大 MCP 工具包，提供语义检索与编辑能力——它是智能体的专属IDE |
| [karakeep-app/karakeep](https://github.com/karakeep-app/karakeep) | ⭐ 29.0k | TypeScript | 支持自托管的全类型书签应用，可收纳链接、笔记与图片，带AI自动 tagging 和全文搜索 |
...
| [fastfetch-cli/fastfetch](https://github.com/fastfetch-cli/fastfetch) | ⭐ 24.6k | C | 一款持续维护、功能丰富、侧重性能的类 neofetch 系统信息工具。 |
...
| [Vonng/ddia](https://github.com/Vonng/ddia) | ⭐ 23.6k | Python | 《Designing Data-Intensive Application》DDIA 第一版 / 第二版 中文翻译 |
...
| [SpotX-Official/SpotX](https://github.com/SpotX-Official/SpotX) | ⭐ 22.3k | PowerShell | 用于破解桌面版Spotify的SpotX补丁工具 |
...
| [ccusage/ccusage](https://github.com/ccusage/ccusage) | ⭐ 18.5k | Rust | 运行 npx ccusage |
...
| [jlcodes99/cockpit-tools](https://github.com/jlcodes99/cockpit-tools) | ⭐ 17.6k | Rust | 🚀 通用 AI IDE 账号管理工具：支持 Antigravity / Codex / GitHub Copilot / Windsurf / Kiro / C… |
...
| [GeeeekExplorer/nano-vllm](https://github.com/GeeeekExplorer/nano-vllm) | ⭐ 15.4k | Python | Nano vLLM |
...
| [datawhalechina/all-in-rag](https://github.com/datawhalechina/all-in-rag) | ⭐ 11.0k | Python | 🔍大模型应用开发实战一：RAG 技术全栈指南，在线阅读地址：https://datawhalechina.github.io/all-in-rag/ |
...
| [OpenBMB/MiniCPM](https://github.com/OpenBMB/MiniCPM) | ⭐ 10.9k | Jupyter Notebook | MiniCPM5: SOTA on-device LLMs, small yet powerful. |
...
| [openchamber/openchamber](https://github.com/openchamber/openchamber) | ⭐ 9.8k | TypeScript | Agentic Development Environment based on OpenCode AI agent |
...
| [zhukunpenglinyutong/jetbrains-cc-gui](https://github.com/zhukunpenglinyutong/jetbrains-cc-gui) | ⭐ 6.2k | Java | Jetbrains Claude Code 与 Codex GUI 插件 |
...
| [binaricat/Netcatty](https://github.com/binaricat/Netcatty) | ⭐ 5.9k | TypeScript | 集SSH工作区、SFTP和终端于一体 |
...
| [Kuddev/pebrel](https://github.com/Kuddev/pebrel) | ⭐ 1.3k | Rust | AI-native, GPU-accelerated terminal emulator for Windows with SSH, persistent se… |
...
| [0voice/developkit_set](https://github.com/0voice/developkit_set) | ⭐ 998 |  | 2021年最新总结，值得推荐的c/c++开源框架与库。持续更新中。 |
...
| [huifer/WellAlly-health](https://github.com/huifer/WellAlly-health) | ⭐ 949 | Shell | Ally-Health 是一款智能医疗助手，它依托先进AI技术与医学专业知识革新个人健康管理。它通过自然语言交互帮助用户记录症状、管理用药、整理病历并获取多学科… |
...
| [rmyorston/busybox-w32](https://github.com/rmyorston/busybox-w32) | ⭐ 886 | C | BusyBox 的 WIN32 原生移植版。 |
...
| [ButTaiwan/gensen-font](https://github.com/ButTaiwan/gensen-font) | ⭐ 853 |  | 源自Source Han Sans的免费字体系列。 |
...
| [findmover/wxread](https://github.com/findmover/wxread) | ⭐ 787 | Python | 微信读书刷时长助你成为霸榜“大佬” |
| [bilibili/vim-vide](https://github.com/bilibili/vim-vide) | ⭐ 786 | Vim Script | Lightest vimrc, while strong enough. 最轻的vim配置，却足够强！ |
| [OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL](https://github.com/OUBIGFA/De-AI-Prompt-Enhancer-Writer-Booster-SKILL) | ⭐ 781 |  | 去AI味提示词-作家增强-SKILL |
...
| [WakeUp-Jin/Practical-Guide-to-Context-Engineering](https://github.com/WakeUp-Jin/Practical-Guide-to-Context-Engineering) | ⭐ 773 |  | 大模型应用开发的方向，上下文工程是设计原则，Agent Harness 是构建目标，本项目的目标，是为开发者和研究者提供一份大模型应用开发的骨架思路 |
...
| [hellowind777/hello2cc](https://github.com/hellowind777/hello2cc) | ⭐ 693 | JavaScript | 面向第三方模型的原生优先 Claude Code 插件，支持静默代理模型注入与输出样式定制。 |
...
| [JackyST0/awesome-agent-skills](https://github.com/JackyST0/awesome-agent-skills) | ⭐ 635 | Shell | 🤖 精选的 AI Agent Skills 列表，适用于 Cursor、Claude Code、GitHub Copilot 等 AI 编程工具 |
...
| [bbruceyuan/AI-Interview-Code](https://github.com/bbruceyuan/AI-Interview-Code) | ⭐ 612 | Jupyter Notebook | LLM大模型（重点）以及搜广推等 AI 算法中手写的面试题，（非 LeetCode），比如 Self-Attention, AUC等，一般比 LeetCode… |
...
| [alexkirsz/dispatch](https://github.com/alexkirsz/dispatch) | ⭐ 611 | Rust | 合并多个网络连接，提升你的下载速度 |
...
| [ZMGID/kivio](https://github.com/ZMGID/kivio) | ⭐ 582 | Rust |  |
...
| [WoJiSama/skill-based-architecture](https://github.com/WoJiSama/skill-based-architecture) | ⭐ 577 | Shell | 这是一项可以生成技能的元技能：指向任意代码库后，它就能把项目的规则、工作流与经验教训提取出来，整理存入专用的`skills/<项目名>/`目录中——这个项目技能… |
...
| [Lularible/storage-book](https://github.com/Lularible/storage-book) | ⭐ 564 | C | 一本关于存储技术与文件系统的开源书籍。从绳结记事到Flash物理特性，从FAT到LittleFS —— 还附带教学级日志结构嵌入式文件系统KnotFS（约840… |
| [ahmetsait/toolgit](https://github.com/ahmetsait/toolgit) | ⭐ 563 | Python | Git 生产力工具集 |
| [baidu-baige/LoongForge](https://github.com/baidu-baige/LoongForge) | ⭐ 561 | Python | 一个用于在NVIDIA GPU和昆仑芯XPU上训练大语言模型、视觉语言模型、扩散模型以及具身智能模型的高性能框架 |
...
| [Haleclipse/codex🔀](https://github.com/Haleclipse/codex) | ⭐ 551 | Rust | 可在终端运行的轻量级编程代理 |
| [catlog22/maestro-flow](https://github.com/catlog22/maestro-flow) | ⭐ 550 | TypeScript | 面向多智能体AI开发的意图驱动工作流编排——适配Claude Code、Gemini、Codex等工具的自适应生命周期引擎、自强化知识图谱与可视化仪表盘 |
...
| [hitnology/snoopy](https://github.com/hitnology/snoopy) | ⭐ 534 | Objective-C | macOS 版本史努比屏幕保护 |
...
| [chengazhen/gitlens-pro](https://github.com/chengazhen/gitlens-pro) | ⭐ 487 | Go | 一个用于激活 GitLens Pro 的工具。 |
...
| [MAXeaglet/commandcode-proxy](https://github.com/MAXeaglet/commandcode-proxy) | ⭐ 484 | JavaScript | Command Code API 反代代理，兼容 OpenAI 与 Anthropic 接口 | Reverse proxy exposing Command… |
...
| [itandelin/qoder-free](https://github.com/itandelin/qoder-free) | ⭐ 405 | Python | 一个用于重置 Qoder 应用程序用户身份信息的现代化图形界面工具。 |
| [wzdnzd/resume](https://github.com/wzdnzd/resume) | ⭐ 403 | TypeScript | 功能丰富、支持灵活自定义的简历生成工具 |
| [cloudanum/50Algorithms](https://github.com/cloudanum/50Algorithms) | ⭐ 397 | Jupyter Notebook | Code for 50 Algorithms Every Programmer Should Know, Second Edition (Packt) by I… |
...
| [rashidazarang/chatgpt-chat-exporter](https://github.com/rashidazarang/chatgpt-chat-exporter) | ⭐ 379 | JavaScript | 一款轻量级浏览器端工具，可将你的ChatGPT对话导出为美观的Markdown或PDF格式。 |
...
| [liangdabiao/Claude-Code-Stock-Deep-Research-Agent](https://github.com/liangdabiao/Claude-Code-Stock-Deep-Research-Agent) | ⭐ 371 |  | 本研究基于 Claude Code Deep Research 系统：  方法论: 8阶段股票投资尽调框架 智能体: 28个并行研究智能体 工具: WebSea… |
...
| [andrewkchan/deepseek.cpp](https://github.com/andrewkchan/deepseek.cpp) | ⭐ 323 | C++ | 基于 C++ 的 DeepSeek 系列大语言模型 CPU 推理 |
...
| [WangQrkkk/PaperQuay](https://github.com/WangQrkkk/PaperQuay) | ⭐ 301 | TypeScript | 优先适配桌面端的文献管理工具，支持PDF阅读、翻译、论文概览与AI智能体工作流。 |
...
| [016/Antigravity-Better](https://github.com/016/Antigravity-Better) | ⭐ 261 | HTML | Customize your Antigravity AI chat panel. Your IDE, your rules. 自定义你的 Antigravit… |
...
| [MGI-tech-bioinformatics/DNBelab_C_Series_HT_scRNA-analysis-software](https://github.com/MGI-tech-bioinformatics/DNBelab_C_Series_HT_scRNA-analysis-software) | ⭐ 161 | HTML | 用于灵活、高性能分析DNBelab C系列单细胞数据的官方流程。 |
| [shubhamchandak94/Spring](https://github.com/shubhamchandak94/Spring) | ⭐ 160 | C | FASTQ 压缩 |
| [gally16/LLM-Jailbreaking-Guide](https://github.com/gally16/LLM-Jailbreaking-Guide) | ⭐ 155 |  | LLM Jailbreaking Guide主流大语言模型越狱指南 |
...
| [shuguangnet/docker_backup_script](https://github.com/shuguangnet/docker_backup_script) | ⭐ 129 | Shell | 检测docker容器并自动备份挂载卷以及本地挂载目录 |
...
| [Ssabby1/repo-to-resume-tailor](https://github.com/Ssabby1/repo-to-resume-tailor) | ⭐ 125 | Python | 可根据目标岗位或职位描述，将代码仓库转换为适配简历的项目经历描述 |
...
| [Ayi1337/gpt6-astra-one-shot-games](https://github.com/Ayi1337/gpt6-astra-one-shot-games) | ⭐ 48 | HTML | GPT-6 Astra 的 One Shot 游戏测试，包含原始 Prompt 与可直接运行的单文件 HTML。 |
...
| [holtwood/agent-skills-kit](https://github.com/holtwood/agent-skills-kit) | ⭐ 2 | HTML | 自用 Agent Skills 集合：截图捕获、截图装框、架构图生成、GitHub Pages 配置等，兼容 Claude Code / opencode |
